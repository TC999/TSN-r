...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    /* compiled from: RetryAndFollowUpInterceptor.kt */
    @Metadata(m12618bv = {1, 0, 3}, m12617d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m12616d2 = {"Lokhttp3/internal/http/RetryAndFollowUpInterceptor$Companion;", "", "()V", "MAX_FOLLOW_UPS", "", "okhttp"}, m12615k = 1, m12614mv = {1, 4, 0})
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    ...
    private final Request buildRedirectRequest(Response response, String str) {
        ...
        HttpUrl resolve;
        if (!this.client.followRedirects() || (header$default = Response.header$default(response, HttpHeaders.Names.LOCATION, null, 2, null)) == null || (resolve = response.request().url().resolve(header$default)) == null) {
            return null;
        }
        if (C14342f0.m8193g(resolve.scheme(), response.request().url().scheme()) || this.client.followSslRedirects()) {
    ...
    private final int retryAfter(Response response, int i) {
        ...
        if (header$default != null) {
            if (new Regex("\\d+").matches(header$default)) {
                ...
                C14342f0.m8185o(valueOf, "Integer.valueOf(header)");
                ...
                if (!call$okhttp.isCanceled()) {
                    try {
                        ...
                        if (recover(e, call$okhttp, request$okhttp, !(e instanceof ConnectionShutdownException))) {
                            m12478E = _Collections.m12067r4(m12478E, e);
                            call$okhttp.exitNetworkInterceptorExchange$okhttp(true);
                            z = false;
                        } else {
                            throw Util.withSuppressed(e, m12478E);
                        }
                    } catch (RouteException e2) {
                        if (recover(e2.getLastConnectException(), call$okhttp, request$okhttp, false)) {
                            m12478E = _Collections.m12067r4(m12478E, e2.getFirstConnectException());
                            call$okhttp.exitNetworkInterceptorExchange$okhttp(true);
                            z = false;
                        } else {
                            throw Util.withSuppressed(e2.getFirstConnectException(), m12478E);
                        }
                    }
