...
public final class Route {
    ...
    public Route(@NotNull Address address, @NotNull Proxy proxy, @NotNull InetSocketAddress socketAddress) {
        ...
        C14342f0.m8184p(socketAddress, "socketAddress");
    ...
    public final Address m60288deprecated_address() {
        return this.address;
    }
    ...
    public final Proxy m60289deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m60290deprecated_socketAddress() {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof Route) {
            ...
            if (C14342f0.m8193g(route.address, this.address) && C14342f0.m8193g(route.proxy, this.proxy) && C14342f0.m8193g(route.socketAddress, this.socketAddress)) {
                return true;
            }
        }
        return false;
