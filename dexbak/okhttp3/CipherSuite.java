...
@Metadata(m12618bv = {1, 0, 3}, m12617d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, m12616d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, m12615k = 1, m12614mv = {1, 4, 0})
...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            boolean m6548u2;
            boolean m6548u22;
            m6548u2 = StringsJVM.m6548u2(str, "TLS_", false, 2, null);
            if (m6548u2) {
            ...
            m6548u22 = StringsJVM.m6548u2(str, "SSL_", false, 2, null);
            if (m6548u22) {
        ...
        public final synchronized CipherSuite forJavaName(@NotNull String javaName) {
            ...
            C14342f0.m8184p(javaName, "javaName");
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@NotNull String a, @NotNull String b) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return C14342f0.m8180t(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
                int length = a.length();
        ...
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_VERSION_NAME);
    ...
    public final String m60184deprecated_javaName() {
