...
public final class Address {
    ...
    public Address(@NotNull String uriHost, int i, @NotNull Dns dns, @NotNull SocketFactory socketFactory, @Nullable SSLSocketFactory sSLSocketFactory, @Nullable HostnameVerifier hostnameVerifier, @Nullable CertificatePinner certificatePinner, @NotNull Authenticator proxyAuthenticator, @Nullable Proxy proxy, @NotNull List<? extends Protocol> protocols, @NotNull List<ConnectionSpec> connectionSpecs, @NotNull ProxySelector proxySelector) {
        C14342f0.m8184p(uriHost, "uriHost");
        ...
        this.url = new HttpUrl.Builder().scheme(sSLSocketFactory != null ? "https" : IDataSource.f43971a).host(uriHost).port(i).build();
    ...
    public final CertificatePinner m60158deprecated_certificatePinner() {
    ...
    public final List<ConnectionSpec> m60159deprecated_connectionSpecs() {
    ...
    public final Dns m60160deprecated_dns() {
        return this.dns;
    }
    ...
    public final HostnameVerifier m60161deprecated_hostnameVerifier() {
    ...
    public final List<Protocol> m60162deprecated_protocols() {
    ...
    public final Proxy m60163deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final Authenticator m60164deprecated_proxyAuthenticator() {
    ...
    public final ProxySelector m60165deprecated_proxySelector() {
    ...
    public final SocketFactory m60166deprecated_socketFactory() {
    ...
    public final SSLSocketFactory m60167deprecated_sslSocketFactory() {
    ...
    public final HttpUrl m60168deprecated_url() {
        return this.url;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof Address) {
            ...
            if (C14342f0.m8193g(this.url, address.url) && equalsNonHost$okhttp(address)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equalsNonHost$okhttp(@NotNull Address that) {
        ...
        return C14342f0.m8193g(this.dns, that.dns) && C14342f0.m8193g(this.proxyAuthenticator, that.proxyAuthenticator) && C14342f0.m8193g(this.protocols, that.protocols) && C14342f0.m8193g(this.connectionSpecs, that.connectionSpecs) && C14342f0.m8193g(this.proxySelector, that.proxySelector) && C14342f0.m8193g(this.proxy, that.proxy) && C14342f0.m8193g(this.sslSocketFactory, that.sslSocketFactory) && C14342f0.m8193g(this.hostnameVerifier, that.hostnameVerifier) && C14342f0.m8193g(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }

    public int hashCode() {
        return ((((((((((((((((((527 + this.url.hashCode()) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31) + C15399a.m2805a(this.proxy)) * 31) + C15399a.m2805a(this.sslSocketFactory)) * 31) + C15399a.m2805a(this.hostnameVerifier)) * 31) + C15399a.m2805a(this.certificatePinner);
    }
