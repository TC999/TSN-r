...
public abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        protected Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC14268c interfaceC14268c = (InterfaceC14268c) objArr[objArr.length - 1];
            try {
                if (this.isNullable) {
                    return KotlinExtensions.awaitNullable(adapt, interfaceC14268c);
                }
                return KotlinExtensions.await(adapt, interfaceC14268c);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, interfaceC14268c);
            }
        }
    }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        protected Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC14268c interfaceC14268c = (InterfaceC14268c) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(adapt, interfaceC14268c);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, interfaceC14268c);
            }
        }
