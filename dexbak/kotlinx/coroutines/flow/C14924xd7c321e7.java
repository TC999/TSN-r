...
@DebugMetadata(m8639c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2", m8638f = "Zip.kt", m8637i = {0}, m8636l = {UMSLNetWorkSender.f38894a}, m8635m = "invokeSuspend", m8634n = {"$this$flow"}, m8633s = {"L$0"})
...
public final class C14924xd7c321e7<R> extends SuspendLambda implements InterfaceC15284p<FlowCollector<? super R>, InterfaceC14268c<? super Unit>, Object> {
    ...
    @DebugMetadata(m8639c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$1", m8638f = "Zip.kt", m8637i = {0, 0, 0, 0, 0}, m8636l = {335}, m8635m = "invokeSuspend", m8634n = {"$this$combineInternal", "it", "continuation", "args", "$receiver"}, m8633s = {"L$0", "L$1", "L$2", "L$3", "L$4"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$1 */
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    public static final class C149251 extends SuspendLambda implements InterfaceC15285q<FlowCollector<? super R>, Object[], InterfaceC14268c<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        /* renamed from: p$ */
        private FlowCollector f42636p$;
        private Object[] p$0;

        public C149251(InterfaceC14268c interfaceC14268c) {
        ...
        public final InterfaceC14268c<Unit> create(@NotNull FlowCollector<? super R> flowCollector, @NotNull Object[] objArr, @NotNull InterfaceC14268c<? super Unit> interfaceC14268c) {
            C149251 c149251 = new C149251(interfaceC14268c);
            c149251.f42636p$ = flowCollector;
            c149251.p$0 = objArr;
            return c149251;
        }
        ...
        public final Object invoke(Object obj, Object[] objArr, InterfaceC14268c<? super Unit> interfaceC14268c) {
            return ((C149251) create((FlowCollector) obj, objArr, interfaceC14268c)).invokeSuspend(Unit.f41048a);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                C14294d0.m8596n(obj);
                FlowCollector flowCollector = this.f42636p$;
                Object[] objArr = this.p$0;
                InterfaceC15286r interfaceC15286r = C14924xd7c321e7.this.$transform$inlined;
    ...
    public C14924xd7c321e7(InterfaceC14958h[] interfaceC14958hArr, InterfaceC14268c interfaceC14268c, InterfaceC15286r interfaceC15286r) {
    ...
    public final InterfaceC14268c<Unit> create(@Nullable Object obj, @NotNull InterfaceC14268c<?> interfaceC14268c) {
        C14924xd7c321e7 c14924xd7c321e7 = new C14924xd7c321e7(this.$flows, interfaceC14268c, this.$transform$inlined);
        c14924xd7c321e7.f42635p$ = (FlowCollector) obj;
        return c14924xd7c321e7;
    }

    @Override // p617l1.InterfaceC15284p
    public final Object invoke(Object obj, InterfaceC14268c<? super Unit> interfaceC14268c) {
        return ((C14924xd7c321e7) create(obj, interfaceC14268c)).invokeSuspend(Unit.f41048a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            C14294d0.m8596n(obj);
            FlowCollector flowCollector = this.f42635p$;
            InterfaceC14958h[] interfaceC14958hArr = this.$flows;
            InterfaceC15269a m4858a = Zip.m4858a();
            C149251 c149251 = new C149251(null);
            this.L$0 = flowCollector;
            this.label = 1;
            if (Combine.m4805a(flowCollector, interfaceC14958hArr, m4858a, c149251, this) == m8642h) {
                return m8642h;
            }
        } else if (i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
