...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    public static /* synthetic */ class C141001 {
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            this.f40683s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40683s, subscription)) {
                this.f40683s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L14:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C141001.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r4) goto L8
                if (r6 == r5) goto L4b
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            this.f40684s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40684s, subscription)) {
                this.f40684s = subscription;
                this.actual.onSubscribe(this);
            }
        }
