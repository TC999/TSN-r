...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    static /* synthetic */ class C141011 {
    ...
    public static abstract class BaseFilterSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public final void onNext(T t) {
            ...
            this.f40686s.request(1L);
        }

        @Override // org.reactivestreams.Subscription
        public final void request(long j) {
            this.f40686s.request(j);
        }
    }
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40686s, subscription)) {
                this.f40686s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L1a:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelFilterTry.C141011.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L7
                if (r6 == r5) goto L50
