...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        public final class RailSubscription implements Subscription {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f40688j + this.f40689m, 0L, 1L)) {
            ...
            public void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.f40688j);
                        if (j2 == Long.MAX_VALUE) {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f40688j, j2, BackpressureHelper.addCap(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f40689m) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40687s, subscription)) {
                this.f40687s = subscription;
