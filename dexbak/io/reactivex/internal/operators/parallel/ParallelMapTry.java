...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    public static /* synthetic */ class C141021 {
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            this.f40692s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40692s, subscription)) {
                this.f40692s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L1b:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelMapTry.C141021.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r4) goto L8
                if (r6 == r5) goto L52
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            this.f40693s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40693s, subscription)) {
                this.f40693s = subscription;
                this.actual.onSubscribe(this);
            }
        }
