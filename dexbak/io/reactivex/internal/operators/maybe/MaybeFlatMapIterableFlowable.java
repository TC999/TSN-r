...
public final class MaybeFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements MaybeObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f40540it;
        final Function<? super T, ? extends Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void cancel() {
            this.cancelled = true;
            this.f40539d.dispose();
            this.f40539d = DisposableHelper.DISPOSED;
        }
        ...
        void drain() {
            ...
            Iterator<? extends R> it = this.f40540it;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f40539d, disposable)) {
                this.f40539d = disposable;
