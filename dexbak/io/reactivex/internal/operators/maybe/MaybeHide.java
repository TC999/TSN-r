...
public final class MaybeHide<T> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class HideMaybeObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            this.f40547d.dispose();
            this.f40547d = DisposableHelper.DISPOSED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f40547d.isDisposed();
        }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f40547d, disposable)) {
                this.f40547d = disposable;
