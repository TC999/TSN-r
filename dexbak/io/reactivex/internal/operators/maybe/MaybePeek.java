...
public final class MaybePeek<T> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class MaybePeekObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            ...
            this.f40556d = DisposableHelper.DISPOSED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f40556d.isDisposed();
        }
        ...
        public void onComplete() {
            Disposable disposable = this.f40556d;
        ...
        public void onError(Throwable th) {
            if (this.f40556d == DisposableHelper.DISPOSED) {
                RxJavaPlugins.onError(th);
            } else {
                onErrorInner(th);
            }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f40556d, disposable)) {
                try {
                    this.parent.onSubscribeCall.accept(disposable);
                    this.f40556d = disposable;
