...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowExactBoundedObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            ...
            if (DisposableHelper.validate(this.f40674s, disposable)) {
                this.f40674s = disposable;
                Observer<? super V> observer = this.actual;
        ...
        */
        void drainLoop() {
            ...
            L38:
                ...
                goto L9
            L4d:
                io.reactivex.disposables.Disposable r4 = r7.f40675s
                r4.dispose()
                goto L9
            L53:
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f40675s, disposable)) {
                this.f40675s = disposable;
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
        ...
        public final class CompletionTask implements Runnable {
            ...
            /* renamed from: w */
            private final UnicastSubject<T> f40677w;

            CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f40677w = unicastSubject;
            }

            @Override // java.lang.Runnable
            public void run() {
                WindowSkipObserver.this.complete(this.f40677w);
            }
        }
        ...
        public static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastSubject<T> f40678w;

            SubjectWork(UnicastSubject<T> unicastSubject, boolean z) {
                this.f40678w = unicastSubject;
                this.open = z;
            }
        }
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f40678w);
                        subjectWork.f40678w.onComplete();
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f40676s, disposable)) {
                this.f40676s = disposable;
