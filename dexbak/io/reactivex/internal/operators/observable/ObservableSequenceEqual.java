    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f40635v1 == null) {
                    this.f40635v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f40635v1 == null;
                if (this.f40636v2 == null) {
                    this.f40636v2 = spscLinkedArrayQueue2.poll();
                }
                T t = this.f40636v2;
                boolean z4 = t == null;
                if (z && z2 && z3 && z4) {
                    ...
                    if (!z3 && !z4) {
                        try {
                            if (!this.comparer.test((T) this.f40635v1, t)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.actual.onNext(Boolean.FALSE);
                                this.actual.onComplete();
                                return;
