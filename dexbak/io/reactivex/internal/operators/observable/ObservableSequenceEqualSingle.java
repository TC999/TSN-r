    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f40637v1 == null) {
                    this.f40637v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f40637v1 == null;
                if (this.f40638v2 == null) {
                    this.f40638v2 = spscLinkedArrayQueue2.poll();
                }
                T t = this.f40638v2;
                boolean z4 = t == null;
                if (z && z2 && z3 && z4) {
                    ...
                    if (!z3 && !z4) {
                        try {
                            if (!this.comparer.test((T) this.f40637v1, t)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.actual.onSuccess(Boolean.FALSE);
                                return;
                            }
