...
public final class FlowableWindowBoundarySelector<T, B, V> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    public static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f40517w;
    ...
    static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* renamed from: s */
        Subscription f40518s;
        final AtomicLong windows;

        /* renamed from: ws */
        final List<UnicastProcessor<T>> f40519ws;
        ...
        void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f40517w, null));
            if (enter()) {
                drainLoop();
            }
        }
        ...
        void drainLoop() {
            ...
            List<UnicastProcessor<T>> list = this.f40519ws;
            int i = 1;
            while (true) {
                boolean z = this.done;
                ...
                if (z && z2) {
                    ...
                    UnicastProcessor<T> unicastProcessor3 = windowOperation.f40520w;
                    if (unicastProcessor3 != null) {
                        if (list.remove(unicastProcessor3)) {
                            windowOperation.f40520w.onComplete();
        ...
        public void onNext(T t) {
            ...
            if (fastEnter()) {
                for (UnicastProcessor<T> unicastProcessor : this.f40519ws) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40518s, subscription)) {
                this.f40518s = subscription;
    ...
    public static final class WindowOperation<T, B> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f40520w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b) {
            this.f40520w = unicastProcessor;
            this.open = b;
        }
    }
