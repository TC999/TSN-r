...
public final class FlowableConcatMap<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    /* loaded from: E:\fuckcool\tsn\5406560.dex */
    public static /* synthetic */ class C140971 {
    ...
    public static abstract class BaseConcatMapSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, ConcatMapSupport<R>, Subscription {
        ...
        public final void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40421s, subscription)) {
                this.f40421s = subscription;
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        int i2 = C140971.$SwitchMap$io$reactivex$internal$util$ErrorMode[errorMode.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
