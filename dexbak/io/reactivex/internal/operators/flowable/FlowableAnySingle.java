...
public final class FlowableAnySingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    static final class AnySubscriber<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void dispose() {
            this.f40405s.cancel();
            this.f40405s = SubscriptionHelper.CANCELLED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f40405s == SubscriptionHelper.CANCELLED;
        }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f40405s, subscription)) {
                this.f40405s = subscription;
