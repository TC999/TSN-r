...
public final class ObserverFullArbiter<T> extends FullArbiterPad1 implements Disposable {
    ...
    /* renamed from: s */
    volatile Disposable f40351s = EmptyDisposable.INSTANCE;
    ...
    public boolean setDisposable(Disposable disposable) {
        ...
        this.queue.offer(this.f40351s, NotificationLite.disposable(disposable));
        drain();
        return true;
    }
}
