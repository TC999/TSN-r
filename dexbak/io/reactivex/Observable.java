...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    static /* synthetic */ class C140931 {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m12674to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C140931.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
