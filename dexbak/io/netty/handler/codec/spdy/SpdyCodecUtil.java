...
final class SpdyCodecUtil {
    ...
    public static int getSignedInt(ByteBuf byteBuf, int i) {
        return (byteBuf.getByte(i + 3) & UByte.f41242c) | ((byteBuf.getByte(i) & UByte.f41242c) << 24) | ((byteBuf.getByte(i + 1) & UByte.f41242c) << 16) | ((byteBuf.getByte(i + 2) & UByte.f41242c) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedInt(ByteBuf byteBuf, int i) {
        return (byteBuf.getByte(i + 3) & UByte.f41242c) | ((byteBuf.getByte(i) & C14354n.f41155b) << 24) | ((byteBuf.getByte(i + 1) & UByte.f41242c) << 16) | ((byteBuf.getByte(i + 2) & UByte.f41242c) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedMedium(ByteBuf byteBuf, int i) {
        return (byteBuf.getByte(i + 2) & UByte.f41242c) | ((byteBuf.getByte(i) & UByte.f41242c) << 16) | ((byteBuf.getByte(i + 1) & UByte.f41242c) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedShort(ByteBuf byteBuf, int i) {
        return (byteBuf.getByte(i + 1) & UByte.f41242c) | ((byteBuf.getByte(i) & UByte.f41242c) << 8);
    }
