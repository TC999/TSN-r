...
public class StompSubframeDecoder extends ReplayingDecoder<State> {
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    static /* synthetic */ class C139191 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$stomp$StompSubframeDecoder$State */
        static final /* synthetic */ int[] f40272x1128a9ae;

        static {
            int[] iArr = new int[State.values().length];
            f40272x1128a9ae = iArr;
            try {
                iArr[State.SKIP_CONTROL_CHARACTERS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f40272x1128a9ae[State.READ_HEADERS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40272x1128a9ae[State.BAD_FRAME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f40272x1128a9ae[State.READ_CONTENT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f40272x1128a9ae[State.FINALIZE_FRAME_READ.ordinal()] = 5;
    ...
    private static long getContentLength(StompHeaders stompHeaders, long j) {
        ...
        long j2 = stompHeaders.getLong(asciiString, j);
        if (j2 >= 0) {
            return j2;
        }
