...
public class SocksAuthResponseDecoder extends ReplayingDecoder<State> {
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    static /* synthetic */ class C138921 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$socks$SocksAuthResponseDecoder$State */
        static final /* synthetic */ int[] f40245x1e903f96;

        static {
            int[] iArr = new int[State.values().length];
            f40245x1e903f96 = iArr;
            try {
                iArr[State.CHECK_PROTOCOL_VERSION.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f40245x1e903f96[State.READ_AUTH_RESPONSE.ordinal()] = 2;
    ...
    */
    public void decode(io.netty.channel.ChannelHandlerContext r3, io.netty.buffer.ByteBuf r4, java.util.List<java.lang.Object> r5) throws java.lang.Exception {
        /*
            r2 = this;
            int[] r0 = io.netty.handler.codec.socks.SocksAuthResponseDecoder.C138921.f40245x1e903f96
