...
public final class RtspHeaderValues {
    ...
    public static final AsciiString MODE = new AsciiString(RtspHeaders.Values.MODE);
    ...
    public static final AsciiString TIME = new AsciiString(RtspHeaders.Values.TIME);
