...
public final class RtspHeaderNames {
    ...
    public static final AsciiString TIMESTAMP = new AsciiString(CampaignEx.JSON_KEY_TIMESTAMP);
    public static final AsciiString TRANSPORT = new AsciiString(NotificationCompat.CATEGORY_TRANSPORT);
