...
public class HttpPostRequestEncoder implements ChunkedInput<HttpContent> {
    ...
    */
    ...
    private ByteBuf fillByteBuf() {
        if (this.currentBuffer.readableBytes() > 8096) {
            ByteBuf byteBuf = this.currentBuffer;
            ByteBuf slice = byteBuf.slice(byteBuf.readerIndex(), HttpPostBodyUtil.chunkSize);
    ...
    private HttpContent nextChunk() throws ErrorDataEncoderException {
        ...
        ByteBuf byteBuf = this.currentBuffer;
        int readableBytes = byteBuf != null ? 8096 - byteBuf.readableBytes() : HttpPostBodyUtil.chunkSize;
        if (readableBytes <= 0) {
            return new DefaultHttpContent(fillByteBuf());
        }
    ...
    public void addBodyFileUpload(String str, File file, String str2, boolean z) throws ErrorDataEncoderException {
        ...
        if (file != null) {
            if (str2 == null) {
                str2 = z ? "text/plain" : HttpPostBodyUtil.DEFAULT_BINARY_CONTENT_TYPE;
            }
        ...
        if (interfaceHttpData != null) {
            ...
            if (interfaceHttpData instanceof Attribute) {
                ...
                if (this.duringMixedMode) {
                    ...
                    StringBuilder sb2 = new StringBuilder(this.multipartDataBoundary.length() + TTDownloadField.CALL_DOWNLOAD_MODEL_SET_CLICK_TRACK_URL + (this.multipartMixedBoundary.length() * 2) + fileUpload3.getFilename().length() + fileUpload3.getName().length());
                    sb2.append("--");
