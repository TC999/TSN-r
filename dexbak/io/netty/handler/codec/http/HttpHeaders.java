...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    public static final class Names {
        ...
        /* renamed from: TE */
        public static final String f40229TE = "TE";
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        for (String str : all) {
            if (contains(str, charSequence2, z)) {
                return true;
            }
        }
        return false;
    ...
    public HttpHeaders setAll(HttpHeaders httpHeaders) {
        ObjectUtil.checkNotNull(httpHeaders, TTDownloadField.TT_HEADERS);
    ...
    private static boolean contains(String str, CharSequence charSequence, boolean z) {
