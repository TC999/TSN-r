...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    private static final AsciiString WEBSOCKET = new AsciiString(HttpHeaders.Values.WEBSOCKET);
    ...
    private static String insertSpaces(String str, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ...
            str = str.substring(0, randomNumber) + HttpConstants.SP_CHAR + str.substring(randomNumber);
        }
        return str;
    }
