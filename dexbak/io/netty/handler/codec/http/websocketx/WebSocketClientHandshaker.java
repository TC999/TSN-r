...
public abstract class WebSocketClientHandshaker {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static CharSequence websocketOriginValue(String str, int i) {
        StringBuilder sb = new StringBuilder();
        HttpScheme httpScheme = HttpScheme.HTTPS;
        sb.append((Object) (i == httpScheme.port() ? httpScheme.name() : HttpScheme.HTTP.name()));
        sb.append("://");
        sb.append(str);
        String sb2 = sb.toString();
        if (i == HttpScheme.HTTP.port() || i == httpScheme.port()) {
            return sb2;
        }
        return sb2 + ':' + i;
    }
