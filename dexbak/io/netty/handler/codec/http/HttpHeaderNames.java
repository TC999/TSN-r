...
public final class HttpHeaderNames {
    ...
    public static final AsciiString ETAG = new AsciiString(DownloadModel.ETAG);
    ...
    public static final AsciiString FROM = new AsciiString(Constants.FROM);
    ...
    public static final AsciiString LOCATION = new AsciiString(SocializeConstants.KEY_LOCATION);
    ...
    /* renamed from: TE */
    public static final AsciiString f40228TE = new AsciiString("te");
    ...
    public static final AsciiString VIA = new AsciiString(SocializeProtocolConstants.PROTOCOL_KEY_VERIFY_MEDIA);
