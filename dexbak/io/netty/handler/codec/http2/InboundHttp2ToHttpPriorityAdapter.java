...
public final class InboundHttp2ToHttpPriorityAdapter extends InboundHttp2ToHttpAdapter {
    ...
    private static void addHttpHeadersToHttp2Headers(HttpHeaders httpHeaders, Http2Headers http2Headers) {
        ...
        while (iteratorCharSequence.hasNext()) {
            ...
            http2Headers.add((Http2Headers) AsciiString.m12682of(next.getKey()), AsciiString.m12682of(next.getValue()));
        }
    }
    ...
    public void onPriorityTreeParentChanged(Http2Stream http2Stream, Http2Stream http2Stream2) {
        ...
        if (message == null) {
            ...
            defaultHttpHeaders.setInt(HttpConversionUtil.ExtensionHeaderNames.STREAM_DEPENDENCY_ID.text(), parent.mo12684id());
            ...
            getActiveHeaders(message).setInt(HttpConversionUtil.ExtensionHeaderNames.STREAM_DEPENDENCY_ID.text(), parent.mo12684id());
        }
    }
