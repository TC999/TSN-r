...
public final class HttpConversionUtil {
    ...
    public static final class Http2ToHttpHeaderTranslator {
        ...
        public void translate(Map.Entry<CharSequence, CharSequence> entry) throws Http2Exception {
            ...
            if (asciiString != null) {
                this.output.add(asciiString, AsciiString.m12682of(value));
    ...
    static {
        ...
        OUT_OF_MESSAGE_SEQUENCE_RETURN_CODE = HttpResponseStatus.f40230OK;
    ...
    private static void setHttp2Scheme(HttpHeaders httpHeaders, URI uri, Http2Headers http2Headers) {
        ...
        if (str != null) {
            http2Headers.scheme(AsciiString.m12682of(str));
            return;
        }
    ...
    public static void toHttp2Headers(HttpHeaders httpHeaders, Http2Headers http2Headers) {
        ...
        while (iteratorCharSequence.hasNext()) {
            ...
            AsciiString lowerCase = AsciiString.m12682of(next.getKey()).toLowerCase();
            if (!HTTP_TO_HTTP2_HEADER_BLACKLIST.contains(lowerCase)) {
                AsciiString asciiString2 = HttpHeaderNames.f40228TE;
                ...
                if (lowerCase.contentEqualsIgnoreCase(asciiString3)) {
                    AsciiString m12682of = AsciiString.m12682of(next.getValue());
                    try {
                        int forEachByte = m12682of.forEachByte(ByteProcessor.FIND_SEMI_COLON);
                        if (forEachByte != -1) {
                            int i = 0;
                            do {
                                asciiString = HttpHeaderNames.COOKIE;
                                http2Headers.add((Http2Headers) asciiString, m12682of.subSequence(i, forEachByte, false));
                                i = forEachByte + 2;
                                if (i >= m12682of.length()) {
                                    break;
                                }
                                forEachByte = m12682of.forEachByte(i, m12682of.length() - i, ByteProcessor.FIND_SEMI_COLON);
                            } while (forEachByte != -1);
                            if (i < m12682of.length()) {
                                http2Headers.add((Http2Headers) asciiString, m12682of.subSequence(i, m12682of.length(), false));
                            } else {
                                throw new IllegalArgumentException("cookie value is of unexpected format: " + ((Object) m12682of));
                            }
                        } else {
                            http2Headers.add((Http2Headers) asciiString3, m12682of);
                        }
                    } catch (Exception e) {
