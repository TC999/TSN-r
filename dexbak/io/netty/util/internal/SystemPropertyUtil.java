...
public final class SystemPropertyUtil {
    ...
    public static int getInt(String str, int i) {
        ...
        logger.warn("Unable to parse the integer system property '{}':{} - using the default value: {}", str, lowerCase, Integer.valueOf(i));
        return i;
    }
    ...
    public static long getLong(String str, long j) {
        ...
        logger.warn("Unable to parse the long integer system property '{}':{} - using the default value: {}", str, lowerCase, Long.valueOf(j));
        return j;
    }
