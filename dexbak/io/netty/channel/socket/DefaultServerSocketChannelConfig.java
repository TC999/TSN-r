...
public class DefaultServerSocketChannelConfig extends DefaultChannelConfig implements ServerSocketChannelConfig {
    ...
    public ServerSocketChannelConfig mo60143setBacklog(int i) {
        if (i >= 0) {
            this.backlog = i;
            return this;
        }
    ...
    public <T> boolean setOption(ChannelOption<T> channelOption, T t) {
        ...
        if (channelOption == ChannelOption.SO_RCVBUF) {
            mo60144setReceiveBufferSize(((Integer) t).intValue());
            return true;
        } else if (channelOption == ChannelOption.SO_REUSEADDR) {
            mo60145setReuseAddress(((Boolean) t).booleanValue());
            return true;
        } else if (channelOption == ChannelOption.SO_BACKLOG) {
            mo60143setBacklog(((Integer) t).intValue());
            return true;
        } else {
    ...
    public ServerSocketChannelConfig mo60144setReceiveBufferSize(int i) {
        try {
    ...
    public ServerSocketChannelConfig mo60145setReuseAddress(boolean z) {
        try {
