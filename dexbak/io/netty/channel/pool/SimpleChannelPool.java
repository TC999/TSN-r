...
public class SimpleChannelPool implements ChannelPool {
    ...
    private Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        ...
        if (pollChannel == null) {
            Bootstrap mo60142clone = this.bootstrap.mo60142clone();
            mo60142clone.attr(POOL_KEY, this);
            ChannelFuture connectChannel = connectChannel(mo60142clone);
    ...
    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z) {
        ...
        Bootstrap mo60142clone = ((Bootstrap) ObjectUtil.checkNotNull(bootstrap, "bootstrap")).mo60142clone();
        this.bootstrap = mo60142clone;
        mo60142clone.handler(new ChannelInitializer<Channel>() { // from class: io.netty.channel.pool.SimpleChannelPool.1
            static final /* synthetic */ boolean $assertionsDisabled = false;
