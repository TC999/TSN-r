...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    /* renamed from: ch */
    private final SelectableChannel f40187ch;
    ...
    public AbstractNioChannel(Channel channel, SelectableChannel selectableChannel, int i) {
        ...
        this.f40187ch = selectableChannel;
    ...
    protected void doRegister() throws Exception {
        ...
        while (true) {
            try {
                this.selectionKey = mo60146javaChannel().register(eventLoop().selector, 0, this);
                return;
    ...
    public SelectableChannel mo60146javaChannel() {
        return this.f40187ch;
    }
    ...
    public abstract class AbstractNioUnsafe extends AbstractChannel.AbstractUnsafe implements NioUnsafe {
        ...
        /* renamed from: ch */
        public final SelectableChannel mo12688ch() {
            return AbstractNioChannel.this.mo60146javaChannel();
        }
