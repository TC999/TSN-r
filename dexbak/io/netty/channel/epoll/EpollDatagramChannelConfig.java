...
public final class EpollDatagramChannelConfig extends EpollChannelConfig implements DatagramChannelConfig {
    ...
    public int getReceiveBufferSize() {
        try {
            return this.datagramChannel.mo12687fd().getReceiveBufferSize();
        } catch (IOException e) {
    ...
    public int getSendBufferSize() {
        try {
            return this.datagramChannel.mo12687fd().getSendBufferSize();
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    }
    ...
    public int getTrafficClass() {
        try {
            return Native.getTrafficClass(this.datagramChannel.mo12687fd().intValue());
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    }
    ...
    public boolean isBroadcast() {
        try {
            return Native.isBroadcast(this.datagramChannel.mo12687fd().intValue()) == 1;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    }
    ...
    public boolean isReuseAddress() {
        try {
            return Native.isReuseAddress(this.datagramChannel.mo12687fd().intValue()) == 1;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    }
    ...
    public boolean isReusePort() {
        try {
            return Native.isReusePort(this.datagramChannel.mo12687fd().intValue()) == 1;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    }
    ...
    public EpollDatagramChannelConfig setReusePort(boolean z) {
        try {
            Native.setReusePort(this.datagramChannel.mo12687fd().intValue(), z ? 1 : 0);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    ...
    public EpollDatagramChannelConfig setBroadcast(boolean z) {
        try {
            Native.setBroadcast(this.datagramChannel.mo12687fd().intValue(), z ? 1 : 0);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    ...
    public EpollDatagramChannelConfig setReceiveBufferSize(int i) {
        try {
            this.datagramChannel.mo12687fd().setReceiveBufferSize(i);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    ...
    public EpollDatagramChannelConfig setReuseAddress(boolean z) {
        try {
            Native.setReuseAddress(this.datagramChannel.mo12687fd().intValue(), z ? 1 : 0);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    ...
    public EpollDatagramChannelConfig setSendBufferSize(int i) {
        try {
            this.datagramChannel.mo12687fd().setSendBufferSize(i);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
    ...
    public EpollDatagramChannelConfig setTrafficClass(int i) {
        try {
            Native.setTrafficClass(this.datagramChannel.mo12687fd().intValue(), i);
            return this;
        } catch (IOException e) {
            throw new ChannelException(e);
        }
