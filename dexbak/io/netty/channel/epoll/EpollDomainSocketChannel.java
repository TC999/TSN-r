...
public final class EpollDomainSocketChannel extends AbstractEpollStreamChannel implements DomainSocketChannel {
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    public static /* synthetic */ class C136911 {
    ...
    public final class EpollDomainUnsafe extends AbstractEpollStreamChannel.EpollStreamUnsafe {
        ...
        private void epollInReadFd() {
            if (EpollDomainSocketChannel.this.mo12687fd().isInputShutdown()) {
                clearEpollIn0();
                return;
            }
            ...
            do {
                try {
                    recvBufAllocHandle.lastBytesRead(Native.recvFd(EpollDomainSocketChannel.this.mo12687fd().intValue()));
        ...
        public void epollInReady() {
            int i = C136911.$SwitchMap$io$netty$channel$unix$DomainSocketReadMode[EpollDomainSocketChannel.this.config().getReadMode().ordinal()];
            if (i == 1) {
                super.epollInReady();
            } else if (i == 2) {
                epollInReadFd();
        ...
        /* synthetic */ EpollDomainUnsafe(EpollDomainSocketChannel epollDomainSocketChannel, C136911 c136911) {
            this();
        }
    }
    ...
    public boolean doWriteSingle(ChannelOutboundBuffer channelOutboundBuffer, int i) throws Exception {
        ...
        if ((current instanceof FileDescriptor) && Native.sendFd(mo12687fd().intValue(), ((FileDescriptor) current).intValue()) > 0) {
