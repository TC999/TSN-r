...
public abstract class AbstractEpollServerChannel extends AbstractEpollChannel implements ServerChannel {
    ...
    public final class EpollServerSocketUnsafe extends AbstractEpollChannel.AbstractEpollUnsafe {
        ...
        public void epollInReady() {
            if (AbstractEpollServerChannel.this.mo12687fd().isInputShutdown()) {
                clearEpollIn0();
                return;
            }
            ...
            do {
                try {
                    recvBufAllocHandle.lastBytesRead(AbstractEpollServerChannel.this.mo12687fd().accept(this.acceptedAddress));
                    if (recvBufAllocHandle.lastBytesRead() == -1) {
                        break;
                    }
                    recvBufAllocHandle.incMessagesRead(1);
                    byte b = this.acceptedAddress[0];
                    this.readPending = false;
                    pipeline.fireChannelRead((Object) AbstractEpollServerChannel.this.newChildChannel(recvBufAllocHandle.lastBytesRead(), this.acceptedAddress, 1, b));
                } catch (Throwable th2) {
                    th = th2;
                }
