...
public abstract class Service {
    ...
    private void terminateQueue() {
        synchronized (this.qLock) {
            if (this.f40789q != null) {
                ...
                vector.setSize(1);
                this.f40789q.enqueue(new TerminatorEvent(), vector);
                this.f40789q = null;
            }
        }
    }
    ...
    public void queueEvent(MailEvent mailEvent, Vector vector) {
        synchronized (this.qLock) {
            if (this.f40789q == null) {
                this.f40789q = new EventQueue();
            }
        }
        this.f40789q.enqueue(mailEvent, (Vector) vector.clone());
    }
