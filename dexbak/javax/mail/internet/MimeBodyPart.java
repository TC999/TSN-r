...
public class MimeBodyPart extends BodyPart implements MimePart {
    ...
    /* renamed from: dh */
    protected DataHandler f40792dh;
    ...
    public static void invalidateContentHeaders(MimePart mimePart) throws MessagingException {
        ...
        mimePart.removeHeader(HttpHeaders.Names.CONTENT_TRANSFER_ENCODING);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setEncoding(MimePart mimePart, String str) throws MessagingException {
        mimePart.setHeader(HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, str);
    }
    ...
    public DataHandler getDataHandler() throws MessagingException {
        if (this.f40792dh == null) {
            this.f40792dh = new DataHandler(new MimePartDataSource(this));
        }
        return this.f40792dh;
    }
    ...
    public void updateHeaders() throws MessagingException {
        ...
        if (this.cachedContent != null) {
            this.f40792dh = new DataHandler(this.cachedContent, getContentType());
            this.cachedContent = null;
            this.content = null;
            InputStream inputStream = this.contentStream;
            if (inputStream != null) {
    ...
    public static String getEncoding(MimePart mimePart) throws MessagingException {
        ...
        int type;
        String header = mimePart.getHeader(HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, null);
        if (header == null) {
            return null;
        }
