...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdaptedFunctionReference) {
            ...
            return this.isTopLevel == adaptedFunctionReference.isTopLevel && this.arity == adaptedFunctionReference.arity && this.flags == adaptedFunctionReference.flags && C14342f0.m8193g(this.receiver, adaptedFunctionReference.receiver) && C14342f0.m8193g(this.owner, adaptedFunctionReference.owner) && this.name.equals(adaptedFunctionReference.name) && this.signature.equals(adaptedFunctionReference.signature);
        }
        return false;
    }
