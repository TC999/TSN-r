...
public class ContentProviderProxy extends ContentProvider {
    ...
    public Bundle call(@NonNull String str, @Nullable String str2, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#call(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
            return null;
        }
    }
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#delete(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return -1;
    }
    ...
    public String getType(@NonNull Uri uri) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#getType className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#insert(2 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#query(5 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String str, @Nullable String[] strArr) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#update(4 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return 0;
    }
    ...
    private PluginContentProvider obtainPluginProvider(Uri uri, String str, String str2) {
        ...
        if (str2 == null) {
            ZeusLogger.m37077w(ZeusLogger.TAG_PROVIDER, "[Method:obtainPluginProvider()] plugin Authority is null !!! plugin provider can not find !!");
        }
        PluginContentProvider pluginProvider = this.mPluginProviderManager.getPluginProvider(new ContentProviderManager.C6185b(optString2, optString, str2));
    ...
    public int delete(@NonNull Uri uri, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#delete(2 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return -1;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#insert(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2, @Nullable CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#query(6 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#update(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return 0;
    }
    ...
    public Bundle call(@NonNull String str, @NonNull String str2, @Nullable String str3, @Nullable Bundle bundle) {
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#call(4 params-Added in API level 29) className=" + getClass().getSimpleName() + ",exception:", th);
            return null;
        }
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable Bundle bundle, @Nullable CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            ZeusLogger.m37076w(ZeusLogger.TAG_PROVIDER, "proxy provider#query(4 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
}
