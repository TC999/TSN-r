...
public interface TTLiveConstants {
    ...
    public static final String EXPAND_METHOD_NAME_KEY = "expand_method_name";
    public static final String EXPAND_METHOD_PARAM_KEY = "expand_method_param";
    ...
    public static final String INIT_APP_NAME = "app_name";
    public static final String INIT_CHANNEL = "channel";
    public static final String INIT_CUSTOM_CONTROLLER = "c_control";
    public static final String INIT_DEBUG = "debug";
    public static final String INIT_EC_HOST_APPID = "ec_host_appid";
    public static final String INIT_GENERATE_APPID = "g_appid";
    public static final String INIT_PARTENER = "partner";
    public static final String INIT_PARTENER_SECERET = "p_secret";
    public static final String INIT_SUB_PROCESS = "sub_process";
    ...
    public static final int LIVE_SDK_STATUS_INIT_FAILED = -3;
    ...
    public static final String SCHEME_URI_KEY = "scheme_uri";
    @Deprecated
