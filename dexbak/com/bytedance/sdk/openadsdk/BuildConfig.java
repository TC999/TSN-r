...
public final class BuildConfig {
    ...
    public static final String COMMIT_HASH = "2a17075";
    ...
    public static final String PLUGIN_PACKAGE_NAME = "com.byted.pangle.m";
    public static final int VERSION_CODE = 5908;
    public static final String VERSION_NAME = "5.9.0.8";
}
