...
public final class MarkerOptions extends BaseOptions implements Parcelable, Cloneable {
    ...
    /* renamed from: b */
    private void m52037b() {
        LatLng latLng;
        try {
            if (!this.isGps || (latLng = this.latLng) == null) {
                return;
            }
            double[] m51135a = C2477a.m51135a(latLng.longitude, latLng.latitude);
            this.gpsLatLng = new LatLng(m51135a[1], m51135a[0]);
    ...
    /* renamed from: clone */
    public final MarkerOptions m60103clone() {
        try {
            super.clone();
        ...
        markerOptions.f7050a = this.f7050a;
