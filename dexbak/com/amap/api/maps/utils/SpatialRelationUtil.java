...
public class SpatialRelationUtil {
            ...
            try {
                if (list.size() != 0) {
                    ...
                    if (calShortestDistancePoint != null) {
                        ...
                        if (AMapUtils.calculateLineDistance(new LatLng(dPoint.f7977x, dPoint.f7978y), latLng) < d) {
                            Object obj = calShortestDistancePoint.first;
                            Object obj2 = calShortestDistancePoint.second;
                            return new Pair<>(obj, new LatLng(((DPoint) obj2).f7977x, ((DPoint) obj2).f7978y));
                        }
                    }
                }
            } catch (Throwable th) {
    ...
    private static boolean checkRotateIsMatch(DPoint dPoint, DPoint dPoint2, float f) {
        ...
        if (dPoint != null && dPoint2 != null) {
            float abs = Math.abs((C1732a3.m55706g(dPoint, dPoint2) + 360.0f) - f) % 360.0f;
            if (abs > 180.0f) {
                abs = 360.0f - abs;
            }
            if (abs < 50.0f) {
            ...
            if (list.size() >= 2) {
                ...
                while (true) {
                    ...
                    if (!checkRotateIsMatch(dPoint3, dPoint4, f)) {
                        ...
                        d = d2;
                        i = size;
                        Pair<Double, DPoint> pointToSegDist = pointToSegDist(dPoint2.f7977x, dPoint2.f7978y, dPoint3.f7977x, dPoint3.f7978y, dPoint4.f7977x, dPoint4.f7978y);
                        if (pair2 == null) {
                            doubleValue = ((Double) pointToSegDist.first).doubleValue();
                            pair = new Pair<>(Integer.valueOf(i2 - 1), pointToSegDist.second);
