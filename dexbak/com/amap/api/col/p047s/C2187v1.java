...
public class C2187v1 {
    ...
    /* renamed from: b */
    private static String m52394b(byte[] bArr, int i) throws IOException {
        if (bArr != null) {
            if (i >= 0) {
                if (i + 0 <= bArr.length) {
                    ...
                    int i5 = 0;
                    while (i4 < i3) {
                        m52392d(bArr, i4 + 0, 3, bArr2, i5);
                        i4 += 3;
                        i5 += 4;
                    }
                    if (i4 < i) {
                        m52392d(bArr, i4 + 0, i - i4, bArr2, i5);
                        i5 += 4;
                    }
                    if (i5 <= i2 - 1) {
    ...
    /* renamed from: c */
    public static byte[] m52393c(String str) throws IOException {
        return m52391e(str);
    }

    /* renamed from: d */
    private static byte[] m52392d(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        byte[] bArr3 = f6608a;
    ...
    /* renamed from: e */
    private static byte[] m52391e(String str) throws IOException {
        byte[] bytes;
        ...
        if (str != null) {
            ...
            byte[] m52390f = m52390f(bytes, bytes.length);
            if (m52390f.length >= 4 && 35615 == ((m52390f[0] & UByte.f41242c) | ((m52390f[1] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK))) {
                ...
                try {
                    try {
                        ...
                        try {
                            byteArrayInputStream = new ByteArrayInputStream(m52390f);
                            try {
                                ...
                                m52390f = byteArrayOutputStream2.toByteArray();
    ...
    /* renamed from: f */
    private static byte[] m52390f(byte[] bArr, int i) throws IOException {
        int i2;
        if (bArr != null) {
            int i3 = i + 0;
            int i4 = 1;
