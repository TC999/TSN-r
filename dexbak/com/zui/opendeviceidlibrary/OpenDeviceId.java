    ...
    public String getAAID() {
        ...
        try {
            ...
            if (iDeviceidInterface != null) {
                ...
                return ((aaid == null || "".equals(aaid)) && this.mDeviceidInterface.mo12845f(packageName)) ? this.mDeviceidInterface.getAAID(packageName) : aaid;
            }
            return null;
        ...
        if (context != null) {
            ...
            this.mConnection = new ServiceConnection() { // from class: com.zui.opendeviceidlibrary.OpenDeviceId.1
                ...
                public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    OpenDeviceId.this.mDeviceidInterface = IDeviceidInterface.Stub.m12846a(iBinder);
