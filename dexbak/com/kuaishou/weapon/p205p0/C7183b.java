...
/* renamed from: com.kuaishou.weapon.p0.b */
/* loaded from: E:\fuckcool\tsn\6520572.dex */
public final class C7183b {

    /* renamed from: a */
    public static final String f24540a = "AES/CBC/NoPadding";

    /* renamed from: b */
    public static final int f24541b = 16;

    /* renamed from: c */
    public static final String f24542c = "a3NyaXNrY3RsYnVzaW5zc3Z4cHprd3NwYWlvcXBrc3M=";

    /* renamed from: d */
    private static final String f24543d = "AES/CBC/PKCS5Padding";

    /* renamed from: e */
    private static final String f24544e = "AES";

    /* renamed from: f */
    private static final String f24545f = "AES/CBC/PKCS7Padding";

    /* renamed from: a */
    public static byte[] m34307a(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str.getBytes(), f24544e);
        Cipher cipher = Cipher.getInstance(f24543d);
        cipher.init(1, secretKeySpec, new IvParameterSpec(str2.getBytes()));
        return cipher.doFinal(bArr);
    }

    /* renamed from: b */
    public static byte[] m34305b(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str2.getBytes(), f24544e);
        Cipher cipher = Cipher.getInstance(f24543d);
    ...
    */
    public static int m34304c(java.lang.String r7, java.lang.String r8, byte[] r9) {
        /*
            r0 = -1
        ...
        L9c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kuaishou.weapon.p205p0.C7183b.m34304c(java.lang.String, java.lang.String, byte[]):int");
    }

    /* renamed from: a */
    public static byte[] m34306a(byte[] bArr, byte[] bArr2, boolean z) {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, f24544e);
            Cipher cipher = Cipher.getInstance(f24543d);
