...
public final class GlideException extends Exception {
    ...
    private void printStackTrace(Appendable appendable) {
        ...
        appendCauses(getCauses(), new C3573a(appendable));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.bumptech.glide.load.engine.GlideException$a */
    /* loaded from: E:\fuckcool\tsn\7241516.dex */
    public static final class C3573a implements Appendable {
        ...
        /* renamed from: a */
        private final Appendable f13538a;

        /* renamed from: b */
        private boolean f13539b = true;

        C3573a(Appendable appendable) {
            this.f13538a = appendable;
        }

        @NonNull
        /* renamed from: a */
        private CharSequence m45430a(@Nullable CharSequence charSequence) {
        ...
        public Appendable append(char c) throws IOException {
            if (this.f13539b) {
                this.f13539b = false;
                this.f13538a.append(f13537d);
            }
            this.f13539b = c == '\n';
            this.f13538a.append(c);
            return this;
        }

        @Override // java.lang.Appendable
        public Appendable append(@Nullable CharSequence charSequence) throws IOException {
            CharSequence m45430a = m45430a(charSequence);
            return append(m45430a, 0, m45430a.length());
        }
        ...
        public Appendable append(@Nullable CharSequence charSequence, int i, int i2) throws IOException {
            ...
            if (m45430a.length() > 0 && m45430a.charAt(i2 - 1) == '\n') {
                z = true;
            }
            this.f13539b = z;
            this.f13538a.append(m45430a, i, i2);
            return this;
        }
    }
}
