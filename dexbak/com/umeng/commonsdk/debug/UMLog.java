...
public class UMLog {
    ...
    /* renamed from: AQ */
    private static final String f38750AQ = "├───────────────────解决方案─────────────────────────────────────────────────────────────────────────────";
    ...
    /* renamed from: aq */
    public static void m14016aq(int i, String str, String str2) {
        try {
            if (UMConfigure.isDebugLog()) {
                UInterface logger = getLogger(i);
                logger.log(TAG, TOP_BORDER_AQ);
                logger.log(TAG, "│     " + str);
                logger.log(TAG, f38750AQ);
                logger.log(TAG, "│     " + str2);
    ...
    /* renamed from: aq */
    public static void m14014aq(String str, int i, String str2, String str3) {
        try {
            if (UMConfigure.isDebugLog()) {
                UInterface logger = getLogger(i);
    ...
    /* renamed from: aq */
    public static void m14015aq(String str, int i, String str2) {
        m14012aq((String) null, str, i, str2);
    }

    /* renamed from: aq */
    public static void m14013aq(String str, int i, String str2, String[] strArr, String[] strArr2, String[] strArr3, String[] strArr4) {
        m14011aq(null, str, i, str2, strArr, strArr2, strArr3, strArr4);
    }

    /* renamed from: aq */
    public static void m14012aq(String str, String str2, int i, String str3) {
        m14011aq(str, str2, i, str3, null, null, null, null);
    }
    ...
    /* renamed from: aq */
    public static void m14011aq(String str, String str2, int i, String str3, String[] strArr, String[] strArr2, String[] strArr3, String[] strArr4) {
        String[] split;
        try {
            if (UMConfigure.isDebugLog()) {
