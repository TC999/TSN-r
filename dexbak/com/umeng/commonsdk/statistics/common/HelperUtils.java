...
public class HelperUtils {
    ...
    public static String getMD5(String str) {
        try {
            ...
            StringBuffer stringBuffer = new StringBuffer();
            for (byte b : digest) {
                stringBuffer.append(Integer.toHexString((b & UByte.f41242c) | InputDeviceCompat.SOURCE_ANY).substring(6));
            }
            return stringBuffer.toString();
        } catch (NoSuchAlgorithmException e) {
            MLog.m13813i(TAG, "getMD5 error", e);
            return "";
        }
    }
    ...
    public static String getUmengMD5(String str) {
        try {
            ...
            MLog.m13813i(TAG, "getMD5 error", th);
            return "";
        }
    }
