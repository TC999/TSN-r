...
public class UMDBUtils {
    ...
    */
    public static boolean m14351a(java.lang.String r12, android.database.sqlite.SQLiteDatabase r13) {
        /*
            r0 = 0
            if (r12 != 0) goto L4
            return r0
        ...
        L42:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.analytics.pro.UMDBUtils.m14351a(java.lang.String, android.database.sqlite.SQLiteDatabase):boolean");
    }

    /* renamed from: b */
    public static String m14349b(Context context) {
        File databasePath = context.getDatabasePath(UMDBConfig.f38175b);
        return databasePath.getParent() + File.separator;
    }

    /* renamed from: c */
    public static String m14347c(Context context) {
        return m14349b(context) + UMDBConfig.f38174a;
    }

    /* renamed from: b */
    public static List<String> m14348b(List<String> list) {
    ...
    /* renamed from: a */
    public static void m14355a(Context context) {
        if (context == null) {
            return;
        }
        try {
            ...
            C13155f.m14369a(context).m14370a();
        } catch (Throwable unused) {
        }
    }

    /* renamed from: a */
    public static String m14350a(List<String> list) {
        return TextUtils.join("!", list);
    }

    /* renamed from: a */
    public static List<String> m14352a(String str) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean m14354a(android.database.sqlite.SQLiteDatabase r10, java.lang.String r11, java.lang.String r12) {
        /*
            r2 = 0
            r3 = 0
            r4 = 0
        ...
        L3d:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.analytics.pro.UMDBUtils.m14354a(android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String):boolean");
    }

    /* renamed from: a */
    public static void m14353a(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3) {
