...
public class ZIDManager {
    ...
    /* renamed from: d */
    public static ZIDManager f39657d;

    /* renamed from: a */
    public boolean f39658a = false;
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    public class RunnableC13485a implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ Context f39661a;

        /* renamed from: b */
        public final /* synthetic */ IZIDCompletionCallback f39662b;

        public RunnableC13485a(Context context, IZIDCompletionCallback iZIDCompletionCallback) {
            this.f39661a = context;
            this.f39662b = iZIDCompletionCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            String m13198a = ZIDManager.m13198a(ZIDManager.this, this.f39661a);
            if (TextUtils.isEmpty(m13198a)) {
                IZIDCompletionCallback iZIDCompletionCallback = this.f39662b;
            ...
            IZIDCompletionCallback iZIDCompletionCallback2 = this.f39662b;
            if (iZIDCompletionCallback2 != null) {
                iZIDCompletionCallback2.onSuccess(m13198a);
            }
        }
    }
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    public class RunnableC13486b implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ Context f39664a;

        public RunnableC13486b(Context context) {
            this.f39664a = context;
        }

        @Override // java.lang.Runnable
        public void run() {
            ZIDManager.this.m13197b(this.f39664a);
        }
    }

    /* renamed from: com.umeng.umzid.ZIDManager$c */
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    public class RunnableC13487c implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ Context f39666a;

        public RunnableC13487c(Context context) {
            this.f39666a = context;
        }

        @Override // java.lang.Runnable
        public void run() {
            ZIDManager.m13198a(ZIDManager.this, this.f39666a);
        }
    }
    ...
    */
    public static /* synthetic */ java.lang.String m13198a(com.umeng.umzid.ZIDManager r10, android.content.Context r11) {
        /*
            boolean r0 = r10.f39658a
            r1 = 0
            if (r0 == 0) goto L7
            goto Ldf
        L7:
            ...
            java.lang.String r5 = com.umeng.umzid.C13492d.m13180e(r11)     // Catch: java.lang.Throwable -> Ld9
            java.lang.String r6 = "mc"
            r2.put(r6, r5)     // Catch: java.lang.Throwable -> Ld9
            java.lang.String r6 = com.umeng.umzid.C13492d.m13178f(r11)     // Catch: java.lang.Throwable -> Ld9
            ...
            boolean r9 = com.umeng.umzid.C13492d.m13174i(r11)     // Catch: java.lang.Throwable -> L4c
            r7.put(r8, r9)     // Catch: java.lang.Throwable -> L4c
            java.lang.String r8 = "wifi_pxy"
            boolean r9 = com.umeng.umzid.C13492d.m13173j(r11)     // Catch: java.lang.Throwable -> L4c
            r7.put(r8, r9)     // Catch: java.lang.Throwable -> L4c
            java.lang.String r8 = "double"
            boolean r9 = com.umeng.umzid.C13492d.m13176g(r11)     // Catch: java.lang.Throwable -> L4c
            r7.put(r8, r9)     // Catch: java.lang.Throwable -> L4c
            goto L54
        L4c:
            r8 = move-exception
        ...
        L5b:
            r10.m13199a(r11, r2)     // Catch: java.lang.Throwable -> Ld9
            java.lang.String r7 = com.umeng.umzid.C13492d.m13188b(r11)     // Catch: java.lang.Throwable -> Ld9
        ...
        L6b:
            ...
            java.lang.String r2 = com.umeng.umzid.C13488a.m13195a(r7, r2)     // Catch: java.lang.Throwable -> Ld9
            ...
            if (r2 != r0) goto Ld5
            com.umeng.umzid.C13492d.m13177f(r11, r4)     // Catch: java.lang.Throwable -> Ld9
            com.umeng.umzid.C13492d.m13190a(r11, r5)     // Catch: java.lang.Throwable -> Ld9
            com.umeng.umzid.C13492d.m13187b(r11, r6)     // Catch: java.lang.Throwable -> Ld9
            ...
            if (r0 != 0) goto Lb7
            com.umeng.umzid.C13492d.m13179e(r11, r1)     // Catch: java.lang.Throwable -> Ld9
        Lb7:
            ...
            if (r2 != 0) goto Lc6
            com.umeng.umzid.C13492d.m13181d(r11, r0)     // Catch: java.lang.Throwable -> Ld9
        Lc6:
            java.lang.String r0 = "resetToken"
            java.lang.String r0 = r7.optString(r0)     // Catch: java.lang.Throwable -> Ld9
            boolean r2 = android.text.TextUtils.isEmpty(r0)     // Catch: java.lang.Throwable -> Ld9
            if (r2 != 0) goto Ld5
            com.umeng.umzid.C13492d.m13184c(r11, r0)     // Catch: java.lang.Throwable -> Ld9
        Ld5:
            r10.m13200a(r11)     // Catch: java.lang.Throwable -> Ld9
            goto Ldd
        Ld9:
            r11 = move-exception
        ...
        Le0:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.umzid.ZIDManager.m13198a(com.umeng.umzid.ZIDManager, android.content.Context):java.lang.String");
    }

    public static void configureDomain(Context context, String str) {
        SharedPreferences m13196a;
        SharedPreferences.Editor edit;
        String m13186b = C13492d.m13186b(str);
        if (context == null || m13186b == null || TextUtils.isEmpty(m13186b) || (m13196a = C13488a.m13196a(context)) == null || (edit = m13196a.edit()) == null) {
            return;
        }
        edit.putString("inputDomain", m13186b).commit();
    }
    ...
    /* renamed from: a */
    public final void m13200a(Context context) {
        Object invoke;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String m13197b(android.content.Context r14) {
        /*
            Method dump skipped, instructions count: 373
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.umzid.ZIDManager.m13197b(android.content.Context):java.lang.String");
    }
    ...
    public synchronized String getZID(Context context) {
        ...
        String m13182d = C13492d.m13182d(origApplicationContext);
        if (TextUtils.isEmpty(m13182d)) {
            C13490c.m13192a(new RunnableC13487c(origApplicationContext));
            return "";
        }
        return m13182d;
    }
    ...
    */
    public synchronized void init(android.content.Context r4, java.lang.String r5, com.umeng.umzid.IZIDCompletionCallback r6) {
        /*
            r3 = this;
            monitor-enter(r3)
            boolean r0 = com.umeng.umzid.C13492d.m13175h(r4)     // Catch: java.lang.Throwable -> Laa
            r3.f39660c = r0     // Catch: java.lang.Throwable -> Laa
            if (r0 != 0) goto Lb
            monitor-exit(r3)
            return
        Lb:
        ...
        L29:
            ...
            if (r1 != 0) goto L50
            android.content.SharedPreferences r1 = com.umeng.umzid.C13488a.m13196a(r0)     // Catch: java.lang.Throwable -> Laa
            if (r1 == 0) goto L50
        ...
        L50:
            java.lang.String r5 = com.umeng.umzid.C13492d.m13182d(r0)     // Catch: java.lang.Throwable -> Laa
            if (r5 == 0) goto L6b
            boolean r1 = android.text.TextUtils.isEmpty(r5)     // Catch: java.lang.Throwable -> Laa
            if (r1 == 0) goto L5d
            goto L6b
        L5d:
            ...
            com.umeng.umzid.C13490c.m13192a(r1)     // Catch: java.lang.Throwable -> Laa
            if (r6 == 0) goto L73
        ...
        L6b:
            ...
            com.umeng.umzid.C13490c.m13192a(r5)     // Catch: java.lang.Throwable -> Laa
        L73:
            java.lang.String r5 = ""
            android.content.SharedPreferences r6 = com.umeng.umzid.C13488a.m13196a(r4)     // Catch: java.lang.Throwable -> Laa
            if (r6 == 0) goto L83
        ...
        L83:
            ...
            if (r5 == 0) goto La8
            java.lang.String r5 = ""
            android.content.SharedPreferences r4 = com.umeng.umzid.C13488a.m13196a(r4)     // Catch: java.lang.Throwable -> Laa
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final org.json.JSONObject m13199a(android.content.Context r10, org.json.JSONObject r11) {
        /*
            Method dump skipped, instructions count: 436
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.umzid.ZIDManager.m13199a(android.content.Context, org.json.JSONObject):org.json.JSONObject");
    }
}
