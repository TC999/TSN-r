...
public class UClient {
    ...
    private void addFilePart(String str, byte[] bArr, String str2, OutputStream outputStream) throws IOException {
        outputStream.write(("--" + str2 + END + "Content-Disposition: form-data; name=\"pic\"; filename=\"" + str + "\"" + END + "Content-Type: " + HttpPostBodyUtil.DEFAULT_BINARY_CONTENT_TYPE + END + "Content-Transfer-Encoding: binary" + END + END).getBytes());
    ...
    protected String convertStreamToString(InputStream inputStream) {
        ...
        while (true) {
            try {
                ...
                if (readLine != null) {
                    sb.append(readLine + ShellAdbUtils.f33810d);
                } else {
