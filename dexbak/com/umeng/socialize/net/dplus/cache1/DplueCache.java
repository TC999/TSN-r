...
public class DplueCache {
    /* renamed from: a */
    private static JSONObject m13241a(JSONObject jSONObject) {
    ...
    */
    ...
    public static boolean save(JSONObject jSONObject, File file) throws JSONException, IOException {
        if (file.exists()) {
            ...
            return m13242a(readFile + "," + jSONObject, file);
        }
        file.createNewFile();
        return m13242a(jSONObject.toString(), file);
    }

    /* renamed from: a */
    private static boolean m13242a(String str, File file) {
