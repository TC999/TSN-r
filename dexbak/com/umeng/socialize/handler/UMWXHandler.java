...
public class UMWXHandler extends UMSSOHandler {
    ...
    /* loaded from: E:\fuckcool\tsn\6400276.dex */
    public static /* synthetic */ class C1339623 {
                        ...
                        QueuedWork.runInMain(new Runnable() { // from class: com.umeng.socialize.handler.UMWXHandler.3.1
                            ...
                            public void run() {
                                if (jsonToMap.get(UMWXHandler.ERRORCODE) != null) {
                                    RunnableC133973 runnableC133973 = RunnableC133973.this;
                                    UMAuthListener authListener = UMWXHandler.this.getAuthListener(uMAuthListener);
                                    SHARE_MEDIA share_media = SHARE_MEDIA.WEIXIN;
                                    ...
                                    RunnableC133973 runnableC1339732 = RunnableC133973.this;
                                ...
                                jsonToMap.put(CommonNetImpl.f39530AS, UMWXHandler.this.config.appkey);
                                Map map = jsonToMap;
                    ...
                    QueuedWork.runInMain(new Runnable() { // from class: com.umeng.socialize.handler.UMWXHandler.4.1
                        ...
                        public void run() {
                            if (hashMap.get(UMWXHandler.ERRORCODE) == null && hashMap.get("code") == null) {
                                RunnableC133994 runnableC133994 = RunnableC133994.this;
                                ...
                                RunnableC133994 runnableC1339942 = RunnableC133994.this;
                            ...
                            hashMap.put(CommonNetImpl.f39530AS, UMWXHandler.this.config.appkey);
                            Map map = hashMap;
                            map.put("uid", map.get("openid"));
                            Map map2 = hashMap;
                            map2.put("unionid", map2.get("unionid"));
    ...
    private boolean shareTo(WeiXinShareContent weiXinShareContent) {
        ...
        int i = C1339623.$SwitchMap$com$umeng$socialize$bean$SHARE_MEDIA[this.mTarget.ordinal()];
        if (i == 1) {
            req.scene = 0;
        } else if (i == 2) {
            req.scene = 1;
        ...
        authorize(new UMAuthListener() { // from class: com.umeng.socialize.handler.UMWXHandler.10
            ...
            public void onComplete(SHARE_MEDIA share_media, int i, Map<String, String> map) {
                QueuedWork.runInBack(new Runnable() { // from class: com.umeng.socialize.handler.UMWXHandler.10.1
                    @Override // java.lang.Runnable
                    public void run() {
                        C1338110 c1338110 = C1338110.this;
    ...
    public void onCreate(Context context, PlatformConfig.Platform platform) {
        ...
        if (TextUtils.isEmpty(aPPIDPlatform.getFileProvider())) {
            SLog.m13211E(UmengText.C13466WX.WEIXIN_FILE_PROVIDER_ERROR);
        } else {
        ...
        if (!isAbleShareEmoji(this.mTarget, weiXinShareContent)) {
            QueuedWork.runInMain(new Runnable() { // from class: com.umeng.socialize.handler.UMWXHandler.12
                ...
                public void run() {
                    ...
                    SHARE_MEDIA share_media = UMWXHandler.this.mTarget;
                    shareListener.onError(share_media, new Throwable(UmengErrorCode.ShareDataTypeIllegal.getMessage() + UmengText.C13466WX.WX_CIRCLE_NOT_SUPPORT_EMOJ));
                }
            });
            return false;
            ...
            QueuedWork.runInMain(new Runnable() { // from class: com.umeng.socialize.handler.UMWXHandler.13
                ...
                public void run() {
                    UMShareListener shareListener = UMWXHandler.this.getShareListener(uMShareListener);
                    SHARE_MEDIA share_media = UMWXHandler.this.mTarget;
                    shareListener.onError(share_media, new Throwable(UmengErrorCode.ShareDataTypeIllegal.getMessage() + UmengText.C13466WX.WX_CIRCLE_NOT_SUPPORT_MIN));
                }
            });
            return false;
        } else {
