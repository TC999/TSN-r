...
/* renamed from: com.kwad.components.ad.widget.tailframe.appbar.TailFrameBarAppPortraitHorizontal */
/* loaded from: E:\fuckcool\tsn\6520572.dex */
public class TailFrameBarAppPortraitHorizontal extends AbstractC8522a {
    ...
    public final void mo30422b(@NonNull AdTemplate adTemplate) {
        if (C10487e.m25654F(adTemplate)) {
            ...
            this.f28031Hh.setBackgroundColor(Color.parseColor("#FFFFFF"));
        }
    ...
    public int getLayoutId() {
        return C9659R.C9663layout.ksad_video_tf_bar_app_portrait_horizontal;
    }
