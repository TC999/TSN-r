...
public final class LoadAndDisplayImageTask implements IoUtils.CopyListener, Runnable {
    ...
    private boolean delayIfNeed() {
        if (this.options.shouldDelayBeforeLoading()) {
            C10400L.m26180d(LOG_DELAY_BEFORE_LOADING, Integer.valueOf(this.options.getDelayBeforeLoading()), this.memoryCacheKey);
            try {
                Thread.sleep(this.options.getDelayBeforeLoading());
                return isTaskNotActual();
            } catch (InterruptedException unused) {
                C10400L.m26179e(LOG_TASK_INTERRUPTED, this.memoryCacheKey);
                return true;
            }
        }
        return false;
    ...
    private boolean downloadImage() {
        ...
        if (stream == null) {
            C10400L.m26179e(ERROR_NO_IMAGE_STREAM, this.memoryCacheKey);
            return false;
        }
        try {
            return this.configuration.diskCache.save(this.uri, stream, this);
        } finally {
            C10738b.closeQuietly(stream);
        }
    }
    ...
    private boolean isTaskInterrupted() {
        if (Thread.interrupted()) {
            C10400L.m26180d(LOG_TASK_INTERRUPTED, this.memoryCacheKey);
            return true;
        }
        return false;
    }
    ...
    private boolean isViewCollected() {
        if (this.imageAware.isCollected()) {
            C10400L.m26180d(LOG_TASK_CANCELLED_IMAGEAWARE_COLLECTED, this.memoryCacheKey);
            return true;
        }
        return false;
    }
    ...
    private boolean isViewReused() {
        if (!this.memoryCacheKey.equals(this.engine.getLoadingUriForView(this.imageAware))) {
            C10400L.m26180d(LOG_TASK_CANCELLED_IMAGEAWARE_REUSED, this.memoryCacheKey);
            return true;
        }
        return false;
    }
    ...
    private boolean resizeAndSaveImage(int i, int i2) {
        ...
        if (bitmap != null && this.configuration.processorForDiskCache != null) {
            C10400L.m26180d(LOG_PROCESS_IMAGE_BEFORE_CACHE_ON_DISK, this.memoryCacheKey);
            bitmap = this.configuration.processorForDiskCache.process(bitmap);
            if (bitmap == null) {
                C10400L.m26179e(ERROR_PROCESSOR_FOR_DISK_CACHE_NULL, this.memoryCacheKey);
            }
        }
        if (bitmap != null) {
    ...
    private boolean tryCacheImageOnDisk() {
        C10400L.m26180d(LOG_CACHE_IMAGE_ON_DISK, this.memoryCacheKey);
        try {
            ...
            if (downloadImage) {
                ...
                if (i > 0 || i2 > 0) {
                    C10400L.m26180d(LOG_RESIZE_CACHED_IMAGE_FILE, this.memoryCacheKey);
    ...
    */
    private com.kwad.sdk.core.imageloader.core.decode.DecodedResult tryLoadBitmap() {
        /*
            ...
            com.kwad.sdk.core.imageloader.utils.C10400L.m26180d(r4, r5)     // Catch: java.lang.Throwable -> La2 java.lang.OutOfMemoryError -> Lac java.io.IOException -> Lb6 com.kwad.sdk.core.imageloader.core.LoadAndDisplayImageTask.TaskCancelledException -> Lc1 java.lang.IllegalStateException -> Lc3
        ...
        L49:
            ...
            com.kwad.sdk.core.imageloader.utils.C10400L.m26180d(r4, r3)     // Catch: java.lang.Throwable -> L93 java.lang.OutOfMemoryError -> L98 java.io.IOException -> L9d com.kwad.sdk.core.imageloader.core.LoadAndDisplayImageTask.TaskCancelledException -> Lc1 java.lang.IllegalStateException -> Lc4
        ...
        La2:
            r1 = move-exception
        La3:
            com.kwad.sdk.core.imageloader.utils.C10400L.m26178e(r1)
    ...
    private boolean waitIfPaused() {
        ...
        if (pause.get()) {
            synchronized (this.engine.getPauseLock()) {
                if (pause.get()) {
                    C10400L.m26180d(LOG_WAITING_FOR_RESUME, this.memoryCacheKey);
                    try {
                        this.engine.getPauseLock().wait();
                        C10400L.m26180d(LOG_RESUME_AFTER_PAUSE, this.memoryCacheKey);
                    } catch (InterruptedException unused) {
                        C10400L.m26179e(LOG_TASK_INTERRUPTED, this.memoryCacheKey);
                        return true;
                    }
