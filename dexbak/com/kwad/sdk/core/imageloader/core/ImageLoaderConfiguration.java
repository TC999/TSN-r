...
public final class ImageLoaderConfiguration {
    ...
    /* loaded from: E:\fuckcool\tsn\6520572.dex */
    public static /* synthetic */ class C103931 {

        /* renamed from: $SwitchMap$com$kwad$sdk$core$imageloader$core$download$ImageDownloader$Scheme */
        static final /* synthetic */ int[] f29556x3b39606f;

        static {
            int[] iArr = new int[ImageDownloader.Scheme.values().length];
            f29556x3b39606f = iArr;
            try {
                iArr[ImageDownloader.Scheme.HTTP.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f29556x3b39606f[ImageDownloader.Scheme.HTTPS.ordinal()] = 2;
    ...
    public static class Builder {
        ...
        public Builder diskCache(DiskCache diskCache) {
            if (this.diskCacheSize > 0 || this.diskCacheFileCount > 0) {
                C10400L.m26175w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
            }
            if (this.diskCacheFileNameGenerator != null) {
                C10400L.m26175w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
        ...
        public Builder memoryCache(MemoryCache memoryCache) {
            if (this.memoryCacheSize != 0) {
                C10400L.m26175w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder taskExecutor(Executor executor) {
            if (this.threadPoolSize != 3 || this.threadPriority != 3 || this.tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
                C10400L.m26175w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
    ...
    static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        public InputStream getStream(String str, Object obj) {
            int i = C103931.f29556x3b39606f[ImageDownloader.Scheme.ofUri(str).ordinal()];
            if (i != 1 && i != 2) {
    ...
    /* synthetic */ ImageLoaderConfiguration(Builder builder, C103931 c103931) {
        this(builder);
    }
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C10400L.writeDebugLogs(builder.writeLogs);
    }
}
