...
public class AcRunQuestionBindingImpl extends AcRunQuestionBinding implements View$OnClickListenerC4297a.InterfaceC4298a {
    @Nullable
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"pub_title"}, new int[]{9}, new int[]{C4215R.C4221layout.pub_title});
        SparseIntArray sparseIntArray = new SparseIntArray();
        sViewsWithIds = sparseIntArray;
        sparseIntArray.put(2131233211, 10);
        sparseIntArray.put(2131233146, 11);
        sparseIntArray.put(C4215R.C4219id.tv_question, 12);
        sparseIntArray.put(C4215R.C4219id.rg_answer, 13);
    }
    ...
    private AcRunQuestionBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback8 = new View$OnClickListenerC4297a(this, 1);
        invalidateAll();
    }
}
