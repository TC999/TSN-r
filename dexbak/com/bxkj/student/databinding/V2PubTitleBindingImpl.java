...
public class V2PubTitleBindingImpl extends V2PubTitleBinding implements View$OnClickListenerC4297a.InterfaceC4298a {
    @Nullable
    ...
    public V2PubTitleBindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    protected void executeBindings() {
        ...
        if ((8 & j) != 0) {
            this.ibBack.setOnClickListener(this.mCallback51);
        }
        if ((10 & j) != 0) {
    ...
    private V2PubTitleBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback51 = new View$OnClickListenerC4297a(this, 1);
        invalidateAll();
    }
}
