...
public class SlideDetailsLayout extends ViewGroup {
    ...
    private void finishTouchEvent() {
        ...
        int i = (int) (this.mPercent * measuredHeight2);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (this.mTarget != null && isEnabled()) {
            ...
            if (actionMasked != 1 && actionMasked == 2) {
                ...
                Status status = this.mStatus;
                if (status != Status.CLOSE || f2 <= 0.0f) {
                    return status != Status.OPEN || f2 >= 0.0f;
                }
                return false;
            }
            return false;
    ...
    */
    ...
    public SlideDetailsLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C4215R.styleable.SlideDetailsLayout, defStyleAttr, 0);
