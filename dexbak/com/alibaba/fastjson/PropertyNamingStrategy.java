...
public enum PropertyNamingStrategy {
    ...
    public String translate(String str) {
        char charAt;
        int i = C17221.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy[ordinal()];
        int i2 = 0;
        if (i == 1) {
            ...
            while (i2 < str.length()) {
                ...
                if (charAt2 >= 'A' && charAt2 <= 'Z') {
                    char c = (char) (charAt2 + HttpConstants.SP_CHAR);
                    if (i2 > 0) {
                        sb.append('_');
                    }
                    sb.append(c);
            ...
            while (i2 < str.length()) {
                ...
                if (charAt3 >= 'A' && charAt3 <= 'Z') {
                    char c2 = (char) (charAt3 + HttpConstants.SP_CHAR);
                    if (i2 > 0) {
                        sb2.append('-');
                    }
                    sb2.append(c2);
