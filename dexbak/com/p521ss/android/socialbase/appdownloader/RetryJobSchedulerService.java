...
@TargetApi(21)
/* renamed from: com.ss.android.socialbase.appdownloader.RetryJobSchedulerService */
...
public class RetryJobSchedulerService extends JobService {
    ...
    */
    public static void m18483ok(com.p521ss.android.socialbase.downloader.model.DownloadInfo r11, long r12, boolean r14, int r15) {
        /*
            if (r11 == 0) goto Lc2
            r0 = 0
            ...
            goto Lc2
        La:
            android.content.Context r2 = com.p521ss.android.socialbase.downloader.downloader.C12490bl.m17807l()
            if (r2 != 0) goto L11
            return
        L11:
            ...
            r5 = 2
            if (r3 == 0) goto L2a
            android.content.Context r3 = com.p521ss.android.socialbase.downloader.downloader.C12490bl.m17807l()
            com.ss.android.socialbase.downloader.downloader.Downloader r3 = com.p521ss.android.socialbase.downloader.downloader.Downloader.getInstance(r3)
            com.ss.android.socialbase.downloader.downloader.td r3 = r3.getReserveWifiStatusListener()
            if (r3 == 0) goto L2a
            r3.mo17627ok(r11, r5, r4)
        L2a:
        ...
        L50:
            ...
            java.lang.Class<com.ss.android.socialbase.appdownloader.RetryJobSchedulerService> r10 = com.p521ss.android.socialbase.appdownloader.RetryJobSchedulerService.class
        ...
        L84:
            ...
            if (r13 == 0) goto La5
            android.content.Context r13 = com.p521ss.android.socialbase.downloader.downloader.C12490bl.m17807l()     // Catch: java.lang.Throwable -> Lbe
            com.ss.android.socialbase.downloader.downloader.Downloader r13 = com.p521ss.android.socialbase.downloader.downloader.Downloader.getInstance(r13)     // Catch: java.lang.Throwable -> Lbe
            com.ss.android.socialbase.downloader.downloader.td r13 = r13.getReserveWifiStatusListener()     // Catch: java.lang.Throwable -> Lbe
            if (r13 == 0) goto La5
            r13.mo17627ok(r11, r4, r4)     // Catch: java.lang.Throwable -> Lbe
        La5:
            if (r12 > 0) goto Lc2
            ...
            com.p521ss.android.socialbase.downloader.p549bl.C12409ok.m17894s(r11, r12)     // Catch: java.lang.Throwable -> Lbe
            goto Lc2
        Lbe:
            r11 = move-exception
            r11.printStackTrace()
        Lc2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p521ss.android.socialbase.appdownloader.RetryJobSchedulerService.m18483ok(com.ss.android.socialbase.downloader.model.DownloadInfo, long, boolean, int):void");
    }
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        if (jobParameters != null) {
            ...
            C12409ok.m17901bl("RetrySchedulerService", "onStartJob, id = " + jobId);
            C12565td.m17403ok().m17402ok(jobId);
            return false;
        }
        return false;
    }
