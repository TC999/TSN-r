...
import com.baidu.idl.face.platform.p049ui.utils.BrightnessUtils;
import com.baidu.idl.face.platform.p049ui.utils.CameraPreviewUtils;
import com.baidu.idl.face.platform.p049ui.utils.CameraUtils;
import com.baidu.idl.face.platform.p049ui.utils.VolumeUtils;
import com.baidu.idl.face.platform.p049ui.widget.FaceDetectRoundView;
...
public class FaceLivenessActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback, Camera.ErrorCallback, VolumeUtils.VolumeCallback, ILivenessStrategyCallback, ILivenessViewCallback {
    ...
    /* renamed from: com.baidu.idl.face.platform.ui.FaceLivenessActivity$6 */
    /* loaded from: E:\fuckcool\tsn\7241516.dex */
    public static /* synthetic */ class C25046 {
    ...
    */
    private int displayOrientation(android.content.Context r4) {
        ...
        L54:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.idl.face.platform.p049ui.FaceLivenessActivity.displayOrientation(android.content.Context):int");
    }

    private void loadAnimSource() {
        LivenessTypeEnum livenessTypeEnum = this.mLivenessType;
        if (livenessTypeEnum != null) {
            switch (C25046.$SwitchMap$com$baidu$idl$face$platform$LivenessTypeEnum[livenessTypeEnum.ordinal()]) {
                case 1:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_eye);
                    break;
                case 2:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_left);
                    break;
                case 3:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_right);
                    break;
                case 4:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_down);
                    break;
                case 5:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_up);
                    break;
                case 6:
                    this.mImageAnim.setBackgroundResource(C2505R.C2507drawable.anim_mouth);
                    break;
            }
    ...
    private void onRefreshView(FaceStatusNewEnum faceStatusNewEnum, String str, int i) {
        switch (C25046.$SwitchMap$com$baidu$idl$face$platform$FaceStatusNewEnum[faceStatusNewEnum.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            case 6:
                ...
                this.mFaceDetectRoundView.setProcessCount(i, this.mFaceConfig.getLivenessTypeList().size());
                stopAnim();
                return;
            case 7:
            case 8:
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C2505R.C2510layout.activity_face_liveness_v3100);
        this.mContext = this;
        ...
        View findViewById = findViewById(C2505R.C2508id.liveness_root_layout);
        this.mRootView = findViewById;
        this.mFrameLayout = (FrameLayout) findViewById.findViewById(C2505R.C2508id.liveness_surface_layout);
        ...
        float f = this.mDisplayWidth * 0.75f * 0.9f;
        ...
        int i = C2505R.C2508id.liveness_close;
        view.findViewById(i).setOnClickListener(new View.OnClickListener() { // from class: com.baidu.idl.face.platform.ui.FaceLivenessActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                FaceLivenessActivity.this.onBackPressed();
            }
        });
        FaceDetectRoundView faceDetectRoundView = (FaceDetectRoundView) this.mRootView.findViewById(C2505R.C2508id.liveness_face_round);
        this.mFaceDetectRoundView = faceDetectRoundView;
        faceDetectRoundView.setIsActiveLive(true);
        this.mCloseView = (ImageView) this.mRootView.findViewById(i);
        ImageView imageView = (ImageView) this.mRootView.findViewById(C2505R.C2508id.liveness_sound);
        this.mSoundView = imageView;
        imageView.setImageResource(this.mIsEnableSound ? C2505R.mipmap.icon_titlebar_voice2 : C2505R.C2507drawable.collect_image_voice_selector);
        this.mSoundView.setOnClickListener(new View.OnClickListener() { // from class: com.baidu.idl.face.platform.ui.FaceLivenessActivity.2
            ...
            public void onClick(View view2) {
                ...
                faceLivenessActivity2.mSoundView.setImageResource(faceLivenessActivity2.mIsEnableSound ? C2505R.mipmap.icon_titlebar_voice2 : C2505R.C2507drawable.collect_image_voice_selector);
        ...
        this.mTipsTopView = (TextView) this.mRootView.findViewById(C2505R.C2508id.liveness_top_tips);
        this.mSuccessView = (ImageView) this.mRootView.findViewById(C2505R.C2508id.liveness_success_image);
        this.mImageLayout = (LinearLayout) this.mRootView.findViewById(C2505R.C2508id.liveness_result_image_layout);
        this.mImageLayout2 = (LinearLayout) this.mRootView.findViewById(C2505R.C2508id.liveness_result_image_layout2);
        this.mRelativeAddImageView = (RelativeLayout) this.mRootView.findViewById(C2505R.C2508id.relative_add_image_view);
        addImageView();
        this.mViewBg = findViewById(C2505R.C2508id.view_live_bg);
    }
    ...
    @Override // com.baidu.idl.face.platform.p049ui.utils.VolumeUtils.VolumeCallback
    public void volumeChanged() {
        try {
            AudioManager audioManager = (AudioManager) getSystemService("audio");
            if (audioManager != null) {
                this.mIsEnableSound = audioManager.getStreamVolume(3) > 0;
                this.mSoundView.setImageResource(this.mIsEnableSound ? C2505R.mipmap.icon_titlebar_voice2 : C2505R.mipmap.icon_titlebar_voice1);
                ILivenessStrategy iLivenessStrategy = this.mILivenessStrategy;
                if (iLivenessStrategy != null) {
