...
public class FaceDetectActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback, Camera.ErrorCallback, VolumeUtils.VolumeCallback, IDetectStrategyCallback {
    ...
    /* renamed from: com.baidu.idl.face.platform.ui.FaceDetectActivity$5 */
    /* loaded from: E:\fuckcool\tsn\7241516.dex */
    public static /* synthetic */ class C24985 {
    ...
    */
    private int displayOrientation(android.content.Context r4) {
        ...
        L54:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.idl.face.platform.p049ui.FaceDetectActivity.displayOrientation(android.content.Context):int");
    }

    private void onRefreshView(FaceStatusNewEnum faceStatusNewEnum, String str) {
        int i = C24985.$SwitchMap$com$baidu$idl$face$platform$FaceStatusNewEnum[faceStatusNewEnum.ordinal()];
        if (i == 1) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C2505R.C2510layout.activity_face_detect_v3100);
        ...
        View findViewById = findViewById(C2505R.C2508id.detect_root_layout);
        this.mRootView = findViewById;
        this.mFrameLayout = (FrameLayout) findViewById.findViewById(C2505R.C2508id.detect_surface_layout);
        ...
        int i = C2505R.C2508id.detect_close;
        view.findViewById(i).setOnClickListener(new View.OnClickListener() { // from class: com.baidu.idl.face.platform.ui.FaceDetectActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                FaceDetectActivity.this.onBackPressed();
            }
        });
        FaceDetectRoundView faceDetectRoundView = (FaceDetectRoundView) this.mRootView.findViewById(C2505R.C2508id.detect_face_round);
        ...
        ImageView imageView = (ImageView) this.mRootView.findViewById(C2505R.C2508id.detect_sound);
        ...
        this.mSoundView.setOnClickListener(new View.OnClickListener() { // from class: com.baidu.idl.face.platform.ui.FaceDetectActivity.2
            ...
            public void onClick(View view2) {
                ...
                faceDetectActivity2.mSoundView.setImageResource(faceDetectActivity2.mIsEnableSound ? C2505R.mipmap.icon_titlebar_voice2 : C2505R.C2507drawable.collect_image_voice_selector);
        ...
        this.mTipsTopView = (TextView) this.mRootView.findViewById(C2505R.C2508id.detect_top_tips);
        this.mSuccessView = (ImageView) this.mRootView.findViewById(C2505R.C2508id.detect_success_image);
        this.mImageLayout = (LinearLayout) this.mRootView.findViewById(C2505R.C2508id.detect_result_image_layout);
        this.mImageLayout2 = (LinearLayout) this.mRootView.findViewById(C2505R.C2508id.detect_result_image_layout2);
        this.mViewBg = findViewById(C2505R.C2508id.view_bg);
