...
public class FaceLivenessStrategyExtModule implements ILivenessStrategy {
    ...
    /* renamed from: com.baidu.idl.face.platform.strategy.FaceLivenessStrategyExtModule$2 */
    /* loaded from: E:\fuckcool\tsn\7241516.dex */
    public static /* synthetic */ class C24882 {
        ...
        static final /* synthetic */ int[] f8432x49bb5ee7;
        ...
        static {
            ...
            try {
                f8432x49bb5ee7[LivenessStatus.LivenessTips.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8432x49bb5ee7[LivenessStatus.LivenessOK.ordinal()] = 3;
    ...
    private void processUIResult(FaceModel faceModel, BDFaceImageInstance bDFaceImageInstance) {
        ...
        if (this.mIsProcessing) {
            ...
            if (faceModuleStateNew != faceStatusNewEnum) {
                ...
                } else if (C24882.$SwitchMap$com$baidu$idl$face$platform$FaceStatusNewEnum[faceModuleStateNew.ordinal()] != 1) {
                    bDFaceImageInstance.destory();
                ...
                int i = C24882.f8432x49bb5ee7[this.mLivenessStatus.ordinal()];
                if (i != 1) {
                    if (i != 2) {
