        ...
        public boolean process(byte[] bArr, int i, int i2, boolean z) {
            ...
            while (i9 < i4) {
                if (i8 == 0) {
                    while (true) {
                        int i10 = i9 + 4;
                        if (i10 > i4 || (i6 = (iArr[bArr[i9] & UByte.f41242c] << 18) | (iArr[bArr[i9 + 1] & UByte.f41242c] << 12) | (iArr[bArr[i9 + 2] & UByte.f41242c] << 6) | iArr[bArr[i9 + 3] & UByte.f41242c]) < 0) {
                            break;
                        }
                        bArr2[i7 + 2] = (byte) i6;
