...
import com.tencent.p562mm.opensdk.channel.MMessageActV2;
...
import com.tencent.p562mm.opensdk.modelbiz.AddCardToWXCardPackage;
import com.tencent.p562mm.opensdk.modelbiz.ChooseCardFromWXCardPackage;
import com.tencent.p562mm.opensdk.modelbiz.CreateChatroom;
import com.tencent.p562mm.opensdk.modelbiz.HandleScanResult;
import com.tencent.p562mm.opensdk.modelbiz.IWXChannelJumpInfo;
import com.tencent.p562mm.opensdk.modelbiz.JoinChatroom;
import com.tencent.p562mm.opensdk.modelbiz.OpenWebview;
import com.tencent.p562mm.opensdk.modelbiz.SubscribeMessage;
import com.tencent.p562mm.opensdk.modelbiz.SubscribeMiniProgramMsg;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelBaseJumpInfo;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelJumpMiniProgramInfo;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelJumpUrlInfo;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelOpenFeed;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelOpenLive;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelOpenProfile;
import com.tencent.p562mm.opensdk.modelbiz.WXChannelShareVideo;
import com.tencent.p562mm.opensdk.modelbiz.WXInvoiceAuthInsert;
import com.tencent.p562mm.opensdk.modelbiz.WXLaunchMiniProgram;
import com.tencent.p562mm.opensdk.modelbiz.WXLaunchMiniProgramWithToken;
import com.tencent.p562mm.opensdk.modelbiz.WXLaunchWxaRedirectingPage;
import com.tencent.p562mm.opensdk.modelbiz.WXNontaxPay;
import com.tencent.p562mm.opensdk.modelbiz.WXOpenBusinessView;
import com.tencent.p562mm.opensdk.modelbiz.WXOpenBusinessWebview;
import com.tencent.p562mm.opensdk.modelbiz.WXOpenCustomerServiceChat;
import com.tencent.p562mm.opensdk.modelbiz.WXPayInsurance;
import com.tencent.p562mm.opensdk.modelbiz.WXPreloadMiniProgram;
import com.tencent.p562mm.opensdk.modelbiz.WXPreloadMiniProgramEnvironment;
import com.tencent.p562mm.opensdk.modelbiz.WXQRCodePay;
import com.tencent.p562mm.opensdk.modelmsg.GetMessageFromWX;
import com.tencent.p562mm.opensdk.modelmsg.LaunchFromWX;
import com.tencent.p562mm.opensdk.modelmsg.SendAuth;
import com.tencent.p562mm.opensdk.modelmsg.SendMessageToWX;
import com.tencent.p562mm.opensdk.modelmsg.SendTdiAuth;
import com.tencent.p562mm.opensdk.modelmsg.ShowMessageFromWX;
import com.tencent.p562mm.opensdk.modelmsg.WXMediaMessage;
import com.tencent.p562mm.opensdk.modelmsg.WXMiniProgramObject;
import com.tencent.p562mm.opensdk.modelmsg.WXStateSceneDataObject;
import com.tencent.p562mm.opensdk.modelmsg.WXTextObject;
import com.tencent.p562mm.opensdk.modelmsg.WXWebpageObject;
import com.tencent.p562mm.opensdk.modelpay.JumpToOfflinePay;
import com.tencent.p562mm.opensdk.modelpay.PayResp;
import com.tencent.p562mm.opensdk.modelpay.WXJointPay;
import com.tencent.p562mm.opensdk.utils.C12989b;
import com.tencent.p562mm.opensdk.utils.ILog;
...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = 2;
        Log.m15265d(TAG, "<init>, appId = " + str + ", checkSignature = " + z + ", launchMode = " + i);
        this.context = context;
        this.appId = str;
        this.checkSignature = z;
        this.launchMode = i;
        C12989b.f37215a = StubApp.getOrigApplicationContext(context.getApplicationContext());
    }
    ...
    private String getTokenFromWX(Context context) {
        ...
        if (query == null || !query.moveToFirst()) {
            Log.m15264e(TAG, "getTokenFromWX , token is null , if your app targetSdkVersion >= 30, include 'com.tencent.mm' in a set of <package> elements inside the <queries> element");
            return null;
        }
        String string = query.getString(0);
        Log.m15263i(TAG, "getTokenFromWX token is " + string);
        query.close();
        return string;
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        Log.m15263i(TAG, "handleWxInternalRespType, extInfo = " + str);
        try {
            parse = Uri.parse(str);
            queryParameter = parse.getQueryParameter("wx_internal_resptype");
            Log.m15263i(TAG, "handleWxInternalRespType, respType = " + queryParameter);
        } catch (Exception e) {
            Log.m15264e(TAG, "handleWxInternalRespType fail, ex = " + e.getMessage());
        }
        if (C12989b.m15256b(queryParameter)) {
            Log.m15264e(TAG, "handleWxInternalRespType fail, respType is null");
            return false;
        } else if (queryParameter.equals("subscribemessage")) {
            SubscribeMessage.Resp resp = new SubscribeMessage.Resp();
            String queryParameter2 = parse.getQueryParameter("ret");
            if (queryParameter2 != null && queryParameter2.length() > 0) {
                resp.errCode = C12989b.m15257a(queryParameter2, 0);
            }
            resp.openId = parse.getQueryParameter("openid");
            resp.templateID = parse.getQueryParameter("template_id");
            resp.scene = C12989b.m15257a(parse.getQueryParameter("scene"), 0);
            resp.action = parse.getQueryParameter(CcgConstant.f38549t);
            ...
            if (queryParameter3 != null && queryParameter3.length() > 0) {
                resp2.errCode = C12989b.m15257a(queryParameter3, 0);
            }
            ...
            if (queryParameter4 != null && queryParameter4.length() > 0) {
                resp3.errCode = C12989b.m15257a(queryParameter4, 0);
            }
            ...
            if (queryParameter5 != null && queryParameter5.length() > 0) {
                resp4.errCode = C12989b.m15257a(queryParameter5, 0);
            }
            ...
            if (!"subscribeminiprogrammsg".equals(queryParameter) && !"5".equals(queryParameter)) {
                Log.m15264e(TAG, "this open sdk version not support the request type");
                return false;
            }
            SubscribeMiniProgramMsg.Resp resp5 = new SubscribeMiniProgramMsg.Resp();
            String queryParameter6 = parse.getQueryParameter("ret");
            if (queryParameter6 != null && queryParameter6.length() > 0) {
                resp5.errCode = C12989b.m15257a(queryParameter6, 0);
            }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        if (!isWXAppInstalled()) {
            Log.m15264e(TAG, "openWXApp failed, not installed or signature check failed");
            return;
        }
        try {
            Log.m15263i(TAG, "launchWXUsingPendingIntent");
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), AMapEngineUtils.HALF_MAX_P20_WIDTH).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
                @Override // android.app.PendingIntent.OnFinished
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i, String str, Bundle bundle) {
                    Log.m15265d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e) {
            Log.m15264e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e.getMessage());
            openWXApp();
        }
    }
    ...
    private boolean sendFinderOpenFeed(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m15263i(TAG, "sendFinderOpenFeed");
    ...
    private boolean sendFinderOpenLive(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m15263i(TAG, "sendFinderOpenLive");
    ...
    private boolean sendFinderOpenProfile(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m15263i(TAG, "sendFinderOpenProfile");
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m15263i(TAG, "sendFinderShareVideo");
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            Log.m15265d(TAG, "pay, set wxappPayEntryClassname = " + wxappPayEntryClassname);
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.m15264e(TAG, "get from metaData failed : " + e.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
                Log.m15264e(TAG, "pay fail, wxappPayEntryClassname is null");
                return false;
            }
        }
        ...
        try {
            ...
            Log.m15264e(TAG, "getTokenFromWX fail, exception = " + e2);
        }
    ...
    @Override // com.tencent.p562mm.opensdk.openapi.IWXAPI
    public void detach() {
        Log.m15265d(TAG, "detach");
        this.detached = true;
        this.context = null;
    }
    ...
    public int getWXAppSupportAPI() {
        ...
        if (!isWXAppInstalled()) {
            Log.m15264e(TAG, "open wx app failed, not installed or signature check failed");
            return 0;
        }
        this.wxSdkVersion = 0;
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        C12989b.f37219e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
            ...
            public void run() {
                try {
                    ...
                    Log.m15261w(BaseWXApiImplV10.TAG, e.getMessage());
                }
        ...
        try {
            ...
            Log.m15261w(TAG, e.getMessage());
        }
        Log.m15265d(TAG, "wxSdkVersion = " + this.wxSdkVersion);
        if (this.wxSdkVersion == 0) {
            try {
                ...
                Log.m15265d(TAG, "OPEN_SDK_VERSION = " + this.wxSdkVersion);
            } catch (Exception e2) {
                Log.m15264e(TAG, "get from metaData failed : " + e2.getMessage());
            }
        }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.m15264e(TAG, "handleIntent fail, ex = " + e.getMessage());
        }
        if (!WXApiImplComm.isIntentFromWx(intent, ConstantsAPI.Token.WX_TOKEN_VALUE_MSG)) {
            Log.m15263i(TAG, "handleIntent fail, intent not from weixin msg");
            return false;
            ...
            if (stringExtra2 != null && stringExtra2.length() != 0) {
                if (!checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), C12976a.m15277a(stringExtra, intExtra, stringExtra2))) {
                    Log.m15264e(TAG, "checksum fail");
                    return false;
                }
                int intExtra2 = intent.getIntExtra("_wxapi_command_type", 0);
                Log.m15263i(TAG, "handleIntent, cmd = " + intExtra2);
                switch (intExtra2) {
                    case 1:
                    ...
                    case 4:
                        ...
                        if (str != null && str.contains("wx_internal_resptype")) {
                            ...
                            Log.m15263i(TAG, "handleIntent, extInfo contains wx_internal_resptype, ret = " + handleWxInternalRespType);
                            ...
                            try {
                                ...
                                if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                    ...
                                    if (queryParameter != null && queryParameter.length() > 0) {
                                        resp.errCode = C12989b.m15257a(queryParameter, 0);
                                    }
                                    resp.resultInfo = parse.getQueryParameter("resultInfo");
                                    resp.errStr = parse.getQueryParameter("errmsg");
                                    String queryParameter2 = parse.getQueryParameter("type");
                                    if (queryParameter2 != null && queryParameter2.length() > 0) {
                                        resp.businessType = C12989b.m15257a(queryParameter2, 0);
                                    }
                                    iWXAPIEventHandler.onResp(resp);
                                    return true;
                                }
                                Log.m15265d(TAG, "not openbusinesswebview %" + str);
                            } catch (Exception e2) {
                                Log.m15264e(TAG, "parse fail, ex = " + e2.getMessage());
                            }
                        }
                    ...
                    case 23:
                    default:
                        Log.m15264e(TAG, "unknown cmd = " + intExtra2);
                        break;
                    case 9:
            ...
            Log.m15264e(TAG, "invalid argument");
            return false;
        }
    }
    ...
    public boolean registerApp(String str, long j) {
        ...
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m15264e(TAG, "register app failed for wechat app signature check failed");
            return false;
        }
        Log.m15265d(TAG, "registerApp, appId = " + str);
        if (str != null) {
            this.appId = str;
        }
        Log.m15265d(TAG, "registerApp, appId = " + str);
        ...
        Log.m15265d(TAG, "register app " + this.context.getPackageName());
        C12976a.C12977a c12977a = new C12976a.C12977a();
        c12977a.f37174a = "com.tencent.mm";
        c12977a.f37175b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c12977a.f37176c = "weixin://registerapp?appid=" + this.appId;
        c12977a.f37177d = j;
        return C12976a.m15281a(this.context, c12977a);
    }
    ...
    public boolean sendReq(BaseReq baseReq) {
        ...
        if (WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            ...
            if (baseReq.checkArgs()) {
                Log.m15263i(TAG, "sendReq, req type = " + baseReq.getType());
                ...
                try {
                    ...
                    Log.m15264e(TAG, "getTokenFromWX fail, exception = " + e);
                }
    ...
    public void unregisterApp() {
        ...
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m15264e(TAG, "unregister app failed for wechat app signature check failed");
            return;
        }
        Log.m15265d(TAG, "unregisterApp, appId = " + this.appId);
        String str = this.appId;
        if (str == null || str.length() == 0) {
            Log.m15264e(TAG, "unregisterApp fail, appId is empty");
            return;
        }
        Log.m15265d(TAG, "unregister app " + this.context.getPackageName());
        C12976a.C12977a c12977a = new C12976a.C12977a();
        c12977a.f37174a = "com.tencent.mm";
        c12977a.f37175b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c12977a.f37176c = "weixin://unregisterapp?appid=" + this.appId;
        C12976a.m15281a(this.context, c12977a);
    }
}
