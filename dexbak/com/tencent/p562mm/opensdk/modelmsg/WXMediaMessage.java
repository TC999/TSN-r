...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m15264e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            if (str == null || str.length() == 0) {
                Log.m15264e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
                return str;
            }
        ...
        private static String pathOldToNew(String str) {
            Log.m15263i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m15264e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            ...
            Log.m15264e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
            return str;
        }
    ...
    public boolean checkArgs() {
        ...
        } else if (getType() == 76 && C12989b.m15256b(this.title)) {
            str = "checkArgs fail, Type = Music Video, but title == null";
        } else if (C12989b.m15260a(getType()) && ((bArr2 = this.thumbData) == null || bArr2.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (C12989b.m15260a(getType()) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m15264e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
}
