...
public class WXStateSceneDataObject implements SendMessageToWX.IWXSceneDataObject {
    ...
    @Override // com.tencent.p562mm.opensdk.modelmsg.SendMessageToWX.IWXSceneDataObject
    public boolean checkArgs() {
        String str = this.stateId;
        if (str != null && str.length() > LENGTH_LIMIT) {
            Log.m15264e(TAG, "checkArgs fail, stateId is invalid");
            return false;
        }
        ...
        if (iWXStateJumpInfo == null) {
            Log.m15264e(TAG, "checkArgs fail, statsJumpInfo is null");
            return false;
        }
    ...
    public void unserialize(Bundle bundle) {
        ...
        if (string != null) {
            try {
                ...
                Log.m15264e(TAG, "get WXSceneDataObject from bundle failed: unknown ident " + string + ", ex = " + e.getMessage());
            }
        }
    }
}
