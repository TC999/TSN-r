...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C6711R.C6719style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int color = MaterialColors.getColor(this, C6711R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C6711R.attr.colorOnSurface);
            int color3 = MaterialColors.getColor(this, C6711R.attr.colorSurface);
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6711R.attr.radioButtonStyle);
    }
    ...
    */
    public MaterialRadioButton(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C6711R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C6711R.styleable.MaterialRadioButton_buttonTint
        ...
        L28:
            int r8 = com.google.android.material.C6711R.styleable.MaterialRadioButton_useMaterialThemeColors
