...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C6711R.C6718string.item_view_role_description));
    }
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C6711R.C6717layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C6711R.C6714drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C6711R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C6711R.C6715id.icon);
        TextView textView = (TextView) findViewById(C6711R.C6715id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C6711R.C6715id.largeLabel);
