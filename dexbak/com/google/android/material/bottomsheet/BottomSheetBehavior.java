...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C6711R.C6719style.Widget_Design_BottomSheet_Modal;
                ...
                if (f2 < 0.0f) {
                    ...
                    if (bottomSheetBehavior2.hideable && bottomSheetBehavior2.shouldHide(view, f2)) {
                        ...
                        if (BottomSheetBehavior.this.fitToContents) {
                            ...
                            } else if (Math.abs(top4 - i4) < Math.abs(top4 - BottomSheetBehavior.this.collapsedOffset)) {
                                i = BottomSheetBehavior.this.halfExpandedOffset;
                            } else {
                                i = BottomSheetBehavior.this.collapsedOffset;
                            }
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, int i) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C6711R.dimen.design_bottom_sheet_peek_height_min);
    ...
    public void setHalfExpandedRatio(@FloatRange(from = 0.0d, m60036to = 1.0d) float f) {
        if (f > 0.0f && f < 1.0f) {
    ...
    private void createMaterialShapeDrawable(@NonNull Context context, AttributeSet attributeSet, boolean z, @Nullable ColorStateList colorStateList) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attributeSet, C6711R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
    ...
    public BottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.peekHeightGestureInsetBuffer = context.getResources().getDimensionPixelSize(C6711R.dimen.mtrl_min_touch_target_size);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6711R.styleable.BottomSheetBehavior_Layout);
        this.shapeThemingEnabled = obtainStyledAttributes.hasValue(C6711R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        int i2 = C6711R.styleable.BottomSheetBehavior_Layout_backgroundTint;
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.elevation = obtainStyledAttributes.getDimension(C6711R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        }
        int i3 = C6711R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight;
        ...
        setHideable(obtainStyledAttributes.getBoolean(C6711R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setGestureInsetBottomIgnored(obtainStyledAttributes.getBoolean(C6711R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(obtainStyledAttributes.getBoolean(C6711R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(obtainStyledAttributes.getBoolean(C6711R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setDraggable(obtainStyledAttributes.getBoolean(C6711R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setSaveFlags(obtainStyledAttributes.getInt(C6711R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(obtainStyledAttributes.getFloat(C6711R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        int i4 = C6711R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset;
