...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C6711R.C6719style.Widget_Design_AppBarLayout;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6711R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C6711R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
    ...
    private void startLiftOnScrollElevationOverlayAnimation(@NonNull final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C6711R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration(getResources().getInteger(C6711R.integer.app_bar_elevation_anim_duration));
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        int i2 = C6711R.attr.state_liftable;
        if (!z) {
            i2 = -i2;
        }
        iArr[0] = i2;
        iArr[1] = (z && this.lifted) ? C6711R.attr.state_lifted : -C6711R.attr.state_lifted;
        int i3 = C6711R.attr.state_collapsible;
        if (!z) {
            i3 = -i3;
        }
        iArr[2] = i3;
        iArr[3] = (z && this.lifted) ? C6711R.attr.state_collapsed : -C6711R.attr.state_collapsed;
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6711R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.Nullable android.util.AttributeSet r12, int r13) {
        ...
        L27:
            int[] r2 = com.google.android.material.C6711R.styleable.AppBarLayout
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r12
            r3 = r13
            ...
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_android_background
        ...
        L5f:
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_expanded
        ...
        L6e:
            if (r8 < r9) goto L80
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_elevation
            boolean r0 = r12.hasValue(r13)
            if (r0 == 0) goto L80
        ...
        L80:
            r13 = 26
            if (r8 < r13) goto La2
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r0 = r12.hasValue(r13)
            if (r0 == 0) goto L93
            boolean r13 = r12.getBoolean(r13, r6)
            r10.setKeyboardNavigationCluster(r13)
        L93:
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r0 = r12.hasValue(r13)
            if (r0 == 0) goto La2
            boolean r13 = r12.getBoolean(r13, r6)
            r10.setTouchscreenBlocksFocus(r13)
        La2:
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_liftOnScroll
            boolean r13 = r12.getBoolean(r13, r6)
            r10.liftOnScroll = r13
            int r13 = com.google.android.material.C6711R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r11 = r12.getResourceId(r13, r11)
            r10.liftOnScrollTargetViewId = r11
            int r11 = com.google.android.material.C6711R.styleable.AppBarLayout_statusBarForeground
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6711R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C6711R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int i = C6711R.styleable.AppBarLayout_Layout_layout_scrollInterpolator;
