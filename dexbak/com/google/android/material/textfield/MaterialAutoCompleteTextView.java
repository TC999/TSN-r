...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6711R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C6711R.styleable.MaterialAutoCompleteTextView, i, C6711R.C6719style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        int i2 = C6711R.styleable.MaterialAutoCompleteTextView_android_inputType;
