...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C6711R.C6719style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C6711R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C6711R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C6711R.dimen.mtrl_switch_thumb_elevation);
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6711R.attr.switchStyle);
    }
    ...
    */
    public SwitchMaterial(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9) {
        /*
            ...
            int[] r2 = com.google.android.material.C6711R.styleable.SwitchMaterial
            r7 = 0
            int[] r5 = new int[r7]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r9 = com.google.android.material.C6711R.styleable.SwitchMaterial_useMaterialThemeColors
