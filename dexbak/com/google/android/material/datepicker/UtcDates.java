...
class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll("d", resources.getString(C6711R.C6718string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C6711R.C6718string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C6711R.C6718string.mtrl_picker_text_input_year_abbr));
    }
