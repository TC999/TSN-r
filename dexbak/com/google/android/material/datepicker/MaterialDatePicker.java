...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C6711R.C6714drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C6711R.C6714drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(C6711R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C6711R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return dimensionPixelSize + dimensionPixelSize2 + (resources.getDimensionPixelSize(C6711R.dimen.mtrl_calendar_day_height) * i) + ((i - 1) * resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C6711R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    public static boolean isFullscreen(@NonNull Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C6711R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C6711R.C6715id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C6711R.C6718string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            string = checkableImageButton.getContext().getString(C6711R.C6718string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C6711R.C6718string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C6711R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C6711R.attr.materialCalendarStyle, C6711R.C6719style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C6711R.C6717layout.mtrl_picker_fullscreen : C6711R.C6717layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C6711R.C6715id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C6711R.C6715id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C6711R.C6715id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C6711R.C6715id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C6711R.C6715id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C6711R.C6715id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C6711R.C6715id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C6711R.C6715id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C6711R.dimen.mtrl_calendar_dialog_background_inset);
