...
public class ShapePath {
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f23808y - this.startY, this.operation.f23807x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f23808y - this.startY) / (this.operation.f23807x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        private float f23807x;

        /* renamed from: y */
        private float f23808y;
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f23807x, this.f23808y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f23807x = f;
        pathLineOperation.f23808y = f2;
