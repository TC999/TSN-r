...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, m60036to = 1.0d) float f, @FloatRange(from = 0.0d, m60036to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            this.shadowPaint.setShadowLayer(f6, (int) (calculateElevationDxMultiplier * f6), f7, SHADOW_COLOR);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            ...
            int i2 = C6711R.C6715id.mtrl_motion_snapshot_view;
    ...
    private static ShapeAppearanceModel getShapeAppearance(@NonNull View view, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        int i = C6711R.C6715id.mtrl_motion_snapshot_view;
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C6711R.attr.transitionShapeAppearance});
