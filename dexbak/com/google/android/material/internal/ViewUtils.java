...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i2, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, C6711R.styleable.Insets, i, i2);
        final boolean z = obtainStyledAttributes.getBoolean(C6711R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean z2 = obtainStyledAttributes.getBoolean(C6711R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean z3 = obtainStyledAttributes.getBoolean(C6711R.styleable.Insets_paddingRightSystemWindowInsets, false);
    ...
    public static class RelativePadding {
        ...
        public void applyToView(View view) {
            ViewCompat.setPaddingRelative(view, this.start, this.f47197top, this.end, this.bottom);
        }

        public RelativePadding(@NonNull RelativePadding relativePadding) {
            this.start = relativePadding.start;
            this.f47197top = relativePadding.f47197top;
