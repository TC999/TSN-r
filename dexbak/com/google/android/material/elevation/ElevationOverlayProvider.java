...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(@NonNull Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C6711R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C6711R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C6711R.attr.colorSurface, 0);
