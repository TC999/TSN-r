...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {16842752, C6711R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C6711R.attr.materialThemeOverlay};
