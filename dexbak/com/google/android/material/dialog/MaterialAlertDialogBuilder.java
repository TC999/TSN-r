...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    private static final int DEF_STYLE_ATTR = C6711R.attr.alertDialogStyle;
    @StyleRes
    private static final int DEF_STYLE_RES = C6711R.C6719style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C6711R.attr.materialAlertDialogTheme;
    @Nullable
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@InterfaceC0075Px int i) {
        this.backgroundInsets.bottom = i;
        return this;
    }

    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@InterfaceC0075Px int i) {
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@InterfaceC0075Px int i) {
        if (getContext().getResources().getConfiguration().getLayoutDirection() == 1) {
            this.backgroundInsets.right = i;
        } else {
            this.backgroundInsets.left = i;
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@InterfaceC0075Px int i) {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C6711R.attr.colorSurface, getClass().getCanonicalName());
