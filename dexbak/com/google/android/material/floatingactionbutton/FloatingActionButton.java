...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C6711R.C6719style.Widget_Design_FloatingActionButton;
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6711R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C6711R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    public void setCustomSize(@InterfaceC0075Px int i) {
        if (i >= 0) {
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6711R.attr.floatingActionButtonStyle);
    }
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i != 1) {
                return resources.getDimensionPixelSize(C6711R.dimen.design_fab_size_normal);
            }
            return resources.getDimensionPixelSize(C6711R.dimen.design_fab_size_mini);
