...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder m60135clone = m60135clone();
        m60135clone.serializeInnerClasses = false;
        return m60135clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder m60135clone = m60135clone();
        m60135clone.requireExpose = true;
        return m60135clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            m60135clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            m60135clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m60135clone = m60135clone();
        m60135clone.modifiers = 0;
        for (int i : iArr) {
            m60135clone.modifiers = i | m60135clone.modifiers;
        }
        return m60135clone;
    }
    ...
    public Excluder withVersion(double d) {
        Excluder m60135clone = m60135clone();
        m60135clone.version = d;
        return m60135clone;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: clone */
    public Excluder m60135clone() {
        try {
