...
public final class AABar {
    ...
    @NotNull
    public final AABar groupPadding(@Nullable Float f) {
        this.groupPadding = f;
        return this;
    }
    ...
    @NotNull
    public final AABar pointPadding(@Nullable Float f) {
        this.pointPadding = f;
        return this;
    }

    @NotNull
    public final AABar pointPlacement(@Nullable Float f) {
