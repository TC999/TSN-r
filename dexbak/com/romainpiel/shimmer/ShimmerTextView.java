...
public class ShimmerTextView extends TextView implements ShimmerViewBase {
    ...
    public boolean mo20279a() {
        return this.f32964a.m20272f();
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    /* renamed from: b */
    public boolean mo20278b() {
        return this.f32964a.m20273e();
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public float getGradientX() {
        return this.f32964a.m20277a();
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public int getPrimaryColor() {
        return this.f32964a.m20276b();
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public int getReflectionColor() {
        return this.f32964a.m20275c();
    }

    @Override // android.widget.TextView, android.view.View
    public void onDraw(Canvas canvas) {
        ShimmerViewHelper shimmerViewHelper = this.f32964a;
    ...
    public void setAnimationSetupCallback(ShimmerViewHelper.InterfaceC11839a interfaceC11839a) {
        this.f32964a.m20268j(interfaceC11839a);
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public void setGradientX(float f) {
        this.f32964a.m20267k(f);
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public void setPrimaryColor(int i) {
        this.f32964a.m20266l(i);
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public void setReflectionColor(int i) {
        this.f32964a.m20265m(i);
    }

    @Override // com.romainpiel.shimmer.ShimmerViewBase
    public void setShimmering(boolean z) {
        this.f32964a.m20264n(z);
    }
