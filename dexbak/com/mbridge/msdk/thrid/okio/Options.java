...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        ...
        if (i7 < i3) {
            ...
            while (true) {
                ...
                buffer.writeInt(byteString.getByte(i19) & UByte.f41242c);
                i19++;
            }
            if (i10 + 1 == i3) {
    ...
    */
    public static com.mbridge.msdk.thrid.okio.Options m20928of(com.mbridge.msdk.thrid.okio.ByteString... r10) {
        /*
            Method dump skipped, instructions count: 266
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okio.Options.m20928of(com.mbridge.msdk.thrid.okio.ByteString[]):com.mbridge.msdk.thrid.okio.Options");
    }
