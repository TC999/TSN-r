...
public final class HttpHeaders {
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((code >= 100 && code < 200) || code == 204 || code == 304) && contentLength(response) == -1 && !HttpHeaders.Values.CHUNKED.equalsIgnoreCase(response.header(HttpHeaders.Names.TRANSFER_ENCODING))) ? false : true;
    }
