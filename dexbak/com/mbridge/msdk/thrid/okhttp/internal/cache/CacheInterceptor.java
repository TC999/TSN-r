...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!HttpHeaders.Names.WARNING.equalsIgnoreCase(name) || !value.startsWith("1")) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        try {
            ...
            if (this.cache != null) {
                if (com.mbridge.msdk.thrid.okhttp.internal.http.HttpHeaders.hasBody(build2) && CacheStrategy.isCacheable(build2, request)) {
