...
public class MraidJSController {
    ...
    /* renamed from: a */
    public static MraidJSController m23231a() {
        if (f29885b == null) {
            synchronized (MraidJSController.class) {
                if (f29885b == null) {
                    f29885b = new MraidJSController();
                }
            }
        }
        return f29885b;
    ...
    /* renamed from: a */
    public final void m23230a(Context context, final String str) {
        if (context == null) {
            return;
        }
        String m22944b = SharedPerferenceManager.m22949a().m22944b("MraidJSController");
        if (TextUtils.isEmpty(m22944b) || !m22944b.equals(str)) {
            try {
                new MraidJSRequest(context).m22234a(0, str, (CommonRequestParams) null, new CommonStringResponseHandler() { // from class: com.mbridge.msdk.c.b.b.1
                    @Override // com.mbridge.msdk.foundation.same.net.p481b.CommonStringResponseHandler
                    /* renamed from: a */
                    public final void mo22294a(String str2) {
                        SameLogTool.m21738a("MraidJSController", "request mraid js success, content = " + str2);
                        if (TextUtils.isEmpty(str2)) {
                            return;
                        }
                        MraidJSController.this.f29886c = str2;
                        MraidJSController.m23227b(MraidJSController.this, str2);
                        SharedPerferenceManager.m22949a().m22945a("MraidJSController", str);
                    }

                    @Override // com.mbridge.msdk.foundation.same.net.p481b.CommonStringResponseHandler
                    /* renamed from: b */
                    public final void mo22293b(String str2) {
                        SameLogTool.m21738a("MraidJSController", "fail request mraid js. " + str2);
                    }
                });
            } catch (Exception e) {
                SameLogTool.m21733d("MraidJSController", e.getMessage());
            }
        }
    }

    /* renamed from: b */
    static /* synthetic */ void m23227b(MraidJSController mraidJSController, final String str) {
