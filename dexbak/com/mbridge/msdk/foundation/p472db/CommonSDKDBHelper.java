...
public class CommonSDKDBHelper extends CommonAbsDBHelper {
    ...
    /* renamed from: a */
    private static CommonSDKDBHelper f30357a;
    ...
    /* renamed from: a */
    public static CommonSDKDBHelper m22721a(Context context) {
        if (f30357a == null) {
            synchronized (CommonSDKDBHelper.class) {
                if (f30357a == null) {
                    f30357a = new CommonSDKDBHelper(StubApp.getOrigApplicationContext(context.getApplicationContext()));
                }
            }
        }
        return f30357a;
    ...
    /* renamed from: b */
    private void m22718b(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    /* renamed from: c */
    private void m22715c(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    @Override // com.mbridge.msdk.foundation.p472db.CommonAbsDBHelper
    /* renamed from: c */
    protected final String mo22716c() {
        return "mbridge.msdk.and.db";
    }

    @Override // com.mbridge.msdk.foundation.p472db.CommonAbsDBHelper
    /* renamed from: d */
    protected final int mo22714d() {
        return 69;
    }

    @Override // com.mbridge.msdk.foundation.p472db.CommonAbsDBHelper
    /* renamed from: a */
    protected final void mo22720a(SQLiteDatabase sQLiteDatabase) {
        m22718b(sQLiteDatabase);
    }

    @Override // com.mbridge.msdk.foundation.p472db.CommonAbsDBHelper
    /* renamed from: a */
    protected final void mo22719a(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        m22715c(sQLiteDatabase);
        m22718b(sQLiteDatabase);
    }

    @Override // com.mbridge.msdk.foundation.p472db.CommonAbsDBHelper
    /* renamed from: b */
    protected final void mo22717b(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        m22715c(sQLiteDatabase);
        m22718b(sQLiteDatabase);
    }
}
