...
/* renamed from: com.mbridge.msdk.foundation.db.q */
/* loaded from: E:\fuckcool\tsn\6520572.dex */
public class SettingCampaignDao extends BaseDao {

    /* renamed from: a */
    private static SettingCampaignDao f30370a;

    private SettingCampaignDao(CommonAbsDBHelper commonAbsDBHelper) {
        super(commonAbsDBHelper);
    }

    /* renamed from: a */
    public static SettingCampaignDao m22674a(CommonAbsDBHelper commonAbsDBHelper) {
        if (f30370a == null) {
            synchronized (SettingCampaignDao.class) {
                if (f30370a == null) {
                    f30370a = new SettingCampaignDao(commonAbsDBHelper);
                }
            }
        }
        return f30370a;
    ...
    /* renamed from: b */
    public final synchronized int m22671b() {
        try {
    ...
    */
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.ReportData> m22669c() {
        /*
            r10 = this;
            monitor-enter(r10)
            r0 = 0
        ...
        L89:
            goto L88
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p472db.SettingCampaignDao.m22669c():java.util.List");
    }

    /* renamed from: b */
    public final synchronized int m22670b(String str) {
        try {
            String[] strArr = {str};
            if (getWritableDatabase() == null) {
                return -1;
    ...
    */
    public final synchronized int m22675a() {
        ...
        L41:
            goto L40
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p472db.SettingCampaignDao.m22675a():int");
    }

    /* renamed from: a */
    public final synchronized int m22672a(String str) {
        try {
            String[] strArr = {str};
            if (getWritableDatabase() == null) {
                return -1;
    ...
    /* renamed from: a */
    public final synchronized long m22673a(ReportData reportData) {
        try {
            ...
            contentValues.put(CampaignEx.JSON_KEY_ST_IEX, reportData.m22473a());
            if (getWritableDatabase() == null) {
                return -1L;
            }
