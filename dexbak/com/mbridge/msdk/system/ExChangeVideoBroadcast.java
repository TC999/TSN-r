...
public class ExChangeVideoBroadcast extends BroadcastReceiver {
    ...
    private static class ExChangeVideoRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (MBSDKContext.m22865f().m22861j() == null || TextUtils.isEmpty(this.f32112pn)) {
                return;
            }
            try {
            ...
            intent.setClassName(this.f32112pn, "com.mbridge.msdk.foundation.aidl.VideoRequestService");
            MBSDKContext.m22865f().m22861j().bindService(intent, new ServiceConnection() { // from class: com.mbridge.msdk.system.ExChangeVideoBroadcast.ExChangeVideoRunnable.1
                ...
                public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    ...
                    if (ExChangeVideoRunnable.this.videoBinderInterface != null) {
                        try {
                            ExChangeVideoRunnable.this.videoBinderInterface.registerListener(new VideoBinderListener.AbstractBinderC11249a() { // from class: com.mbridge.msdk.system.ExChangeVideoBroadcast.ExChangeVideoRunnable.1.1
                                ...
                                public final void onVideo(final String str, final long j, final String str2, final String str3, final String str4, final ParcelFileDescriptor parcelFileDescriptor) throws RemoteException {
                                    ThreadPoolUtils.m22309a().execute(new Runnable() { // from class: com.mbridge.msdk.system.ExChangeVideoBroadcast.ExChangeVideoRunnable.1.1.1
                                        ...
                                        */
                                        public final void run() {
                                            /*
                                                ...
                                                com.mbridge.msdk.foundation.same.b.c r3 = com.mbridge.msdk.foundation.same.p475b.MBridgeDir.MBRIDGE_VC     // Catch: java.lang.Throwable -> L9e java.io.IOException -> Lb7
                                                java.lang.String r3 = com.mbridge.msdk.foundation.same.p475b.MBridgeDirManager.m22347b(r3)     // Catch: java.lang.Throwable -> L9e java.io.IOException -> Lb7
                                            ...
                                            Lb7:
                                                return
                                            */
                                            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.system.ExChangeVideoBroadcast.ExChangeVideoRunnable.ServiceConnectionC116411.BinderC116421.RunnableC116431.run():void");
                                        }
                                    });
                                }
                            });
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ThreadPoolUtils.m22309a().execute(new ExChangeVideoRunnable(str2));
    }
}
