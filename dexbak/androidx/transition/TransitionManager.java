...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo60085clone = transition.mo60085clone();
        mo60085clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo60085clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo60085clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo60085clone);
    }
    ...
    /* renamed from: go */
    public static void m59977go(@NonNull Scene scene) {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition mo60085clone = transition.mo60085clone();
        sceneChangeSetup(viewGroup, mo60085clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo60085clone);
    }

    /* renamed from: go */
    public static void m59976go(@NonNull Scene scene, @Nullable Transition transition) {
