...
import androidx.recyclerview.C0654R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0654R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0654R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0654R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0654R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0654R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@InterfaceC0075Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@InterfaceC0075Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@InterfaceC0075Px int i, @InterfaceC0075Px int i2) {
            ...
            public void setDx(@InterfaceC0075Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@InterfaceC0075Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
            ...
            public Action(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        protected abstract void onSeekTargetStep(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, @NonNull State state, @NonNull Action action);
    ...
    */
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST : 33;
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable != null && drawable != null && stateListDrawable2 != null && drawable2 != null) {
            ...
            new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0654R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0654R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0654R.dimen.fastscroll_margin));
            return;
        }
    ...
    */
    ...
    public void onScrolled(@InterfaceC0075Px int i, @InterfaceC0075Px int i2) {
    }
    ...
    */
    ...
    public void smoothScrollBy(@InterfaceC0075Px int i, @InterfaceC0075Px int i2) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0654R.attr.recyclerViewStyle);
    }
    ...
    */
    ...
    public void smoothScrollBy(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, @Nullable Interpolator interpolator) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0654R.styleable.RecyclerView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 29) {
            saveAttributeDataForStyleable(context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        }
        String string = obtainStyledAttributes.getString(C0654R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0654R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0654R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0654R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0654R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0654R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0654R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0654R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
    ...
    public void smoothScrollBy(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, @Nullable Interpolator interpolator, int i3) {
    ...
    void smoothScrollBy(@InterfaceC0075Px int i, @InterfaceC0075Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutSuppressed) {
