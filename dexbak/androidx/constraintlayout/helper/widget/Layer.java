...
public class Layer extends ConstraintHelper {
    ...
    private void transform() {
        ...
        for (int i = 0; i < this.mCount; i++) {
            ...
            float top2 = ((view.getTop() + view.getBottom()) / 2) - this.mComputedCenterY;
            view.setTranslationX((((f2 * left) + (f4 * top2)) - left) + this.mShiftX);
            view.setTranslationY((((left * f5) + (f6 * top2)) - top2) + this.mShiftY);
    ...
    public void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0224R.styleable.ConstraintLayout_Layout_android_visibility) {
                    this.mApplyVisibilityOnAttach = true;
                } else if (index == C0224R.styleable.ConstraintLayout_Layout_android_elevation) {
