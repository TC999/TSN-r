...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        acquireSolverVariable.f111id = i;
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i = 0; i < this.mNumRows; i++) {
            str = (str + this.mRows[i]) + ShellAdbUtils.f33810d;
        }
        System.out.println(str + this.mGoal + ShellAdbUtils.f33810d);
    }
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f111id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                boolean[] zArr = this.mAlreadyTestedCandidates;
                int i3 = pivotCandidate.f111id;
                if (zArr[i3]) {
                    return i2;
                }
                zArr[i3] = true;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f111id = i2;
    ...
    public void displayReadableRows() {
        ...
        for (int i = 0; i < this.mVariablesID; i++) {
            ...
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + ShellAdbUtils.f33810d;
            }
        }
        String str2 = str + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str2 = str2 + "Goal: " + this.mGoal + ShellAdbUtils.f33810d;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i].toReadableString()) + ShellAdbUtils.f33810d;
            }
        }
        System.out.println(str + this.mGoal + ShellAdbUtils.f33810d);
    }
