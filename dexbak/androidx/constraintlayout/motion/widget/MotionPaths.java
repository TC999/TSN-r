...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f109x, motionPaths.f109x) | z;
        zArr[2] = z | diff(this.f110y, motionPaths.f110y) | zArr[2];
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f109x;
        float f9 = motionPaths.f110y;
        float f10 = (motionPaths2.f109x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f110y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f109x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f110y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 2;
        this.f109x = (int) (((motionPaths.f109x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f110y = (int) (((motionPaths.f110y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = motionPaths.f110y;
        float f11 = motionPaths.height;
        float f12 = (motionPaths2.f109x + (motionPaths2.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (motionPaths2.f110y + (motionPaths2.height / 2.0f)) - ((f11 / 2.0f) + f10);
        float f14 = f12 * f3;
        float f15 = (f6 * f4) / 2.0f;
        this.f109x = (int) ((f8 + f14) - f15);
        float f16 = f3 * f13;
        float f17 = (f7 * f5) / 2.0f;
        this.f110y = (int) ((f10 + f16) - f17);
        this.width = (int) (f9 + f);
        this.height = (int) (f11 + f2);
        float f18 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f109x + f14) - f15);
        float f20 = (int) ((motionPaths.f110y + f16) - f17);
        this.f109x = f19 + ((-f13) * f18);
        this.f110y = f20 + (f12 * f18);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f109x;
        float f9 = motionPaths.f110y;
        float f10 = motionPaths2.f109x + (f4 / 2.0f);
        float f11 = motionPaths2.f110y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f109x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f110y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 3;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f109x = (int) (keyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f110y = (int) (keyPosition.mPercentY * ((int) (i2 - this.height)));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
