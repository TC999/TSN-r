...
public class MotionController {
    ...
    */
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = motionPaths.f109x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f6 = f5 - motionPaths2.f109x;
        float f7 = motionPaths.f110y - motionPaths2.f110y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f3 = motionPaths.f109x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f4 = motionPaths2.f109x;
        float f5 = f3 - f4;
        float f6 = motionPaths.f110y;
        float f7 = motionPaths2.f110y;
        float f8 = f6 - f7;
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        float f3 = motionPaths.f109x;
        rectF.left = f3;
        float f4 = motionPaths.f110y;
        rectF.top = f4;
        rectF.right = f3 + motionPaths.width;
        rectF.bottom = f4 + motionPaths.height;
        RectF rectF2 = new RectF();
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f5 = motionPaths2.f109x;
        rectF2.left = f5;
        float f6 = motionPaths2.f110y;
        rectF2.top = f6;
    ...
    float getStartX() {
        return this.mStartMotionPath.f109x;
    }

    float getStartY() {
        return this.mStartMotionPath.f110y;
    }
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f2 = motionPaths.f109x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f3 = f2 + ((motionPaths2.f109x - f2) * adjustedPosition);
            float f4 = motionPaths.f110y;
            float f5 = f4 + ((motionPaths2.f110y - f4) * adjustedPosition);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i20 = 0; i20 < size; i20++) {
                ...
                dArr6[i20][0] = motionPathsArr[i20].f109x;
                dArr6[i20][1] = motionPathsArr[i20].f110y;
            }
