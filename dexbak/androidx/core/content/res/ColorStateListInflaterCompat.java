...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, m60036to = 1.0d) float f) {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0241R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0241R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                int i3 = C0241R.styleable.ColorStateListItem_android_alpha;
                if (obtainAttributes.hasValue(i3)) {
                    f = obtainAttributes.getFloat(i3, 1.0f);
                } else {
                    int i4 = C0241R.styleable.ColorStateListItem_alpha;
                ...
                for (int i6 = 0; i6 < attributeCount; i6++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != C0241R.attr.alpha) {
                        int i7 = i5 + 1;
