...
public class WindowInsetsCompat {
    ...
    private static class Impl28 extends Impl21 {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Impl28) {
                return C0262a.m60024a(this.mPlatformInsets, ((Impl28) obj).mPlatformInsets);
            }
            return false;
        }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f47161top - i2);
        int max3 = Math.max(0, insets.right - i3);
        int max4 = Math.max(0, insets.bottom - i4);
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m60031of(max, max2, max3, max4);
    }
    ...
    public int getStableInsetTop() {
        return getStableInsets().f47161top;
    }
    ...
    public int getSystemWindowInsetTop() {
        return getSystemWindowInsets().f47161top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f47161top, insets.right, insets.bottom);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m60031of(i, i2, i3, i4)).build();
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f47161top, insets.right, insets.bottom);
            }
        }
    ...
    private static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m60031of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public static class Impl20 extends Impl {
        ...
        final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m60031of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m60030of(rect)).build();
    }
