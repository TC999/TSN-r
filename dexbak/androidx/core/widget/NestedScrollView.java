...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST)) ? false : true;
            ...
            if (keyCode == 19) {
                ...
                if (!keyEvent.isAltPressed()) {
                    return arrowScroll(TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST);
                }
                return fullScroll(TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST);
            } else if (keyCode != 62) {
                return false;
            } else {
