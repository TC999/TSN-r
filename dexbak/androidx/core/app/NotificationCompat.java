...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m60082clone() {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0241R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0241R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0241R.C0245layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0241R.C0244id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0241R.C0244id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0241R.C0244id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0241R.C0244id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0241R.C0245layout.notification_action_tombstone;
            } else {
                i = C0241R.C0245layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            remoteViews.setImageViewBitmap(C0241R.C0244id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0241R.C0242color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0241R.C0244id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0241R.C0244id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0241R.C0244id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0241R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0241R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0241R.C0243drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0241R.C0244id.title, 8);
            remoteViews.setViewVisibility(C0241R.C0244id.text2, 8);
            remoteViews.setViewVisibility(C0241R.C0244id.text, 8);
        }
        ...
        */
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i = C0241R.C0244id.notification_main_column;
            remoteViews.removeAllViews(i);
            remoteViews.addView(i, remoteViews2.clone());
            remoteViews.setViewVisibility(i, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0241R.C0244id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m60083clone() {
            WearableExtender wearableExtender = new WearableExtender();
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                if (size != this.mMessages.size() - 1) {
                    spannableStringBuilder.insert(0, (CharSequence) ShellAdbUtils.f33810d);
                }
