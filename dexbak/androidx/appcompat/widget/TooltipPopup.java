...
class TooltipPopup {
    ...
    public TooltipPopup(@NonNull Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0077R.C0082layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0077R.C0080id.message);
        ...
        layoutParams.windowAnimations = C0077R.C0084style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0077R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0077R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0077R.dimen.tooltip_y_offset_touch : C0077R.dimen.tooltip_y_offset_non_touch);
        ...
        if (rect.left < 0 && rect.top < 0) {
            ...
            int identifier = resources.getIdentifier("status_bar_height", "dimen", FaceEnvironment.f8430OS);
