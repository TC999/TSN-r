...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0077R.attr.actionBarSize, 16842841};
    ...
    */
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0077R.C0080id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0077R.C0080id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0077R.C0080id.action_bar));
        }
    }
