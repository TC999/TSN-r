...
public final class EmptyList implements List, Serializable, RandomAccess, e2.a {
    ...
    public void add(int i4, Void r22) {
    ...
    @Override // java.util.List
    public Void set(int i4, Void r22) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public ListIterator listIterator(int i4) {
        ...
        throw new IndexOutOfBoundsException(kotlin.jvm.internal.f0.C("Index: ", Integer.valueOf(i4)));
    }
}
