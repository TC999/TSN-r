...
public final class q implements b {
    ...
    public static final q f58304a = new q();
    ...
    @Override // r2.p
    @Nullable
    public r2.n B(@NotNull r2.t tVar) {
    ...
    @Override // r2.p
    public boolean O(@NotNull r2.m mVar, @NotNull r2.m mVar2) {
    ...
    @NotNull
    public TypeCheckerState z0(boolean z3, boolean z4) {
        return b.a.m0(this, z3, z4);
    }
}
