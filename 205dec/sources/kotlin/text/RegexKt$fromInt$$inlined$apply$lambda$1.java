...
public final class RegexKt$fromInt$$inlined$apply$lambda$1<T> extends Lambda implements l1.l<T, Boolean> {
    final /* synthetic */ int $value$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RegexKt$fromInt$$inlined$apply$lambda$1(int i4) {
        super(1);
