 ...
 */
    ...
    public interface Chain {
        ...
        @NotNull
        Chain withConnectTimeout(int i4, @NotNull TimeUnit timeUnit);

        @NotNull
        Chain withReadTimeout(int i4, @NotNull TimeUnit timeUnit);

        @NotNull
        Chain withWriteTimeout(int i4, @NotNull TimeUnit timeUnit);
