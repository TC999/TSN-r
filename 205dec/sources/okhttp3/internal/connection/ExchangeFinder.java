...
public final class ExchangeFinder {
    ...
    */
    ...
    private final RealConnection findHealthyConnection(int i4, int i5, int i6, int i7, boolean z3, boolean z4) throws IOException {
        while (true) {
    ...
    public final ExchangeCodec find(@NotNull OkHttpClient client, @NotNull RealInterceptorChain chain) {
        ...
        f0.p(chain, "chain");
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !f0.g(chain.getRequest$okhttp().method(), "GET")).newCodec$okhttp(client, chain);
