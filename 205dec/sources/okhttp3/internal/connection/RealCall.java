 ...
 */
    ...
    public RealCall(@NotNull OkHttpClient client, @NotNull Request originalRequest, boolean z3) {
        f0.p(client, "client");
    ...
    private final <E extends IOException> E callDone(E e4) {
        ...
        E e5 = (E) timeoutExit(e4);
        if (e4 != null) {
            EventListener eventListener = this.eventListener;
            f0.m(e5);
            eventListener.callFailed(this, e5);
        } else {
    ...
    public final void enterNetworkInterceptorExchange(@NotNull Request request, boolean z3) {
    ...
    */
    public final <E extends java.io.IOException> E messageDone$okhttp(@org.jetbrains.annotations.NotNull okhttp3.internal.connection.Exchange r3, boolean r4, boolean r5, E r6) {
        ...
        L42:
            r0 = 0
        L43:
            kotlin.f1 r4 = kotlin.f1.f55527a     // Catch: java.lang.Throwable -> L19
            monitor-exit(r2)
            if (r3 == 0) goto L52
            r3 = 0
            r2.exchange = r3
