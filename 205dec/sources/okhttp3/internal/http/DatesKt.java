...
public final class DatesKt {
    ...
    public static final Date toHttpDateOrNull(@NotNull String toHttpDateOrNull) {
        f0.p(toHttpDateOrNull, "$this$toHttpDateOrNull");
        ...
        synchronized (strArr) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (dateFormat == null) {
                    SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i4], Locale.US);
                    simpleDateFormat2.setTimeZone(Util.UTC);
                    dateFormatArr[i4] = simpleDateFormat2;
    ...
    public static final String toHttpDateString(@NotNull Date toHttpDateString) {
        f0.p(toHttpDateString, "$this$toHttpDateString");
        String format = STANDARD_DATE_FORMAT.get().format(toHttpDateString);
        f0.o(format, "STANDARD_DATE_FORMAT.get().format(this)");
        return format;
    }
}
