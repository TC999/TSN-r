 ...
 */
    ...
    public static final class Companion {
        ...
        @NotNull
        public final Relay edit(@NotNull File file, @NotNull Source upstream, @NotNull ByteString metadata, long j4) throws IOException {
            f0.p(file, "file");
            f0.p(upstream, "upstream");
            f0.p(metadata, "metadata");
            RandomAccessFile randomAccessFile = new RandomAccessFile(file, "rw");
            Relay relay = new Relay(randomAccessFile, upstream, 0L, metadata, j4, null);
 ...
 */
    ...
    public final void writeHeader(ByteString byteString, long j4, long j5) throws IOException {
        Buffer buffer = new Buffer();
    ...
    private final void writeMetadata(long j4) throws IOException {
        ...
        FileChannel channel = randomAccessFile.getChannel();
        f0.o(channel, "file!!.channel");
        new FileOperator(channel).write(32 + j4, buffer, this.metadata.size());
    }
    ...
    public /* synthetic */ Relay(RandomAccessFile randomAccessFile, Source source, long j4, ByteString byteString, long j5, u uVar) {
        this(randomAccessFile, source, j4, byteString, j5);
    }
}
