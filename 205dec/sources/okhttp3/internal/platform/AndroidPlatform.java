 ...
 */
    ...
    static {
        int i4;
        boolean z3 = true;
        if (Platform.Companion.isAndroid() && (i4 = Build.VERSION.SDK_INT) < 30) {
            if (!(i4 >= 21)) {
