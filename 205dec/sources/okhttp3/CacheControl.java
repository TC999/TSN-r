 ...
 */
    ...
    public static final class Builder {
        ...
        @NotNull
        public final Builder maxAge(int i4, @NotNull TimeUnit timeUnit) {
        ...
        @NotNull
        public final Builder maxStale(int i4, @NotNull TimeUnit timeUnit) {
            f0.p(timeUnit, "timeUnit");
            if (i4 >= 0) {
        ...
        @NotNull
        public final Builder minFresh(int i4, @NotNull TimeUnit timeUnit) {
            f0.p(timeUnit, "timeUnit");
            if (i4 >= 0) {
 ...
 */
    ...
    public static final class Companion {
        ...
        private final int indexOfElement(String str, String str2, int i4) {
            ...
            while (i4 < length) {
                U2 = x.U2(str2, str.charAt(i4), false, 2, null);
                if (U2) {
                    return i4;
                }
                i4++;
        ...
        static /* synthetic */ int indexOfElement$default(Companion companion, String str, String str2, int i4, int i5, Object obj) {
            if ((i5 & 2) != 0) {
                i4 = 0;
            }
    ...
    public final boolean m143deprecated_immutable() {
    ...
    public final int m144deprecated_maxAgeSeconds() {
    ...
    public final int m145deprecated_maxStaleSeconds() {
    ...
    public final int m146deprecated_minFreshSeconds() {
    ...
    public final boolean m147deprecated_mustRevalidate() {
    ...
    public final boolean m148deprecated_noCache() {
        return this.noCache;
    }
    ...
    public final boolean m149deprecated_noStore() {
        return this.noStore;
    }
    ...
    public final boolean m150deprecated_noTransform() {
    ...
    public final boolean m151deprecated_onlyIfCached() {
    ...
    public final int m152deprecated_sMaxAgeSeconds() {
    ...
    public /* synthetic */ CacheControl(boolean z3, boolean z4, int i4, int i5, boolean z5, boolean z6, boolean z7, int i6, int i7, boolean z8, boolean z9, boolean z10, String str, u uVar) {
