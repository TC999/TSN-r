 ...
 */
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        @TargetApi(16)
        public String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i4, int i5) {
            String[] supportedTypes;
            IjkMediaCodecInfo ijkMediaCodecInfo;
            if (TextUtils.isEmpty(str)) {
                return null;
            }
            Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", str, Integer.valueOf(i4), Integer.valueOf(i5)));
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i4 != 0) {
                        if (i4 == 1) {
                            ...
                            ijkMediaPlayer.notifyOnBufferingUpdate((int) (j5 < 100 ? j5 : 100L));
                            return;
                        } else if (i4 == 4) {
 ...
 */
    ...
    public interface OnMediaCodecSelectListener {
        String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i4, int i5);
    }
 ...
 */
    ...
    private static boolean onNativeInvoke(Object obj, int i4, Bundle bundle) {
        ...
        DebugLog.ifmt(TAG, "onNativeInvoke %d", Integer.valueOf(i4));
        if (obj != null && (obj instanceof WeakReference)) {
            IjkMediaPlayer ijkMediaPlayer = (IjkMediaPlayer) ((WeakReference) obj).get();
            if (ijkMediaPlayer != null) {
                OnNativeInvokeListener onNativeInvokeListener = ijkMediaPlayer.mOnNativeInvokeListener;
                if (onNativeInvokeListener == null || !onNativeInvokeListener.onNativeInvoke(i4, bundle)) {
                    if (i4 == 131079 && (onControlMessageListener = ijkMediaPlayer.mOnControlMessageListener) != null) {
    ...
    private static String onSelectCodec(Object obj, String str, int i4, int i5) {
        ...
        return onMediaCodecSelectListener.onMediaCodecSelect(ijkMediaPlayer, str, i4, i5);
    }
    ...
    private static void postEventFromNative(Object obj, int i4, int i5, int i6, Object obj2) {
        ...
        if (eventHandler != null) {
            ijkMediaPlayer.mEventHandler.sendMessage(eventHandler.obtainMessage(i4, i5, i6, obj2));
        }
    }
    ...
    public void setCacheShare(int i4) {
        _setPropertyLong(20210, i4);
    }
    ...
    */
    ...
    private void setDataSource(FileDescriptor fileDescriptor, long j4, long j5) throws IOException, IllegalArgumentException, IllegalStateException {
