 ...
 */
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i4 = 1; i4 < this.typeArguments.length; i4++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i4]));
            }
            sb.append(">");
            return sb.toString();
        }
 ...
 */
        ...
        if (cls2.isInterface()) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (cls2.isAssignableFrom(interfaces[i4])) {
                    return getGenericSupertype(cls.getGenericInterfaces()[i4], interfaces[i4], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Type getParameterLowerBound(int i4, ParameterizedType parameterizedType) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, Throwable th, int i4, String str, Object... objArr) {
        return methodError(method, th, str + " (parameter #" + (i4 + 1) + ")", objArr);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, int i4, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i4 + 1) + ")", objArr);
    }
}
