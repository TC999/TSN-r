...
public class JsonParse implements HttpJsonKey {
    ...
    private static void addIndentBlank(StringBuilder sb, int i4) {
    ...
    public JsonParse initJson(String str, String str2, String str3, int i4) {
        setCode(str).setData(str2).setMsg(str3).setSuccessCode(i4);
        return jsonParse;
    }
    ...
    public JsonParse setSuccessCode(int i4) {
        this.successCode = i4;
        return this;
    }
    ...
    public static float getFloat(Map<String, Object> map, String str, float f4) {
        try {
    ...
    public static long getLong(Map<String, Object> map, String str, long j4) {
        try {
