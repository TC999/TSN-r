...
public class d {
    ...
    private static volatile d f1975h;

    /* renamed from: a  reason: collision with root package name */
    String[] f1976a = {"java.lang.Integer", "java.lang.Double", "java.lang.Float", "java.lang.Long", "java.lang.Short", "java.lang.Byte", "java.lang.Boolean", "java.lang.Character", "java.lang.String", "java.util.Date", "int", "double", "long", "short", "byte", "boolean", "char", "float"};

    /* renamed from: b  reason: collision with root package name */
    private final String f1977b = "SQLiteDbUtil";

    /* renamed from: c  reason: collision with root package name */
    private SQLiteDatabase f1978c;
    ...
    private boolean k(String str) {
        List<Map<String, Object>> r3 = r("SELECT count(*) FROM sqlite_master WHERE type='table' AND name='" + str + "'");
        return r3 != null && r3.size() > 0 && Integer.parseInt(r3.get(0).get("count(*)").toString()) > 0;
    }

    private <T> T l(Class<T> cls, Cursor cursor) {
        Object valueOf;
        try {
    ...
    private void m() throws Exception {
        if (this.f1978c != null) {
            q(this.f1979d, this.f1980e, this.f1981f, this.f1982g);
            return;
        }
    ...
    public void a() {
        SQLiteDatabase sQLiteDatabase = this.f1978c;
    ...
    public <T> void b(Class<T> cls) {
        ...
        List<Map<String, Object>> r3 = r("PRAGMA table_info([" + d4 + "])");
        ...
        while (i5 < r3.size()) {
            String str5 = str2;
            String obj = r3.get(i5).get("name").toString();
            List<Map<String, Object>> list = r3;
            String obj2 = r3.get(i5).get("type").toString();
            arrayList5.add(obj);
            arrayList6.add(obj2);
            i5++;
            str2 = str5;
    ...
    public <T> int c(Class<T> cls) {
        ...
        try {
            try {
                m();
                i4 = this.f1978c.delete(d4, (String) null, (String[]) null);
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return i4;
    ...
    public <T> int delete(Class<T> cls, int i4) {
        ...
        try {
            try {
                m();
                i5 = this.f1978c.delete(d4, "id=?", new String[]{String.valueOf(i4)});
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return i5;
    ...
    public <T> long insert(T t3) {
        ...
        try {
            try {
                m();
                j4 = this.f1978c.insert(d4, (String) null, g4);
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return j4;
    ...
    public void q(Context context, String str, String str2, String str3) {
        ...
        this.f1982g = str3;
        try {
            this.f1978c = SQLiteDatabase.openOrCreateDatabase(e.c(context, str, str2).getPath(), SQLiteDatabase.getBytes(str3.toCharArray()), (SQLiteDatabase.CursorFactory) null, (SQLiteDatabaseHook) null);
        } catch (Exception e4) {
            e4.printStackTrace();
        }
    }
    ...
    */
    public <T> T query(java.lang.Class<T> r10, int r11) {
        ...
        L4:
            ...
            r9.m()     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            net.sqlcipher.database.SQLiteDatabase r1 = r9.f1978c     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            r3 = 0
        ...
        L2c:
            ...
            if (r1 == 0) goto L3d
            java.lang.Object r10 = r9.l(r10, r11)     // Catch: java.lang.Exception -> L41 java.lang.Throwable -> L53
            r11.close()
            r9.a()
            return r10
        L3d:
        ...
        L5a:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.bluemobi.dylan.sqlitelibrary.d.query(java.lang.Class, int):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> r(java.lang.String r11) {
        /*
            r10 = this;
            r0 = 0
            r10.m()     // Catch: java.lang.Throwable -> L57 java.lang.Exception -> L5c
            net.sqlcipher.database.SQLiteDatabase r1 = r10.f1978c     // Catch: java.lang.Throwable -> L57 java.lang.Exception -> L5c
        ...
        L77:
            goto L76
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.bluemobi.dylan.sqlitelibrary.d.r(java.lang.String):java.util.List");
    }
    ...
    public <T> int update(T t3, int i4) {
        ...
        try {
            ...
            try {
                ...
                ContentValues g4 = g(t3);
                m();
                i5 = this.f1978c.update(d4, g4, "id=?", new String[]{String.valueOf(i4)});
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return i5;
    ...
    public <T> int delete(Class<T> cls, String str, String[] strArr) {
        ...
        try {
            try {
                m();
                i4 = this.f1978c.delete(d4, str, strArr);
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return i4;
    ...
    public <T> void insert(List<T> list) {
        try {
            ...
            try {
                m();
                this.f1978c.beginTransaction();
                for (T t3 : list) {
                    this.f1978c.insert(b.d(t3.getClass()), (String) null, g(t3));
                }
                this.f1978c.setTransactionSuccessful();
            } catch (Exception e4) {
                e4.printStackTrace();
            }
        } finally {
            this.f1978c.endTransaction();
            a();
        }
    }
    ...
    public <T> int update(T t3, String str, String[] strArr) {
        ...
        try {
            try {
                m();
                i4 = this.f1978c.update(d4, g4, str, strArr);
            } catch (Exception e4) {
                e4.printStackTrace();
            }
            return i4;
    ...
    public <T> List<T> query(Class<T> cls, String str, String[] strArr) {
        ...
        try {
            try {
                m();
                query = this.f1978c.query(d4, null, str, strArr, null, null, null);
            } catch (Exception e4) {
                e = e4;
                arrayList = null;
            }
    ...
    public <T> List<T> query(Class<T> cls) {
        ...
        try {
            try {
                m();
                query = this.f1978c.query(b.d(cls), null, null, null, null, null, null);
            } catch (Exception e4) {
                e = e4;
                arrayList = null;
            }
    ...
    public <T> List<T> query(Class<T> cls, String[] strArr, String str, String[] strArr2, String str2, String str3, String str4, String str5) {
        ...
        try {
            try {
                m();
                query = this.f1978c.query(b.d(cls), strArr, str, strArr2, str2, str3, str4, str5);
            } catch (Throwable th) {
                th = th;
            }
        } catch (Exception e4) {
