 ...
 */
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        final BiFunction<? super T1, ? super T2, ? extends R> f54845f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f54845f = biFunction;
        }

        @Override // io.reactivex.functions.Function
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f54845f.apply(objArr[0], objArr[1]);
            }
 ...
 */
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function3<T1, T2, T3, R> f54846f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f54846f = function3;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return (R) this.f54846f.apply(objArr[0], objArr[1], objArr[2]);
            }
 ...
 */
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function4<T1, T2, T3, T4, R> f54847f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f54847f = function4;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return (R) this.f54847f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
 ...
 */
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final Function5<T1, T2, T3, T4, T5, R> f54848f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f54848f = function5;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return (R) this.f54848f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
 ...
 */
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function6<T1, T2, T3, T4, T5, T6, R> f54849f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f54849f = function6;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return (R) this.f54849f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
 ...
 */
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f54850f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f54850f = function7;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return (R) this.f54850f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
 ...
 */
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f54851f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f54851f = function8;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return (R) this.f54851f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
 ...
 */
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f54852f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f54852f = function9;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return (R) this.f54852f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
 ...
 */
    ...
    static final class ArrayListCapacityCallable<T> implements Callable<List<T>> {
        ...
        ArrayListCapacityCallable(int i4) {
            this.capacity = i4;
        }
 ...
 */
    ...
    static final class EqualsPredicate<T> implements Predicate<T> {
        ...
        EqualsPredicate(T t3) {
            this.value = t3;
        }

        @Override // io.reactivex.functions.Predicate
        public boolean test(T t3) throws Exception {
            return ObjectHelper.equals(t3, this.value);
        }
    }
 ...
 */
    ...
    static final class NotificationOnNext<T> implements Consumer<T> {
        ...
        @Override // io.reactivex.functions.Consumer
        public void accept(T t3) throws Exception {
            this.onNotification.accept(Notification.createOnNext(t3));
        }
    }
 ...
 */
    ...
    static final class TimestampFunction<T> implements Function<T, Timed<T>> {
        ...
        @Override // io.reactivex.functions.Function
        public Timed<T> apply(T t3) throws Exception {
            return new Timed<>(t3, this.scheduler.now(this.unit), this.unit);
        }
    }
 ...
 */
    ...
    static final class ToMapKeySelector<K, T> implements BiConsumer<Map<K, T>, T> {
        ...
        public void accept(Map<K, T> map, T t3) throws Exception {
            map.put(this.keySelector.apply(t3), t3);
        }
    }
 ...
 */
    ...
    static final class ToMapKeyValueSelector<K, V, T> implements BiConsumer<Map<K, V>, T> {
        ...
        public void accept(Map<K, V> map, T t3) throws Exception {
            map.put(this.keySelector.apply(t3), this.valueSelector.apply(t3));
        }
    }
 ...
 */
    ...
    static final class ToMultimapKeyValueSelector<K, V, T> implements BiConsumer<Map<K, Collection<V>>, T> {
        ...
        public void accept(Map<K, Collection<V>> map, T t3) throws Exception {
            ...
            collection.add(this.valueSelector.apply(t3));
        }
    }
 ...
 */
    ...
    public static <T> Callable<List<T>> createArrayList(int i4) {
        return new ArrayListCapacityCallable(i4);
    }
    ...
    public static <T> Callable<T> justCallable(T t3) {
        return new JustValue(t3);
    }

    public static <T, U> Function<T, U> justFunction(U u3) {
        return new JustValue(u3);
    }
