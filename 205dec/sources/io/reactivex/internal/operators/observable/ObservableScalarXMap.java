 ...
 */
    ...
    public static final class ScalarDisposable<T> extends AtomicInteger implements QueueDisposable<T>, Runnable {
        ...
        public ScalarDisposable(Observer<? super T> observer, T t3) {
 ...
 */
    ...
    public static final class ScalarXMapObservable<T, R> extends Observable<R> {
        ...
        ScalarXMapObservable(T t3, Function<? super T, ? extends ObservableSource<? extends R>> function) {
            this.value = t3;
    ...
    public static <T, U> Observable<U> scalarXMap(T t3, Function<? super T, ? extends ObservableSource<? extends U>> function) {
        return RxJavaPlugins.onAssembly(new ScalarXMapObservable(t3, function));
    }
