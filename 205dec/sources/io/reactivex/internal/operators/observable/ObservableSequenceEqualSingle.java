    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f55094v1 == null) {
                    this.f55094v1 = spscLinkedArrayQueue.poll();
                }
                boolean z5 = this.f55094v1 == null;
                if (this.f55095v2 == null) {
                    this.f55095v2 = spscLinkedArrayQueue2.poll();
                }
                T t3 = this.f55095v2;
                boolean z6 = t3 == null;
                if (z3 && z4 && z5 && z6) {
                    ...
                    if (!z5 && !z6) {
                        try {
                            if (!this.comparer.test((T) this.f55094v1, t3)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.actual.onSuccess(Boolean.FALSE);
                                return;
                            }
