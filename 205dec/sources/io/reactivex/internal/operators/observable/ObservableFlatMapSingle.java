 ...
 */
        ...
        void innerSuccess(FlatMapSingleObserver<T, R>.InnerObserver innerObserver, R r3) {
            this.set.delete(innerObserver);
            if (get() == 0) {
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55068d, disposable)) {
                this.f55068d = disposable;
