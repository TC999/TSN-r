 ...
 */
    ...
    public static final class OperatorWindowBoundaryCloseObserver<T, V> extends DisposableObserver<V> {
        ...
        final UnicastSubject<T> f55126w;

        OperatorWindowBoundaryCloseObserver(WindowBoundaryMainObserver<T, ?, V> windowBoundaryMainObserver, UnicastSubject<T> unicastSubject) {
            this.parent = windowBoundaryMainObserver;
            this.f55126w = unicastSubject;
        }
 ...
 */
    ...
    static final class WindowBoundaryMainObserver<T, B, V> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable {
        ...
        void close(OperatorWindowBoundaryCloseObserver<T, V> operatorWindowBoundaryCloseObserver) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseObserver.f55126w, null));
            if (enter()) {
                drainLoop();
            }
        }
        ...
        void drainLoop() {
            ...
            while (true) {
                ...
                if (z3 && z4) {
                    ...
                    UnicastSubject<T> unicastSubject3 = windowOperation.f55128w;
                    if (unicastSubject3 != null) {
                        if (list.remove(unicastSubject3)) {
                            windowOperation.f55128w.onComplete();
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55127s, disposable)) {
                this.f55127s = disposable;
 ...
 */
    ...
    public static final class WindowOperation<T, B> {
        ...
        /* renamed from: w  reason: collision with root package name */
        final UnicastSubject<T> f55128w;

        WindowOperation(UnicastSubject<T> unicastSubject, B b4) {
            this.f55128w = unicastSubject;
            this.open = b4;
        }
    }
