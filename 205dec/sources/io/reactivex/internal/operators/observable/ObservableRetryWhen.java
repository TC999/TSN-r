 ...
 */
    ...
    static final class RepeatWhenObserver<T> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        final AtomicReference<Disposable> f55087d = new AtomicReference<>();
 ...
 */
        ...
        public void dispose() {
            DisposableHelper.dispose(this.f55087d);
        ...
        public boolean isDisposed() {
            return DisposableHelper.isDisposed(this.f55087d.get());
        }
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.replace(this.f55087d, disposable);
        }
