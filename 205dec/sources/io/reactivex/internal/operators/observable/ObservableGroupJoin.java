 ...
 */
    ...
    static final class GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, JoinSupport {
        ...
        public void innerClose(boolean z3, LeftRightEndObserver leftRightEndObserver) {
            synchronized (this) {
                this.queue.offer(z3 ? LEFT_CLOSE : RIGHT_CLOSE, leftRightEndObserver);
            }
            drain();
        }
 ...
 */
    ...
    public interface JoinSupport {
        void innerClose(boolean z3, LeftRightEndObserver leftRightEndObserver);
