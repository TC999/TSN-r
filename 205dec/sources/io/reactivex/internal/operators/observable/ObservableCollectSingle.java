 ...
 */
    ...
    static final class CollectObserver<T, U> implements Observer<T>, Disposable {
        ...
        public void dispose() {
            this.f55045s.dispose();
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f55045s.isDisposed();
        }
        ...
        public void onComplete() {
            ...
            this.done = true;
            this.actual.onSuccess((U) this.f55046u);
        }
        ...
        public void onNext(T t3) {
            ...
            try {
                this.collector.accept((U) this.f55046u, t3);
            } catch (Throwable th) {
                this.f55045s.dispose();
                onError(th);
            }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55045s, disposable)) {
                this.f55045s = disposable;
