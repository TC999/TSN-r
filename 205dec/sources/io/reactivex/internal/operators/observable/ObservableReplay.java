 ...
 */
    ...
    static abstract class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
        ...
        public final void next(T t3) {
            addLast(new Node(enterTransform(NotificationLite.next(t3))));
            truncate();
        }
 ...
 */
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> observableSource, int i4) {
        ...
        return create(observableSource, new ReplayBufferSupplier(i4));
    }
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> observableSource, long j4, TimeUnit timeUnit, Scheduler scheduler, int i4) {
        return create(observableSource, new ScheduledReplaySupplier(i4, j4, timeUnit, scheduler));
    }
