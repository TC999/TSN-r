 ...
 */
    ...
    static final class ParallelReduceSubscriber<T, R> extends DeferredScalarSubscriber<T, R> {
        ...
        ParallelReduceSubscriber(Subscriber<? super R> subscriber, R r3, BiFunction<R, ? super T, R> biFunction) {
            super(subscriber);
            this.accumulator = r3;
        ...
        public void onNext(T t3) {
            ...
            try {
                this.accumulator = (R) ObjectHelper.requireNonNull(this.reducer.apply(this.accumulator, t3), "The reducer returned a null value");
            } catch (Throwable th) {
    ...
    public void subscribe(Subscriber<? super R>[] subscriberArr) {
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                try {
                    subscriberArr2[i4] = new ParallelReduceSubscriber(subscriberArr[i4], ObjectHelper.requireNonNull(this.initialSupplier.call(), "The initialSupplier returned a null value"), this.reducer);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
