 ...
 */
    ...
    static final class ParallelPeekSubscriber<T> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t3) {
            ...
            try {
                this.parent.onNext.accept(t3);
                this.actual.onNext(t3);
                try {
                    this.parent.onAfterNext.accept(t3);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    onError(th);
                }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55150s, subscription)) {
                this.f55150s = subscription;
                try {
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                subscriberArr2[i4] = new ParallelPeekSubscriber(subscriberArr[i4], this);
            }
