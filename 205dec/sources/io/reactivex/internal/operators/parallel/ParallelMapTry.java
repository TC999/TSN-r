 ...
 */
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t3) {
            ...
            this.f55148s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55148s, subscription)) {
                this.f55148s = subscription;
 ...
 */
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t3) {
            ...
            this.f55149s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55149s, subscription)) {
                this.f55149s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (subscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i4] = new ParallelMapTryConditionalSubscriber((ConditionalSubscriber) subscriber, this.mapper, this.errorHandler);
                } else {
                    subscriberArr2[i4] = new ParallelMapTrySubscriber(subscriber, this.mapper, this.errorHandler);
                }
            }
