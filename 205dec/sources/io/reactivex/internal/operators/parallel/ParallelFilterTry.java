 ...
 */
    ...
    public static abstract class BaseFilterSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public final void onNext(T t3) {
            ...
            this.f55142s.request(1L);
        }

        @Override // org.reactivestreams.Subscription
        public final void request(long j4) {
            this.f55142s.request(j4);
        }
    }
 ...
 */
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55142s, subscription)) {
                this.f55142s = subscription;
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (subscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i4] = new ParallelFilterConditionalSubscriber((ConditionalSubscriber) subscriber, this.predicate, this.errorHandler);
                } else {
                    subscriberArr2[i4] = new ParallelFilterSubscriber(subscriber, this.predicate, this.errorHandler);
                }
            }
