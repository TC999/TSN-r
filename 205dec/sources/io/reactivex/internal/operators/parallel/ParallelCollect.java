 ...
 */
    ...
    static final class ParallelCollectSubscriber<T, C> extends DeferredScalarSubscriber<T, C> {
        ...
        ParallelCollectSubscriber(Subscriber<? super C> subscriber, C c4, BiConsumer<? super C, ? super T> biConsumer) {
            super(subscriber);
            this.collection = c4;
        ...
        public void onNext(T t3) {
            ...
            try {
                this.collector.accept((C) this.collection, t3);
            } catch (Throwable th) {
    ...
    public void subscribe(Subscriber<? super C>[] subscriberArr) {
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                try {
                    subscriberArr2[i4] = new ParallelCollectSubscriber(subscriberArr[i4], ObjectHelper.requireNonNull(this.initialCollection.call(), "The initialSupplier returned a null value"), this.collector);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
