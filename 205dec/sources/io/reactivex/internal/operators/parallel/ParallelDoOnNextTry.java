 ...
 */
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t3) {
            ...
            this.f55139s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55139s, subscription)) {
                this.f55139s = subscription;
 ...
 */
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t3) {
            ...
            this.f55140s.request(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f55140s, subscription)) {
                this.f55140s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (subscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i4] = new ParallelDoOnNextConditionalSubscriber((ConditionalSubscriber) subscriber, this.onNext, this.errorHandler);
                } else {
                    subscriberArr2[i4] = new ParallelDoOnNextSubscriber(subscriber, this.onNext, this.errorHandler);
                }
            }
