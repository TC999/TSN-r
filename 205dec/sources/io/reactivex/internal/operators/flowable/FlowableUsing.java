 ...
 */
    ...
    static final class UsingSubscriber<T, D> extends AtomicBoolean implements FlowableSubscriber<T>, Subscription {
        ...
        Subscription f54982s;

        UsingSubscriber(Subscriber<? super T> subscriber, D d4, Consumer<? super D> consumer, boolean z3) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f54982s, subscription)) {
                this.f54982s = subscription;
        ...
        public void request(long j4) {
            this.f54982s.request(j4);
        }
    }

    public FlowableUsing(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> function, Consumer<? super D> consumer, boolean z3) {
