 ...
 */
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        boolean checkTerminated(boolean z3, boolean z4, Subscriber<?> subscriber, SimpleQueue<?> simpleQueue) {
            if (this.cancelled) {
                this.current = null;
                simpleQueue.clear();
                return true;
        ...
        void consumedOne(boolean z3) {
            if (z3) {
                int i4 = this.consumed + 1;
                if (i4 == this.limit) {
                    this.consumed = 0;
                    this.f54924s.request(i4);
                    return;
                }
                this.consumed = i4;
            }
        ...
        */
        ...
        public void onNext(T t3) {
            ...
            if (this.fusionMode == 0 && !this.queue.offer(t3)) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f54924s, subscription)) {
                this.f54924s = subscription;
