 ...
 */
        ...
        static final class DebounceInnerSubscriber<T, U> extends DisposableSubscriber<U> {
            ...
            DebounceInnerSubscriber(DebounceSubscriber<T, U> debounceSubscriber, long j4, T t3) {
        ...
        public void onNext(T t3) {
            ...
            try {
                Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.debounceSelector.apply(t3), "The publisher supplied is null");
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f54904s, subscription)) {
                this.f54904s = subscription;
