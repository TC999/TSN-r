 ...
 */
    ...
    public static final class ScalarXMapFlowable<T, R> extends Flowable<R> {
        ...
        ScalarXMapFlowable(T t3, Function<? super T, ? extends Publisher<? extends R>> function) {
            this.value = t3;
    ...
    public static <T, U> Flowable<U> scalarXMap(T t3, Function<? super T, ? extends Publisher<? extends U>> function) {
        return RxJavaPlugins.onAssembly(new ScalarXMapFlowable(t3, function));
    }
