 ...
 */
    ...
    public static final class BufferedReplayCallable<T> implements Callable<ConnectableFlowable<T>> {
        ...
        BufferedReplayCallable(Flowable<T> flowable, int i4) {
 ...
 */
    ...
    public static final class BufferedTimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        BufferedTimedReplay(Flowable<T> flowable, int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
            this.parent = flowable;
            this.bufferSize = i4;
            this.time = j4;
            this.unit = timeUnit;
 ...
 */
    ...
    public static final class FlatMapIntoIterable<T, U> implements Function<T, Publisher<U>> {
        ...
        public Publisher<U> apply(T t3) throws Exception {
            return new FlowableFromIterable((Iterable) ObjectHelper.requireNonNull(this.mapper.apply(t3), "The mapper returned a null Iterable"));
        }
    }
 ...
 */
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u3) throws Exception {
            return this.combiner.apply((T) this.f54931t, u3);
        }
    }
 ...
 */
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, Publisher<R>> {
        ...
        public Publisher<R> apply(T t3) throws Exception {
            return new FlowableMapPublisher((Publisher) ObjectHelper.requireNonNull(this.mapper.apply(t3), "The mapper returned a null Publisher"), new FlatMapWithCombinerInner(this.combiner, t3));
        }
    }
 ...
 */
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, Publisher<T>> {
        ...
        public Publisher<T> apply(T t3) throws Exception {
            return new FlowableTakePublisher((Publisher) ObjectHelper.requireNonNull(this.itemDelay.apply(t3), "The itemDelay returned a null Publisher"), 1L).map(Functions.justFunction(t3)).defaultIfEmpty(t3);
        }
    }
 ...
 */
    ...
    public static final class TimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        TimedReplay(Flowable<T> flowable, long j4, TimeUnit timeUnit, Scheduler scheduler) {
            this.parent = flowable;
            this.time = j4;
            this.unit = timeUnit;
            this.scheduler = scheduler;
 ...
 */
    ...
    public static <T> Callable<ConnectableFlowable<T>> replayCallable(Flowable<T> flowable, int i4) {
        return new BufferedReplayCallable(flowable, i4);
    }

    public static <T> Callable<ConnectableFlowable<T>> replayCallable(Flowable<T> flowable, int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return new BufferedTimedReplay(flowable, i4, j4, timeUnit, scheduler);
    }
    ...
    public static <T> Callable<ConnectableFlowable<T>> replayCallable(Flowable<T> flowable, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return new TimedReplay(flowable, j4, timeUnit, scheduler);
    }
}
