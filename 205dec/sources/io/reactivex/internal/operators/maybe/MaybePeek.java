 ...
 */
    ...
    static final class MaybePeekObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            ...
            this.f55023d.dispose();
            this.f55023d = DisposableHelper.DISPOSED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f55023d.isDisposed();
        }
        ...
        public void onComplete() {
            Disposable disposable = this.f55023d;
        ...
        public void onError(Throwable th) {
            if (this.f55023d == DisposableHelper.DISPOSED) {
                RxJavaPlugins.onError(th);
            } else {
                onErrorInner(th);
            }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55023d, disposable)) {
                try {
                    this.parent.onSubscribeCall.accept(disposable);
                    this.f55023d = disposable;
        ...
        public void onSuccess(T t3) {
            ...
            try {
                this.parent.onSuccessCall.accept(t3);
                this.f55023d = disposableHelper;
