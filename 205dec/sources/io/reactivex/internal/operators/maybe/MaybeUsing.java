 ...
 */
    ...
    static final class UsingObserver<T, D> extends AtomicReference<Object> implements MaybeObserver<T>, Disposable {
        ...
        UsingObserver(MaybeObserver<? super T> maybeObserver, D d4, Consumer<? super D> consumer, boolean z3) {
            super(d4);
        ...
        public void dispose() {
            ...
            this.f55027d = DisposableHelper.DISPOSED;
        ...
        public boolean isDisposed() {
            return this.f55027d.isDisposed();
        }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55027d, disposable)) {
                this.f55027d = disposable;
    ...
    public MaybeUsing(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z3) {
