 ...
 */
        ...
        static final class NextMaybeObserver<T> implements MaybeObserver<T> {
            ...
            public void onSubscribe(Disposable disposable) {
                DisposableHelper.setOnce(this.f55021d, disposable);
            }
        ...
        OnErrorNextMaybeObserver(MaybeObserver<? super T> maybeObserver, Function<? super Throwable, ? extends MaybeSource<? extends T>> function, boolean z3) {
            this.actual = maybeObserver;
