 ...
 */
        ...
        @Override // io.reactivex.MaybeObserver
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f55010d, disposable)) {
                this.f55010d = disposable;
        ...
        public void onSuccess(T t3) {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.onSuccessMapper.apply(t3), "The onSuccessMapper returned a null MaybeSource")).subscribe(new InnerObserver());
            } catch (Exception e4) {
                Exceptions.throwIfFatal(e4);
                this.actual.onError(e4);
            }
