...
public final class RxJavaPlugins {
    ...
    @NonNull
    static <T, R> R apply(@NonNull Function<T, R> function, @NonNull T t3) {
        try {
    ...
    @NonNull
    static <T, U, R> R apply(@NonNull BiFunction<T, U, R> biFunction, @NonNull T t3, @NonNull U u3) {
        try {
            return biFunction.apply(t3, u3);
        } catch (Throwable th) {
            throw ExceptionHelper.wrapOrThrow(th);
        }
    }
