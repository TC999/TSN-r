...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Maybe<T> just(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
        return RxJavaPlugins.onAssembly(new MaybeJust(t3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Maybe<T> defaultIfEmpty(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Maybe<T> onErrorReturnItem(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <E extends MaybeObserver<? super T>> E subscribeWith(E e4) {
        subscribe(e4);
        return e4;
    }
    ...
    public final Maybe<T> timeout(long j4, TimeUnit timeUnit) {
        return timeout(j4, timeUnit, Schedulers.computation());
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Single<T> toSingle(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultValue is null");
        return RxJavaPlugins.onAssembly(new MaybeToSingle(this, t3));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Maybe<Long> timer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new MaybeTimer(Math.max(0L, j4), timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, D> Maybe<T> using(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z3) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new MaybeUsing(callable, function, consumer, z3));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Maybe<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new MaybeDelay(this, Math.max(0L, j4), timeUnit, scheduler));
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Maybe<T> timeout(long j4, TimeUnit timeUnit, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
        return timeout(j4, timeUnit, Schedulers.computation(), maybeSource);
    }
    ...
    public static <T> Maybe<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit) {
        ObjectHelper.requireNonNull(future, "future is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new MaybeFromFuture(future, j4, timeUnit));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher, int i4) {
        ObjectHelper.requireNonNull(publisher, "source is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), false, i4, Flowable.bufferSize()));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final T blockingGet(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultValue is null");
        BlockingMultiObserver blockingMultiObserver = new BlockingMultiObserver();
        subscribe(blockingMultiObserver);
        return (T) blockingMultiObserver.blockingGet(t3);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Maybe<T> delaySubscription(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return delaySubscription(Flowable.timer(j4, timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final Maybe<T> retry(long j4, Predicate<? super Throwable> predicate) {
        return toFlowable().retry(j4, predicate).singleElement();
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Maybe<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
        return timeout(timer(j4, timeUnit, scheduler), maybeSource);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Maybe<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout(timer(j4, timeUnit, scheduler));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher, int i4) {
        ObjectHelper.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(publisher, MaybeToPublisher.instance(), i4, ErrorMode.IMMEDIATE));
    }
