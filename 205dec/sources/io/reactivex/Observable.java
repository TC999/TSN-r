 ...
 */
    ...
    @CheckReturnValue
    public static Observable<Long> interval(long j4, long j5, TimeUnit timeUnit) {
        return interval(j4, j5, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public static Observable<Long> intervalRange(long j4, long j5, long j6, long j7, TimeUnit timeUnit) {
        return intervalRange(j4, j5, j6, j7, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3) {
        ObjectHelper.requireNonNull(t3, "The item is null");
        return RxJavaPlugins.onAssembly(new ObservableJust(t3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static Observable<Long> rangeLong(long j4, long j5) {
        if (j5 < 0) {
            ...
            return RxJavaPlugins.onAssembly(new ObservableRangeLong(j4, j5));
        }
    }
    ...
    private Observable<T> timeout0(long j4, TimeUnit timeUnit, ObservableSource<? extends T> observableSource, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "timeUnit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableTimeoutTimed(this, j4, timeUnit, scheduler, observableSource));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> Observable<R> zipArray(Function<? super Object[], ? extends R> function, boolean z3, int i4, ObservableSource<? extends T>... observableSourceArr) {
        if (observableSourceArr.length == 0) {
            return empty();
        }
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableZip(observableSourceArr, null, function, i4, z3));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> Observable<R> zipIterable(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableZip(null, iterable, function, i4, z3));
    }
    ...
    public final Iterable<T> blockingMostRecent(T t3) {
        return new BlockingObservableMostRecent(this, t3);
    }
    ...
    public final Observable<T> cacheWithInitialCapacity(int i4) {
        return ObservableCache.from(this, i4);
    }
    ...
    public final <U> Single<U> collectInto(U u3, BiConsumer<? super U, ? super T> biConsumer) {
        ObjectHelper.requireNonNull(u3, "initialValue is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z3) {
        return concatMapEagerDelayError(function, Integer.MAX_VALUE, bufferSize(), z3);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<T> defaultIfEmpty(T t3) {
    ...
    public final Maybe<T> elementAt(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableElementAtMaybe(this, j4));
        }
    ...
    public final Single<T> elementAtOrError(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableElementAtSingle(this, j4, null));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    public final Single<T> last(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new ObservableLastSingle(this, t3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<T> onErrorReturnItem(T t3) {
    ...
    public final Single<T> single(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new ObservableSingleSingle(this, t3));
    }
    ...
    public final Observable<T> skip(long j4) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableSkip(this, j4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <E extends Observer<? super T>> E subscribeWith(E e4) {
        subscribe(e4);
        return e4;
    }
    ...
    public final Observable<T> take(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableTake(this, j4));
        }
    ...
    public static <T> Observable<T> concatEager(ObservableSource<? extends ObservableSource<? extends T>> observableSource, int i4, int i5) {
        ObjectHelper.requireNonNull(Integer.valueOf(i4), "maxConcurrency is null");
        ObjectHelper.requireNonNull(Integer.valueOf(i5), "prefetch is null");
        return wrap(observableSource).concatMapEager(Functions.identity(), i4, i5);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Observable<Long> interval(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableInterval(Math.max(0L, j4), Math.max(0L, j5), timeUnit, scheduler));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Observable<Long> intervalRange(long j4, long j5, long j6, long j7, TimeUnit timeUnit, Scheduler scheduler) {
        if (j5 < 0) {
            throw new IllegalArgumentException("count >= 0 required but it was " + j5);
        } else if (j5 == 0) {
            ...
            ObjectHelper.requireNonNull(timeUnit, "unit is null");
            ObjectHelper.requireNonNull(scheduler, "scheduler is null");
            return RxJavaPlugins.onAssembly(new ObservableIntervalRange(j4, j8, Math.max(0L, j6), Math.max(0L, j7), timeUnit, scheduler));
        }
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Observable<Long> timer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableTimer(Math.max(j4, 0L), timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, D> Observable<T> using(Callable<? extends D> callable, Function<? super D, ? extends ObservableSource<? extends T>> function, Consumer<? super D> consumer, boolean z3) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new ObservableUsing(callable, function, consumer, z3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, int i4, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        if (this instanceof ScalarCallable) {
            Object call = ((ScalarCallable) this).call();
        ...
        return RxJavaPlugins.onAssembly(new ObservableConcatMap(this, function, i4, z3 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, int i4, int i5, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new ObservableConcatMapEager(this, function, z3 ? ErrorMode.END : ErrorMode.BOUNDARY, i4, i5));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z3) {
        return flatMap(function, z3, Integer.MAX_VALUE);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapCompletableCompletable(this, function, z3));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapMaybe(this, function, z3));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapSingle(this, function, z3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z3) {
        return (Observable<GroupedObservable<K, T>>) groupBy(function, Functions.identity(), z3, bufferSize());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> observeOn(Scheduler scheduler, boolean z3) {
    ...
    public final Observable<T> repeat(long j4) {
        if (j4 >= 0) {
            ...
            return RxJavaPlugins.onAssembly(new ObservableRepeat(this, j4));
        }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<T> sample(long j4, TimeUnit timeUnit, boolean z3) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> throttleFirst(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableThrottleFirstTimed(this, j4, timeUnit, scheduler));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> throttleLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return sample(j4, timeUnit, scheduler);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> throttleWithTimeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, long j5) {
    ...
    public static <T> Observable<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit) {
        ObjectHelper.requireNonNull(future, "future is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new ObservableFromFuture(future, j4, timeUnit));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4) {
    ...
    public final Single<T> elementAt(long j4, T t3) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(t3, "defaultItem is null");
            return RxJavaPlugins.onAssembly(new ObservableElementAtSingle(this, j4, t3));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z3, int i4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> observeOn(Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableObserveOn(this, scheduler, z3, i4));
    }
    ...
    public final <R> Single<R> reduce(R r3, BiFunction<R, ? super T, R> biFunction) {
        ...
        ObjectHelper.requireNonNull(biFunction, "reducer is null");
        return RxJavaPlugins.onAssembly(new ObservableReduceSeedSingle(this, r3, biFunction));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleTimed(this, j4, timeUnit, scheduler, false));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> scan(R r3, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r3, "seed is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, long j5, int i4) {
        ObjectHelper.verifyPositive(j4, "count");
        ObjectHelper.verifyPositive(j5, "skip");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableWindow(this, j4, j5, i4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> concatDelayError(ObservableSource<? extends ObservableSource<? extends T>> observableSource, int i4, boolean z3) {
        ObjectHelper.requireNonNull(observableSource, "sources is null");
        ObjectHelper.verifyPositive(i4, "prefetch is null");
        return RxJavaPlugins.onAssembly(new ObservableConcatMap(observableSource, Functions.identity(), i4, z3 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> debounce(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableDebounceTimed(this, j4, timeUnit, scheduler));
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<T> delay(long j4, TimeUnit timeUnit, boolean z3) {
        return delay(j4, timeUnit, Schedulers.computation(), z3);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> delaySubscription(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z3, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ...
        return RxJavaPlugins.onAssembly(new ObservableFlatMap(this, function, z3, i4, i5));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z3) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skip(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<T> startWith(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> take(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return delay(j4, timeUnit, scheduler, false);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableGroupBy(this, function, function2, i4, z3));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final Observable<T> retry(long j4, Predicate<? super Throwable> predicate) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(predicate, "predicate is null");
            return RxJavaPlugins.onAssembly(new ObservableRetryPredicate(this, j4, predicate));
        }
        throw new IllegalArgumentException("times >= 0 required but it was " + j4);
    }
    ...
    @SchedulerSupport("io.reactivex:trampoline")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, boolean z3) {
        return skipLast(j4, timeUnit, Schedulers.trampoline(), z3, bufferSize());
    }
    ...
    @SchedulerSupport("io.reactivex:trampoline")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, long j5, TimeUnit timeUnit) {
        return takeLast(j4, j5, timeUnit, Schedulers.trampoline(), false, bufferSize());
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<T> timeout(long j4, TimeUnit timeUnit, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return timeout0(j4, timeUnit, observableSource, Schedulers.computation());
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static <T> Observable<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Observable<Long> interval(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return interval(j4, j4, timeUnit, scheduler);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableDelay(this, j4, timeUnit, scheduler, z3));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleTimed(this, j4, timeUnit, scheduler, z3));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return skipLast(j4, timeUnit, scheduler, false, bufferSize());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3) {
        return zip(this, observableSource, biFunction, z3);
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> function, int i4, long j4, TimeUnit timeUnit) {
        return replay(function, i4, j4, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        return skipLast(j4, timeUnit, scheduler, z3, bufferSize());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableTakeLastTimed(this, j4, j5, timeUnit, scheduler, i4, z3));
        }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return timeout0(j4, timeUnit, observableSource, scheduler);
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, long j5, TimeUnit timeUnit) {
        return window(j4, j5, timeUnit, Schedulers.computation(), bufferSize());
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4) {
        return zip(this, observableSource, biFunction, z3, i4);
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<List<T>> buffer(long j4, long j5, TimeUnit timeUnit) {
        return (Observable<List<T>>) buffer(j4, j5, timeUnit, Schedulers.computation(), ArrayListSupplier.asCallable());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> function, int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return ObservableReplay.multicastSelector(ObservableInternalHelper.replayCallable(this, i4, j4, timeUnit, scheduler), function);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableSkipLastTimed(this, j4, timeUnit, scheduler, i4 << 1, z3));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<List<T>> buffer(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        return (Observable<List<T>>) buffer(j4, j5, timeUnit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout0(j4, timeUnit, null, scheduler);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, int i4) {
        ObjectHelper.verifyPositive(j4, "timespan");
        ObjectHelper.verifyPositive(j5, "timeskip");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new ObservableWindowTimed(this, j4, j5, timeUnit, scheduler, Long.MAX_VALUE, i4, false));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final <U extends Collection<? super T>> Observable<U> buffer(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return RxJavaPlugins.onAssembly(new ObservableBufferTimed(this, j4, j5, timeUnit, scheduler, callable, Integer.MAX_VALUE, false));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> Observable<T> sample(ObservableSource<U> observableSource, boolean z3) {
        ObjectHelper.requireNonNull(observableSource, "sampler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleWithObservable(this, observableSource, z3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, R> Observable<R> zip(ObservableSource<? extends T1> observableSource, ObservableSource<? extends T2> observableSource2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z3) {
        ObjectHelper.requireNonNull(observableSource, "source1 is null");
        ObjectHelper.requireNonNull(observableSource2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z3, bufferSize(), observableSource, observableSource2);
    }
    ...
    @SchedulerSupport("io.reactivex:trampoline")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, boolean z3) {
        return takeLast(j4, timeUnit, Schedulers.trampoline(), z3, bufferSize());
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return takeLast(j4, timeUnit, scheduler, false, bufferSize());
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, R> Observable<R> zip(ObservableSource<? extends T1> observableSource, ObservableSource<? extends T2> observableSource2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z3, int i4) {
        ObjectHelper.requireNonNull(observableSource, "source1 is null");
        ObjectHelper.requireNonNull(observableSource2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z3, i4, observableSource, observableSource2);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<List<T>> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4) {
        return (Observable<List<T>>) buffer(j4, timeUnit, scheduler, i4, ArrayListSupplier.asCallable(), false);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        return takeLast(Long.MAX_VALUE, j4, timeUnit, scheduler, z3, i4);
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, long j5) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final <U extends Collection<? super T>> Observable<U> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4, Callable<U> callable, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        ObjectHelper.verifyPositive(i4, "count");
        return RxJavaPlugins.onAssembly(new ObservableBufferTimed(this, j4, j4, timeUnit, scheduler, callable, i4, z3));
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, long j5, boolean z3) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return window(j4, timeUnit, scheduler, Long.MAX_VALUE, false);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5) {
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> function, long j4, TimeUnit timeUnit) {
        return replay(function, j4, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z3) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7, T t8) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> function, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return ObservableReplay.multicastSelector(ObservableInternalHelper.replayCallable(this, j4, timeUnit, scheduler), function);
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z3, int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j5, "count");
        return RxJavaPlugins.onAssembly(new ObservableWindowTimed(this, j4, j4, timeUnit, scheduler, j5, i4, z3));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<List<T>> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return (Observable<List<T>>) buffer(j4, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "combiner is null");
        return flatMap(ObservableInternalHelper.flatMapWithCombiner(function, biFunction), z3, i4, i5);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final ConnectableObservable<T> replay(int i4, long j4, TimeUnit timeUnit) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final ConnectableObservable<T> replay(int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return ObservableReplay.create(this, j4, timeUnit, scheduler, i4);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final ConnectableObservable<T> replay(long j4, TimeUnit timeUnit) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final ConnectableObservable<T> replay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return ObservableReplay.create(this, j4, timeUnit, scheduler);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
