...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    @CheckReturnValue
    public static Flowable<Long> interval(long j4, long j5, TimeUnit timeUnit) {
        return interval(j4, j5, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public static Flowable<Long> intervalRange(long j4, long j5, long j6, long j7, TimeUnit timeUnit) {
        return intervalRange(j4, j5, j6, j7, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
        return RxJavaPlugins.onAssembly(new FlowableJust(t3));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(Iterable<? extends Publisher<? extends T>> iterable, int i4, int i5) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeArray(int i4, int i5, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).flatMap(Functions.identity(), false, i4, i5);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeArrayDelayError(int i4, int i5, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).flatMap(Functions.identity(), true, i4, i5);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Flowable<Integer> range(int i4, int i5) {
        if (i5 < 0) {
            ...
            if (i4 + (i5 - 1) <= 2147483647L) {
                return RxJavaPlugins.onAssembly(new FlowableRange(i4, i5));
            }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Flowable<Long> rangeLong(long j4, long j5) {
        if (j5 < 0) {
            ...
            return RxJavaPlugins.onAssembly(new FlowableRangeLong(j4, j5));
        }
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> switchOnNext(Publisher<? extends Publisher<? extends T>> publisher, int i4) {
        return fromPublisher(publisher).switchMap(Functions.identity(), i4);
    }
    ...
    private Flowable<T> timeout0(long j4, TimeUnit timeUnit, Publisher<? extends T> publisher, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "timeUnit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableTimeoutTimed(this, j4, timeUnit, scheduler, publisher));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipArray(Function<? super Object[], ? extends R> function, boolean z3, int i4, Publisher<? extends T>... publisherArr) {
        if (publisherArr.length == 0) {
            return empty();
        }
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(publisherArr, null, function, i4, z3));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipIterable(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(null, iterable, function, i4, z3));
    }
    ...
    public final Iterable<T> blockingMostRecent(T t3) {
        return new BlockingFlowableMostRecent(this, t3);
    }
    ...
    public final Flowable<T> cacheWithInitialCapacity(int i4) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableCache(this, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <U> Single<U> collectInto(U u3, BiConsumer<? super U, ? super T> biConsumer) {
        ObjectHelper.requireNonNull(u3, "initialItem is null");
        return collect(Functions.justCallable(u3), biConsumer);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, boolean z3) {
        return concatMapEagerDelayError(function, bufferSize(), bufferSize(), z3);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> defaultIfEmpty(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
    ...
    public final Maybe<T> elementAt(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableElementAtMaybe(this, j4));
        }
    ...
    public final Single<T> elementAtOrError(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableElementAtSingle(this, j4, null));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Single<T> first(T t3) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> last(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultItem");
        return RxJavaPlugins.onAssembly(new FlowableLastSingle(this, t3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> onErrorReturnItem(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
        return onErrorReturn(Functions.justFunction(t3));
    }
    ...
    public final Flowable<T> rebatchRequests(int i4) {
        return observeOn(ImmediateThinScheduler.INSTANCE, true, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> single(T t3) {
        ObjectHelper.requireNonNull(t3, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new FlowableSingleSingle(this, t3));
    }
    ...
    public final Flowable<T> skip(long j4) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableSkip(this, j4));
    }
    ...
    public final Flowable<T> skipLast(int i4) {
        if (i4 >= 0) {
            ...
            return RxJavaPlugins.onAssembly(new FlowableSkipLast(this, i4));
        }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final <E extends Subscriber<? super T>> E subscribeWith(E e4) {
        subscribe(e4);
        return e4;
    }
    ...
    <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> function, int i4, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ...
        return RxJavaPlugins.onAssembly(new FlowableSwitchMap(this, function, i4, z3));
    }
    ...
    public final Flowable<T> take(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableTake(this, j4));
        }
    ...
    public final Flowable<T> takeLast(int i4) {
        if (i4 < 0) {
            ...
            return RxJavaPlugins.onAssembly(new FlowableTakeLast(this, i4));
        }
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatArrayEager(int i4, int i5, Publisher<? extends T>... publisherArr) {
        ObjectHelper.requireNonNull(publisherArr, "sources is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(new FlowableFromArray(publisherArr), Functions.identity(), i4, i5, ErrorMode.IMMEDIATE));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(Publisher<? extends Publisher<? extends T>> publisher, int i4, int i5) {
        ObjectHelper.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEagerPublisher(publisher, Functions.identity(), i4, i5, ErrorMode.IMMEDIATE));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public static Flowable<Long> interval(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableInterval(Math.max(0L, j4), Math.max(0L, j5), timeUnit, scheduler));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public static Flowable<Long> intervalRange(long j4, long j5, long j6, long j7, TimeUnit timeUnit, Scheduler scheduler) {
        if (j5 < 0) {
            throw new IllegalArgumentException("count >= 0 required but it was " + j5);
        } else if (j5 == 0) {
            return empty().delay(j6, timeUnit, scheduler);
        } else {
            long j8 = j4 + (j5 - 1);
            if (j4 > 0 && j8 < 0) {
                throw new IllegalArgumentException("Overflow! start + count is bigger than Long.MAX_VALUE");
            ...
            ObjectHelper.requireNonNull(timeUnit, "unit is null");
            ObjectHelper.requireNonNull(scheduler, "scheduler is null");
            return RxJavaPlugins.onAssembly(new FlowableIntervalRange(j4, j8, Math.max(0L, j6), Math.max(0L, j7), timeUnit, scheduler));
        }
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends Publisher<? extends T>> iterable, int i4, int i5) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> switchOnNextDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i4) {
        return fromPublisher(publisher).switchMapDelayError(Functions.identity(), i4);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public static Flowable<Long> timer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableTimer(Math.max(0L, j4), timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public static <T, D> Flowable<T> using(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> function, Consumer<? super D> consumer, boolean z3) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new FlowableUsing(callable, function, consumer, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(int i4, int i5) {
        return (Flowable<List<T>>) buffer(i4, i5, ArrayListSupplier.asCallable());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMap(Function<? super T, ? extends Publisher<? extends R>> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, function, i4, ErrorMode.IMMEDIATE));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i4, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        if (this instanceof ScalarCallable) {
            Object call = ((ScalarCallable) this).call();
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, function, i4, z3 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEager(Function<? super T, ? extends Publisher<? extends R>> function, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(this, function, i4, i5, ErrorMode.IMMEDIATE));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i4, int i5, boolean z3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(this, function, i4, i5, z3 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U> Flowable<U> concatMapIterable(Function<? super T, ? extends Iterable<? extends U>> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableFlattenIterable(this, function, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z3) {
        return flatMap(function, z3, bufferSize(), bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletableCompletable(this, function, z3, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U> Flowable<U> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableFlattenIterable(this, function, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapMaybe(this, function, z3, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapSingle(this, function, z3, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z3) {
        return (Flowable<GroupedFlowable<K, T>>) groupBy(function, Functions.identity(), z3, bufferSize());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z3) {
        return observeOn(scheduler, z3, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(boolean z3) {
        return onBackpressureBuffer(bufferSize(), z3, true);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final ParallelFlowable<T> parallel(int i4) {
        ObjectHelper.verifyPositive(i4, "parallelism");
        return ParallelFlowable.from(this, i4);
    }
    ...
    public final Flowable<T> repeat(long j4) {
        if (j4 >= 0) {
            ...
            return RxJavaPlugins.onAssembly(new FlowableRepeat(this, j4));
        }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j4, TimeUnit timeUnit, boolean z3) {
        return sample(j4, timeUnit, Schedulers.computation(), z3);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> switchMap(Function<? super T, ? extends Publisher<? extends R>> function, int i4) {
        return switchMap0(function, i4, false);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final <R> Flowable<R> switchMapDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i4) {
        return switchMap0(function, i4, true);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleFirst(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableThrottleFirstTimed(this, j4, timeUnit, scheduler));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return sample(j4, timeUnit, scheduler);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleWithTimeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return debounce(j4, timeUnit, scheduler);
    }
    ...
    public final Single<List<T>> toList(int i4) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableToListSingle(this, Functions.createArrayList(i4)));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, long j5) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> combineLatest(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i4) {
        ObjectHelper.requireNonNull(publisherArr, "sources is null");
        if (publisherArr.length == 0) {
            return empty();
        }
        ...
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableCombineLatest((Publisher[]) publisherArr, (Function) function, i4, false));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> combineLatestDelayError(Function<? super Object[], ? extends R> function, int i4, Publisher<? extends T>... publisherArr) {
        return combineLatestDelayError(publisherArr, function, i4);
    }
    ...
    public static <T> Flowable<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit) {
        ObjectHelper.requireNonNull(future, "future is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new FlowableFromFuture(future, j4, timeUnit));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(Iterable<? extends Publisher<? extends T>> iterable, int i4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends Publisher<? extends T>> iterable, int i4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Single<Boolean> sequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, BiPredicate<? super T, ? super T> biPredicate, int i4) {
        ...
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableSequenceEqualSingle(publisher, publisher2, biPredicate, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U extends Collection<? super T>> Flowable<U> buffer(int i4, int i5, Callable<U> callable) {
        ObjectHelper.verifyPositive(i4, "count");
        ObjectHelper.verifyPositive(i5, "skip");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return RxJavaPlugins.onAssembly(new FlowableBuffer(this, i4, i5, callable));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> elementAt(long j4, T t3) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(t3, "defaultItem is null");
            return RxJavaPlugins.onAssembly(new FlowableElementAtSingle(this, j4, t3));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, int i4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableObserveOn(this, scheduler, z3, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> publish(Function<? super Flowable<T>, ? extends Publisher<? extends R>> function, int i4) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowablePublishMulticast(this, function, i4, false));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Single<R> reduce(R r3, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r3, "seed is null");
        ObjectHelper.requireNonNull(biFunction, "reducer is null");
        return RxJavaPlugins.onAssembly(new FlowableReduceSeedSingle(this, r3, biFunction));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSampleTimed(this, j4, timeUnit, scheduler, false));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> scan(R r3, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r3, "seed is null");
        return scanWith(Functions.justCallable(r3), biFunction);
    }
    ...
    @CheckReturnValue
    @Experimental
    public final Flowable<T> subscribeOn(@NonNull Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSubscribeOn(this, scheduler, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final TestSubscriber<T> test(long j4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, long j5, int i4) {
        ObjectHelper.verifyPositive(j5, "skip");
        ObjectHelper.verifyPositive(j4, "count");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableWindow(this, j4, j5, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> combineLatestDelayError(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i4) {
        ObjectHelper.requireNonNull(publisherArr, "sources is null");
        ObjectHelper.requireNonNull(function, "combiner is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        if (publisherArr.length == 0) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableCombineLatest((Publisher[]) publisherArr, (Function) function, i4, true));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concat(Publisher<? extends Publisher<? extends T>> publisher, int i4) {
        return fromPublisher(publisher).concatMap(Functions.identity(), i4);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i4, boolean z3) {
        return fromPublisher(publisher).concatMapDelayError(Functions.identity(), i4, z3);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> debounce(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableDebounceTimed(this, j4, timeUnit, scheduler));
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j4, TimeUnit timeUnit, boolean z3) {
        return delay(j4, timeUnit, Schedulers.computation(), z3);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delaySubscription(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return delaySubscription(timer(j4, timeUnit, scheduler));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z3, int i4) {
        return flatMap(function, z3, i4, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z3) {
        return groupBy(function, function2, z3, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z3) {
        return onBackpressureBuffer(i4, z3, false);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final ParallelFlowable<T> parallel(int i4, int i5) {
        ObjectHelper.verifyPositive(i4, "parallelism");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return ParallelFlowable.from(this, i4, i5);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, int i4) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return FlowableReplay.multicastSelector(FlowableInternalHelper.replayCallable(this, i4), function);
    }
    ...
    public final Flowable<T> retry(long j4) {
        return retry(j4, Functions.alwaysTrue());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> skip(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return skipUntil(timer(j4, timeUnit, scheduler));
    }
    ...
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit) {
        return skipLast(j4, timeUnit, Schedulers.computation(), false, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> startWith(T t3) {
        ObjectHelper.requireNonNull(t3, "item is null");
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final Flowable<T> take(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return takeUntil(timer(j4, timeUnit, scheduler));
    }
    ...
    public final Flowable<T> timeout(long j4, TimeUnit timeUnit) {
        return timeout0(j4, timeUnit, null, Schedulers.computation());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(Publisher<? extends Publisher<? extends T>> publisher, int i4) {
        return fromPublisher(publisher).flatMap(Functions.identity(), i4);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i4) {
        return fromPublisher(publisher).flatMap(Functions.identity(), true, i4);
    }
    ...
    public final T blockingFirst(T t3) {
        ...
        subscribe((FlowableSubscriber) blockingFirstSubscriber);
        T blockingGet = blockingFirstSubscriber.blockingGet();
        return blockingGet != null ? blockingGet : t3;
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z3, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMap(this, function, z3, i4, i5));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z3, int i4) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableGroupBy(this, function, function2, i4, z3));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z3, boolean z4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i4, z4, z3, Functions.EMPTY_ACTION));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> retry(long j4, Predicate<? super Throwable> predicate) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(predicate, "predicate is null");
            return RxJavaPlugins.onAssembly(new FlowableRetryPredicate(this, j4, predicate));
        }
        throw new IllegalArgumentException("times >= 0 required but it was " + j4);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, boolean z3) {
        return skipLast(j4, timeUnit, Schedulers.computation(), z3, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, long j5, TimeUnit timeUnit) {
        return takeLast(j4, j5, timeUnit, Schedulers.computation(), false, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final TestSubscriber<T> test(long j4, boolean z3) {
        TestSubscriber<T> testSubscriber = new TestSubscriber<>(j4);
        if (z3) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> timeout(long j4, TimeUnit timeUnit, Publisher<? extends T> publisher) {
        ObjectHelper.requireNonNull(publisher, "other is null");
        return timeout0(j4, timeUnit, publisher, Schedulers.computation());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return fromFuture(future, j4, timeUnit).subscribeOn(scheduler);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public static Flowable<Long> interval(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return interval(j4, j4, timeUnit, scheduler);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableDelay(this, Math.max(0L, j4), timeUnit, scheduler, z3));
    }
    ...
    public final ConnectableFlowable<T> publish(int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return FlowablePublish.create(this, i4);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSampleTimed(this, j4, timeUnit, scheduler, z3));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return skipLast(j4, timeUnit, scheduler, false, bufferSize());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        return takeLast(j4, j5, timeUnit, scheduler, false, bufferSize());
    }
    ...
    public final Single<List<T>> toSortedList(int i4) {
        return toSortedList(Functions.naturalComparator(), i4);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3) {
        return zip(this, publisher, biFunction, z3);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(Iterable<? extends Publisher<? extends T>> iterable, int i4, int i5) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(new FlowableFromIterable(iterable), Functions.identity(), i4, i5, ErrorMode.IMMEDIATE));
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z3, boolean z4, Action action) {
        ObjectHelper.requireNonNull(action, "onOverflow is null");
        ObjectHelper.verifyPositive(i4, "capacity");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i4, z4, z3, action));
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, int i4, long j4, TimeUnit timeUnit) {
        return replay(function, i4, j4, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        return skipLast(j4, timeUnit, scheduler, z3, bufferSize());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableTakeLastTimed(this, j4, j5, timeUnit, scheduler, i4, z3));
        }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler, Publisher<? extends T> publisher) {
        ObjectHelper.requireNonNull(publisher, "other is null");
        return timeout0(j4, timeUnit, publisher, scheduler);
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, long j5, TimeUnit timeUnit) {
        return window(j4, j5, timeUnit, Schedulers.computation(), bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4) {
        return zip(this, publisher, biFunction, z3, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Single<Boolean> sequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, int i4) {
        return sequenceEqual(publisher, publisher2, ObjectHelper.equalsPredicate(), i4);
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(long j4, long j5, TimeUnit timeUnit) {
        return (Flowable<List<T>>) buffer(j4, j5, timeUnit, Schedulers.computation(), ArrayListSupplier.asCallable());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, V> Flowable<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> function, BiFunction<? super T, ? super U, ? extends V> biFunction, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "resultSelector is null");
        return (Flowable<V>) flatMap(FlowableInternalHelper.flatMapIntoIterable(function), biFunction, false, bufferSize(), i4);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return FlowableReplay.multicastSelector(FlowableInternalHelper.replayCallable(this, i4, j4, timeUnit, scheduler), function);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableSkipLastTimed(this, j4, timeUnit, scheduler, i4 << 1, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        return window(j4, j5, timeUnit, scheduler, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z3) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z3, bufferSize(), publisher, publisher2);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler) {
        return (Flowable<List<T>>) buffer(j4, j5, timeUnit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final Flowable<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout0(j4, timeUnit, null, scheduler);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.verifyPositive(j4, "timespan");
        ObjectHelper.verifyPositive(j5, "timeskip");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new FlowableWindowTimed(this, j4, j5, timeUnit, scheduler, Long.MAX_VALUE, i4, false));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> combineLatest(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i4) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.requireNonNull(function, "combiner is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableCombineLatest((Iterable) iterable, (Function) function, i4, false));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return RxJavaPlugins.onAssembly(new FlowableBufferTimed(this, j4, j5, timeUnit, scheduler, callable, Integer.MAX_VALUE, false));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, Action action) {
        return onBackpressureBuffer(i4, false, false, action);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> combineLatestDelayError(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i4) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.requireNonNull(function, "combiner is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableCombineLatest((Iterable) iterable, (Function) function, i4, true));
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(long j4, Action action, BackpressureOverflowStrategy backpressureOverflowStrategy) {
        ObjectHelper.requireNonNull(backpressureOverflowStrategy, "strategy is null");
        ObjectHelper.verifyPositive(j4, "capacity");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBufferStrategy(this, j4, action, backpressureOverflowStrategy));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U> Flowable<T> sample(Publisher<U> publisher, boolean z3) {
        ObjectHelper.requireNonNull(publisher, "sampler is null");
        return RxJavaPlugins.onAssembly(new FlowableSamplePublisher(this, publisher, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z3, int i4) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z3, i4, publisher, publisher2);
    }
    ...
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit) {
        return takeLast(j4, timeUnit, Schedulers.computation(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, boolean z3) {
        return takeLast(j4, timeUnit, Schedulers.computation(), z3, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, int i4, Scheduler scheduler) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return FlowableReplay.multicastSelector(FlowableInternalHelper.replayCallable(this, i4), FlowableInternalHelper.replayFunction(function, scheduler));
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return takeLast(j4, timeUnit, scheduler, false, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ObjectHelper.requireNonNull(t7, "The fifth item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        return takeLast(j4, timeUnit, scheduler, z3, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4) {
        return (Flowable<List<T>>) buffer(j4, timeUnit, scheduler, i4, ArrayListSupplier.asCallable(), false);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3, int i4) {
        return takeLast(Long.MAX_VALUE, j4, timeUnit, scheduler, z3, i4);
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, long j5) {
        return window(j4, timeUnit, Schedulers.computation(), j5, false);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4, Callable<U> callable, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        ObjectHelper.verifyPositive(i4, "count");
        return RxJavaPlugins.onAssembly(new FlowableBufferTimed(this, j4, j4, timeUnit, scheduler, callable, i4, z3));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, Function<Throwable, ? extends Publisher<? extends R>> function2, Callable<? extends Publisher<? extends R>> callable, int i4) {
        ObjectHelper.requireNonNull(function, "onNextMapper is null");
        ObjectHelper.requireNonNull(function2, "onErrorMapper is null");
        ObjectHelper.requireNonNull(callable, "onCompleteSupplier is null");
        return merge(new FlowableMapNotification(this, function, function2, callable), i4);
    }

    @SchedulerSupport("io.reactivex:computation")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, long j5, boolean z3) {
        return window(j4, timeUnit, Schedulers.computation(), j5, z3);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return window(j4, timeUnit, scheduler, Long.MAX_VALUE, false);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5) {
        return window(j4, timeUnit, scheduler, j5, false);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, long j4, TimeUnit timeUnit) {
        return replay(function, j4, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z3) {
        return window(j4, timeUnit, scheduler, j5, z3, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7, T t8) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ObjectHelper.requireNonNull(t7, "The fifth item is null");
        ObjectHelper.requireNonNull(t8, "The sixth item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> function, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(function, "selector is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return FlowableReplay.multicastSelector(FlowableInternalHelper.replayCallable(this, j4, timeUnit, scheduler), function);
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z3, int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j5, "count");
        return RxJavaPlugins.onAssembly(new FlowableWindowTimed(this, j4, j4, timeUnit, scheduler, j5, i4, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return (Flowable<List<T>>) buffer(j4, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3) {
        return flatMap(function, biFunction, z3, bufferSize(), bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4) {
        return flatMap(function, biFunction, z3, i4, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z3, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "combiner is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "bufferSize");
        return flatMap(FlowableInternalHelper.flatMapWithCombiner(function, biFunction), z3, i4, i5);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <B> Flowable<Flowable<T>> window(Publisher<B> publisher, int i4) {
        ObjectHelper.requireNonNull(publisher, "boundaryIndicator is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableWindowBoundary(this, publisher, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ObjectHelper.requireNonNull(t7, "The fifth item is null");
        ObjectHelper.requireNonNull(t8, "The sixth item is null");
        ObjectHelper.requireNonNull(t9, "The seventh item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <B> Flowable<List<T>> buffer(Publisher<B> publisher, int i4) {
        ObjectHelper.verifyPositive(i4, "initialCapacity");
        return (Flowable<List<T>>) buffer(publisher, Functions.createArrayList(i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, int i4) {
    ...
    public final ConnectableFlowable<T> replay(int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return FlowableReplay.create(this, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U, V> Flowable<Flowable<T>> window(Publisher<U> publisher, Function<? super U, ? extends Publisher<V>> function, int i4) {
        ObjectHelper.requireNonNull(publisher, "openingIndicator is null");
        ObjectHelper.requireNonNull(function, "closingIndicator is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableWindowBoundarySelector(this, publisher, function, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final ConnectableFlowable<T> replay(int i4, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return FlowableReplay.create(this, j4, timeUnit, scheduler, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t8, "The sixth item is null");
        ObjectHelper.requireNonNull(t9, "The seventh item is null");
        ObjectHelper.requireNonNull(t10, "The eighth item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <B> Flowable<Flowable<T>> window(Callable<? extends Publisher<B>> callable, int i4) {
        ObjectHelper.requireNonNull(callable, "boundaryIndicatorSupplier is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableWindowBoundarySupplier(this, callable, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final ConnectableFlowable<T> replay(int i4, Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return FlowableReplay.observeOn(replay(i4), scheduler);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final ConnectableFlowable<T> replay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return FlowableReplay.create(this, j4, timeUnit, scheduler);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t9, "The seventh item is null");
        ObjectHelper.requireNonNull(t10, "The eighth item is null");
        ObjectHelper.requireNonNull(t11, "The ninth is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12) {
        ObjectHelper.requireNonNull(t3, "The first item is null");
        ObjectHelper.requireNonNull(t4, "The second item is null");
        ObjectHelper.requireNonNull(t5, "The third item is null");
        ObjectHelper.requireNonNull(t6, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t9, "The seventh item is null");
        ObjectHelper.requireNonNull(t10, "The eighth item is null");
        ObjectHelper.requireNonNull(t11, "The ninth item is null");
        ObjectHelper.requireNonNull(t12, "The tenth item is null");
