...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> just(T t3) {
        ...
        return RxJavaPlugins.onAssembly(new SingleJust(t3));
    }
    ...
    private Single<T> timeout0(long j4, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new SingleTimeout(this, j4, timeUnit, scheduler, singleSource));
    }

    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public static Single<Long> timer(long j4, TimeUnit timeUnit) {
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Single<T> delay(long j4, TimeUnit timeUnit) {
    ...
    public final Single<T> onErrorReturnItem(T t3) {
        ObjectHelper.requireNonNull(t3, "value is null");
        return RxJavaPlugins.onAssembly(new SingleOnErrorReturn(this, null, t3));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <E extends SingleObserver<? super T>> E subscribeWith(E e4) {
        subscribe(e4);
        return e4;
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Single<T> timeout(long j4, TimeUnit timeUnit) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Single<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit) {
        return toSingle(Flowable.fromFuture(future, j4, timeUnit));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static Single<Long> timer(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new SingleTimer(j4, timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, U> Single<T> using(Callable<U> callable, Function<? super U, ? extends SingleSource<? extends T>> function, Consumer<? super U> consumer, boolean z3) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "singleFunction is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new SingleUsing(callable, function, consumer, z3));
    }
    ...
    @CheckReturnValue
    @Experimental
    public final Single<T> delay(long j4, TimeUnit timeUnit, boolean z3) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Single<T> retry(long j4) {
        return toSingle(toFlowable().retry(j4));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Single<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static <T> Single<T> fromFuture(Future<? extends T> future, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return toSingle(Flowable.fromFuture(future, j4, timeUnit, scheduler));
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Single<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Single<T> timeout(long j4, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return timeout0(j4, timeUnit, scheduler, singleSource);
    }
    ...
    @CheckReturnValue
    @Experimental
    public final Single<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z3) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new SingleDelay(this, j4, timeUnit, scheduler, z3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concat(Publisher<? extends SingleSource<? extends T>> publisher, int i4) {
        ObjectHelper.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(publisher, SingleInternalHelper.toFlowable(), i4, ErrorMode.IMMEDIATE));
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Single<T> timeout(long j4, TimeUnit timeUnit, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return timeout0(j4, timeUnit, Schedulers.computation(), singleSource);
    }
    ...
    @SchedulerSupport("io.reactivex:computation")
    @CheckReturnValue
    public final Single<T> delaySubscription(long j4, TimeUnit timeUnit) {
        return delaySubscription(j4, timeUnit, Schedulers.computation());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Single<T> delaySubscription(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return delaySubscription(Observable.timer(j4, timeUnit, scheduler));
    }
