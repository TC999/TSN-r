...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
    ...
    public boolean add(Channel channel) {
        boolean z3 = (channel instanceof ServerChannel ? this.serverChannels : this.nonServerChannels).putIfAbsent(channel.id(), channel) == null;
        if (z3) {
    ...
    public DefaultChannelGroup(EventExecutor eventExecutor, boolean z3) {
        this("group-0x" + Integer.toHexString(nextId.incrementAndGet()), eventExecutor, z3);
    }

    @Override // io.netty.channel.group.ChannelGroup
    public ChannelGroupFuture write(Object obj, ChannelMatcher channelMatcher, boolean z3) {
    ...
    @Override // io.netty.channel.group.ChannelGroup
    public ChannelGroupFuture writeAndFlush(Object obj, ChannelMatcher channelMatcher, boolean z3) {
        ChannelGroupFuture defaultChannelGroupFuture;
        if (obj != null) {
            if (z3) {
                for (Channel channel : this.nonServerChannels.values()) {
    ...
    public DefaultChannelGroup(String str, EventExecutor eventExecutor, boolean z3) {
