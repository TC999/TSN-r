 ...
 */
        ...
        this.childListener = new ChannelFutureListener() { // from class: io.netty.channel.group.DefaultChannelGroupFuture.1
            ...
            public void operationComplete(ChannelFuture channelFuture) throws Exception {
                ...
                synchronized (DefaultChannelGroupFuture.this) {
                    ...
                    z3 = DefaultChannelGroupFuture.this.successCount + DefaultChannelGroupFuture.this.failureCount == DefaultChannelGroupFuture.this.futures.size();
                }
                if (z3) {
    ...
    static /* synthetic */ int access$008(DefaultChannelGroupFuture defaultChannelGroupFuture) {
        int i4 = defaultChannelGroupFuture.successCount;
        defaultChannelGroupFuture.successCount = i4 + 1;
        return i4;
    }

    static /* synthetic */ int access$108(DefaultChannelGroupFuture defaultChannelGroupFuture) {
        int i4 = defaultChannelGroupFuture.failureCount;
        defaultChannelGroupFuture.failureCount = i4 + 1;
        return i4;
    }
    ...
    public synchronized boolean isPartialFailure() {
        boolean z3;
        int i4 = this.failureCount;
        if (i4 != 0) {
            z3 = i4 != this.futures.size();
        }
        return z3;
    }
    ...
    public DefaultChannelGroupFuture setSuccess(Void r12) {
        throw new IllegalStateException();
    }
