 ...
 */
    ...
    public NioSctpServerChannel() {
        ...
        this.config = new NioSctpServerChannelConfig(this, mo104javaChannel());
    }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SctpChannel accept = mo104javaChannel().accept();
        if (accept == null) {
            return 0;
        }
    ...
    public com.sun.nio.sctp.SctpServerChannel mo104javaChannel() {
