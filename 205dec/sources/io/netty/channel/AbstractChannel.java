 ...
 */
    ...
    public abstract class AbstractUnsafe implements Channel.Unsafe {
        ...
        class AnonymousClass9 implements Runnable {
            ...
            public void run() {
                AbstractChannel.this.pipeline.fireExceptionCaught((Throwable) this.val$e);
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void fireChannelInactiveAndDeregister(boolean z3) {
            deregister(voidPromise(), z3 && !AbstractChannel.this.isActive());
        }
        ...
        public void invokeLater(Runnable runnable) {
            try {
                ...
                AbstractChannel.logger.warn("Can't invoke task later as EventLoop rejected it", (Throwable) e4);
            }
        }
        ...
        public void register0(ChannelPromise channelPromise) {
            try {
                if (channelPromise.setUncancellable() && ensureOpen(channelPromise)) {
                    boolean z3 = this.neverRegistered;
            ...
            if (AbstractChannel.this.isActive()) {
                try {
                    ...
                    invokeLater(new Runnable() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.8
                        @Override // java.lang.Runnable
                        public void run() {
                            AbstractChannel.this.pipeline.fireExceptionCaught((Throwable) e4);
                        }
                    });
                    close(voidPromise());
                }
        ...
        public final void closeForcibly() {
            ...
            try {
                ...
                AbstractChannel.logger.warn("Failed to close a channel.", (Throwable) e4);
            }
        }
        ...
        private void close(final ChannelPromise channelPromise, final Throwable th, final ClosedChannelException closedChannelException, final boolean z3) {
            if (channelPromise.setUncancellable()) {
                    ...
                    AbstractChannel.this.closeFuture.addListener((GenericFutureListener<? extends Future<? super Void>>) new ChannelFutureListener() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.4
                        ...
                        class AnonymousClass1 implements Runnable {
                            ...
                            public void run() {
                                ...
                                AbstractUnsafe.access$600(abstractUnsafe, defaultChannelPipeline, anonymousClass4.val$outboundBuffer, anonymousClass4.val$shutdownCause);
                            }
                        }
                                ...
                                try {
                                    ...
                                    AbstractUnsafe.this.invokeLater(new Runnable() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.5.1
                                        ...
                                        public void run() {
                                            ...
                                            channelOutboundBuffer.failFlushed(th, z3);
                            ...
                            invokeLater(new Runnable() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.6
                                ...
                                class AnonymousClass1 implements Runnable {
                                    ...
                                    public void run() {
                                        ...
                                        ChannelOutboundBuffer channelOutboundBuffer = anonymousClass6.val$outboundBuffer;
                                        if (channelOutboundBuffer != null) {
                                            channelOutboundBuffer.failFlushed(anonymousClass6.val$cause, anonymousClass6.val$notify);
                                            AnonymousClass6 anonymousClass62 = AnonymousClass6.this;
                                            anonymousClass62.val$outboundBuffer.close(anonymousClass62.val$closeCause);
                                        }
                                        AnonymousClass6 anonymousClass63 = AnonymousClass6.this;
                                        AbstractUnsafe.access$900(AbstractUnsafe.this, isActive);
                                    }
                                }
        ...
        private void deregister(final ChannelPromise channelPromise, final boolean z3) {
            if (channelPromise.setUncancellable()) {
