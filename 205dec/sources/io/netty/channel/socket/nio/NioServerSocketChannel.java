 ...
 */
    ...
    protected void doBind(SocketAddress socketAddress) throws Exception {
        if (PlatformDependent.javaVersion() >= 7) {
            mo104javaChannel().bind(socketAddress, this.config.getBacklog());
        } else {
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SocketChannel accept = mo104javaChannel().accept();
        if (accept != null) {
            try {
    ...
    public java.nio.channels.ServerSocketChannel mo104javaChannel() {
        return (java.nio.channels.ServerSocketChannel) super.mo104javaChannel();
    }
    ...
    public NioServerSocketChannel(java.nio.channels.ServerSocketChannel serverSocketChannel) {
        ...
        this.config = new NioServerSocketChannelConfig(this, mo104javaChannel().socket());
    }
}
