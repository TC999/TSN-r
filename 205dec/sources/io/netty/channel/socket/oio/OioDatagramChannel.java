...
public class OioDatagramChannel extends AbstractOioMessageChannel implements DatagramChannel {
    ...
    private static MulticastSocket newSocket() {
        try {
            ...
            throw new ChannelException("failed to create a new socket", e4);
        }
    }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        ...
        try {
            try {
                ...
                if (e4.getMessage().toLowerCase(Locale.US).contains("socket closed")) {
                    heapBuffer.release();
                    return -1;
                }
                throw e4;
    ...
    public OioDatagramChannel(MulticastSocket multicastSocket) {
        ...
        try {
            try {
                ...
                throw new ChannelException("Failed to configure the datagram socket timeout.", e4);
            }
        } catch (Throwable th) {
