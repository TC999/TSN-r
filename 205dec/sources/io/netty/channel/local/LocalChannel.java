 ...
 */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void doPeerClose(LocalChannel localChannel, boolean z3) {
        if (z3) {
    ...
    public void finishPeerRead0(LocalChannel localChannel) {
        ...
        if (future != null) {
            ...
            a.a(FINISH_READ_FUTURE_UPDATER, localChannel, future, null);
        }
