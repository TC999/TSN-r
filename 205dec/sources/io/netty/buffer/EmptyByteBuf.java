...
public final class EmptyByteBuf extends ByteBuf {
    ...
    static {
        ...
        try {
            if (PlatformDependent.hasUnsafe()) {
                j4 = PlatformDependent.directBufferAddress(allocateDirect);
            }
    ...
    private ByteBuf checkIndex(int i4) {
        if (i4 == 0) {
            return this;
        }
    ...
    private ByteBuf checkLength(int i4) {
        if (i4 >= 0) {
            if (i4 == 0) {
                return this;
            }
    ...
    public ByteBuf getBytes(int i4, ByteBuf byteBuf) {
        return checkIndex(i4, byteBuf.writableBytes());
    }
    ...
    private ByteBuf checkIndex(int i4, int i5) {
        if (i5 >= 0) {
            if (i4 == 0 && i5 == 0) {
                return this;
            }
    ...
    public ByteBuf getBytes(int i4, byte[] bArr) {
        return checkIndex(i4, bArr.length);
    }
    ...
    public ByteBuf getBytes(int i4, ByteBuffer byteBuffer) {
        return checkIndex(i4, byteBuffer.remaining());
    }
