...
public final class HttpUtil {
    ...
    private static byte c2b(char c4) {
        if (c4 > '\u00ff') {
            return (byte) 63;
        }
        return (byte) c4;
    ...
    public static void encodeAscii0(CharSequence charSequence, ByteBuf byteBuf) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            byteBuf.writeByte(c2b(charSequence.charAt(i4)));
        }
    }
    ...
    public static void setKeepAlive(HttpMessage httpMessage, boolean z3) {
        setKeepAlive(httpMessage.headers(), httpMessage.protocolVersion(), z3);
    }

    public static void setTransferEncodingChunked(HttpMessage httpMessage, boolean z3) {
        if (z3) {
    ...
    public static void setKeepAlive(HttpHeaders httpHeaders, HttpVersion httpVersion, boolean z3) {
