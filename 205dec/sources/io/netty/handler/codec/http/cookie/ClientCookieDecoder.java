 ...
 */
    ...
    private static class CookieBuilder {
        ...
        private void parse4(int i4, int i5, int i6) {
            if (this.header.regionMatches(true, i4, "Path", 0, 4)) {
                this.path = computeValue(i5, i6);
            }
        }

        private void parse6(int i4, int i5, int i6) {
            if (this.header.regionMatches(true, i4, "Domain", 0, 5)) {
                this.domain = computeValue(i5, i6);
            } else if (this.header.regionMatches(true, i4, "Secure", 0, 5)) {
                this.secure = true;
            }
        }
        ...
        private void parse7(int i4, int i5, int i6) {
            if (this.header.regionMatches(true, i4, "Expires", 0, 7)) {
                ...
                this.expiresEnd = i6;
            } else if (this.header.regionMatches(true, i4, "Max-Age", 0, 7)) {
                setMaxAge(computeValue(i5, i6));
            }
        }

        private void parse8(int i4, int i5, int i6) {
            if (this.header.regionMatches(true, i4, "HTTPOnly", 0, 8)) {
                this.httpOnly = true;
            }
        }
        ...
        public void appendAttribute(int i4, int i5, int i6, int i7) {
            int i8 = i5 - i4;
            if (i8 == 4) {
                parse4(i4, i6, i7);
            } else if (i8 == 6) {
