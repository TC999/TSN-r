 ...
 */
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, String str, int i4) {
        httpMessage.headers().add(str, (Object) Integer.valueOf(i4));
    }
    ...
    static void encode(HttpHeaders httpHeaders, ByteBuf byteBuf) throws Exception {
    ...
    public static void encodeAscii(CharSequence charSequence, ByteBuf byteBuf) {
        if (charSequence instanceof AsciiString) {
            ...
            HttpUtil.encodeAscii0(charSequence, byteBuf);
        }
    }
    ...
    public static void setContentLength(HttpMessage httpMessage, long j4) {
        HttpUtil.setContentLength(httpMessage, j4);
    }
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, String str, int i4) {
        httpMessage.headers().setInt(str, i4);
    }

    @Deprecated
    public static void setKeepAlive(HttpMessage httpMessage, boolean z3) {
        HttpUtil.setKeepAlive(httpMessage, z3);
    }
    ...
    public abstract HttpHeaders addInt(CharSequence charSequence, int i4);

    public abstract HttpHeaders addShort(CharSequence charSequence, short s3);
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z3) {
        ...
        for (String str : all) {
            if (contains(str, charSequence2, z3)) {
                return true;
            }
        }
        return false;
    ...
    public abstract int getInt(CharSequence charSequence, int i4);

    public abstract Integer getInt(CharSequence charSequence);

    public abstract Short getShort(CharSequence charSequence);

    public abstract short getShort(CharSequence charSequence, short s3);

    public abstract long getTimeMillis(CharSequence charSequence, long j4);
    ...
    public abstract HttpHeaders setInt(CharSequence charSequence, int i4);

    public abstract HttpHeaders setShort(CharSequence charSequence, short s3);
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i4) {
        httpMessage.headers().addInt(charSequence, i4);
    }

    @Deprecated
    public static long getContentLength(HttpMessage httpMessage, long j4) {
        return HttpUtil.getContentLength(httpMessage, j4);
    }
    ...
    @Deprecated
    public static void set100ContinueExpected(HttpMessage httpMessage, boolean z3) {
        HttpUtil.set100ContinueExpected(httpMessage, z3);
    }
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i4) {
        httpMessage.headers().setInt(charSequence, i4);
    }
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, String str, int i4) {
        return httpMessage.headers().getInt(str, i4);
    }
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i4) {
        return httpMessage.headers().getInt(charSequence, i4);
    }

    private static boolean contains(String str, CharSequence charSequence, boolean z3) {
    ...
    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z3) {
        return contains(charSequence.toString(), charSequence2.toString(), z3);
    }
}
