 ...
 */
        ...
        private static <T> CharSequence commaSeparate(CsvValueEscaper<T> csvValueEscaper, T... tArr) {
            ...
            if (tArr.length > 0) {
                ...
                for (int i4 = 0; i4 < length; i4++) {
                    sb.append(csvValueEscaper.escape(tArr[i4]));
                    sb.append(',');
                }
    ...
    public CombinedHttpHeaders(boolean z3) {
        super(new CombinedHttpHeadersImpl(AsciiString.CASE_INSENSITIVE_HASHER, DefaultHttpHeaders.valueConverter(z3), DefaultHttpHeaders.nameValidator(z3)));
    }
}
