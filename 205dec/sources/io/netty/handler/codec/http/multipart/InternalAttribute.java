...
final class InternalAttribute extends AbstractReferenceCounted implements InterfaceHttpData {
    ...
    public void setValue(String str, int i4) {
        if (str != null) {
            ByteBuf copiedBuffer = Unpooled.copiedBuffer(str, this.charset);
            ByteBuf byteBuf = this.value.set(i4, copiedBuffer);
            if (byteBuf != null) {
    ...
    public void addValue(String str, int i4) {
        if (str != null) {
            ByteBuf copiedBuffer = Unpooled.copiedBuffer(str, this.charset);
            this.value.add(i4, copiedBuffer);
            this.size += copiedBuffer.readableBytes();
            return;
        }
        throw new NullPointerException("value");
    ...
    @Override // io.netty.util.AbstractReferenceCounted, io.netty.util.ReferenceCounted
    public InterfaceHttpData retain(int i4) {
        for (ByteBuf byteBuf : this.value) {
            byteBuf.retain(i4);
        }
        return this;
