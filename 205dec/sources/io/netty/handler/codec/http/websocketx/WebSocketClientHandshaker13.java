...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i4) {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        HttpHeaders add = headers.add(HttpHeaderNames.UPGRADE, HttpHeaderValues.WEBSOCKET).add(HttpHeaderNames.CONNECTION, HttpHeaderValues.UPGRADE).add(HttpHeaderNames.SEC_WEBSOCKET_KEY, base64);
        AsciiString asciiString = HttpHeaderNames.HOST;
        add.add(asciiString, host + ':' + websocketPort).add(HttpHeaderNames.SEC_WEBSOCKET_ORIGIN, WebSocketClientHandshaker.websocketOriginValue(host, websocketPort));
    ...
    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i4, boolean z4, boolean z5) {
