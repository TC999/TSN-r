...
public class WebSocketServerHandshaker08 extends WebSocketServerHandshaker {
    ...
    public WebSocketServerHandshaker08(String str, String str2, boolean z3, int i4) {
    ...
    public WebSocketServerHandshaker08(String str, String str2, boolean z3, int i4, boolean z4) {
        super(WebSocketVersion.V08, str, str2, i4);
