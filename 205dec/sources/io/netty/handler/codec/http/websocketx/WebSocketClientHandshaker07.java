...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i4) {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i4, boolean z4, boolean z5) {
