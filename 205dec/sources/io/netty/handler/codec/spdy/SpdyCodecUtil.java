...
final class SpdyCodecUtil {
    ...
    public static int getSignedInt(ByteBuf byteBuf, int i4) {
        return (byteBuf.getByte(i4 + 3) & 255) | ((byteBuf.getByte(i4) & 255) << 24) | ((byteBuf.getByte(i4 + 1) & 255) << 16) | ((byteBuf.getByte(i4 + 2) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedInt(ByteBuf byteBuf, int i4) {
        return (byteBuf.getByte(i4 + 3) & 255) | ((byteBuf.getByte(i4) & Byte.MAX_VALUE) << 24) | ((byteBuf.getByte(i4 + 1) & 255) << 16) | ((byteBuf.getByte(i4 + 2) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedMedium(ByteBuf byteBuf, int i4) {
        return (byteBuf.getByte(i4 + 2) & 255) | ((byteBuf.getByte(i4) & 255) << 16) | ((byteBuf.getByte(i4 + 1) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedShort(ByteBuf byteBuf, int i4) {
        return (byteBuf.getByte(i4 + 1) & 255) | ((byteBuf.getByte(i4) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isServerId(int i4) {
        return i4 % 2 == 0;
    }
