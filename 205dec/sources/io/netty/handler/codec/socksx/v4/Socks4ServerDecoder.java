 ...
 */
    ...
    private void fail(List<Object> list, Throwable th) {
        ...
        DefaultSocks4CommandRequest defaultSocks4CommandRequest = new DefaultSocks4CommandRequest(socks4CommandType, str, i4, str2 != null ? str2 : "");
    ...
    */
    public void decode(io.netty.channel.ChannelHandlerContext r5, io.netty.buffer.ByteBuf r6, java.util.List<java.lang.Object> r7) throws java.lang.Exception {
        /*
            r4 = this;
            int[] r5 = io.netty.handler.codec.socksx.v4.Socks4ServerDecoder.AnonymousClass1.$SwitchMap$io$netty$handler$codec$socksx$v4$Socks4ServerDecoder$State     // Catch: java.lang.Exception -> Lb6
            java.lang.Object r0 = r4.state()     // Catch: java.lang.Exception -> Lb6
            io.netty.handler.codec.socksx.v4.Socks4ServerDecoder$State r0 = (io.netty.handler.codec.socksx.v4.Socks4ServerDecoder.State) r0     // Catch: java.lang.Exception -> Lb6
        ...
        L28:
            ...
            io.netty.handler.codec.socksx.v4.Socks4CommandType r5 = io.netty.handler.codec.socksx.v4.Socks4CommandType.valueOf(r5)     // Catch: java.lang.Exception -> Lb6
            ...
            io.netty.handler.codec.socksx.v4.Socks4ServerDecoder$State r5 = io.netty.handler.codec.socksx.v4.Socks4ServerDecoder.State.READ_USERID     // Catch: java.lang.Exception -> Lb6
        ...
        L53:
            ...
            io.netty.handler.codec.socksx.v4.Socks4ServerDecoder$State r5 = io.netty.handler.codec.socksx.v4.Socks4ServerDecoder.State.READ_DOMAIN     // Catch: java.lang.Exception -> Lb6
            r4.checkpoint(r5)     // Catch: java.lang.Exception -> Lb6
        L60:
        ...
        L7c:
            ...
            io.netty.handler.codec.socksx.v4.Socks4ServerDecoder$State r5 = io.netty.handler.codec.socksx.v4.Socks4ServerDecoder.State.SUCCESS     // Catch: java.lang.Exception -> Lb6
            r4.checkpoint(r5)     // Catch: java.lang.Exception -> Lb6
        L91:
            int r5 = r4.actualReadableBytes()     // Catch: java.lang.Exception -> Lb6
            if (r5 <= 0) goto Lba
