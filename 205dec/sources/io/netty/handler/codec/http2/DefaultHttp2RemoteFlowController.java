    ...
    public final class FlowState implements StreamByteDistributor.StreamState {
        ...
        private void decrementFlowControlWindow(int i4) {
            ...
            try {
                ...
                throw new IllegalStateException("Invalid window state when writing frame: " + e4.getMessage(), e4);
            }
        }

        private void decrementPendingBytes(int i4, boolean z3) {
            incrementPendingBytes(-i4, z3);
        }
        ...
        private void incrementPendingBytes(int i4, boolean z3) {
        ...
        */
        ...
        void markedWritability(boolean z3) {
            this.markedWritable = z3;
        }
    ...
    public final class ListenerWritabilityMonitor extends WritabilityMonitor {
        ...
        void stateCancelled(FlowState flowState) {
            try {
                ...
                throw new RuntimeException("Caught unexpected exception from checkAllWritabilityChanged", e4);
            }
        }
        ...
        void windowSize(FlowState flowState, int i4) {
            ...
            try {
                ...
                throw new RuntimeException("Caught unexpected exception from window", e4);
            }
        }
    }
    ...
    public class WritabilityMonitor {
        ...
        private WritabilityMonitor() {
            this.writer = new StreamByteDistributor.Writer() { // from class: io.netty.handler.codec.http2.DefaultHttp2RemoteFlowController.WritabilityMonitor.1
                ...
                public void write(Http2Stream http2Stream, int i4) {
