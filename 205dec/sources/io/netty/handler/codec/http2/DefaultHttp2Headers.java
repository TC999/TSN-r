...
public class DefaultHttp2Headers extends DefaultHeaders<CharSequence, CharSequence, Http2Headers> implements Http2Headers {
    ...
    private static final ByteProcessor HTTP2_NAME_VALIDATOR_PROCESSOR = new ByteProcessor() { // from class: io.netty.handler.codec.http2.DefaultHttp2Headers.1
        ...
        public boolean process(byte b4) throws Exception {
            return !AsciiString.isUpperCase(b4);
        }
    };
    private static final DefaultHeaders.NameValidator<CharSequence> HTTP2_NAME_VALIDATOR = new DefaultHeaders.NameValidator<CharSequence>() { // from class: io.netty.handler.codec.http2.DefaultHttp2Headers.2
        ...
        public void validateName(CharSequence charSequence) {
            ...
            for (int i4 = 0; i4 < charSequence.length(); i4++) {
                if (AsciiString.isUpperCase(charSequence.charAt(i4))) {
                    PlatformDependent.throwException(Http2Exception.connectionError(Http2Error.PROTOCOL_ERROR, "invalid header name [%s]", charSequence));
                }
            }
        }
 ...
 */
    ...
    public final class Http2HeaderEntry extends DefaultHeaders.HeaderEntry<CharSequence, CharSequence> {
        ...
        protected Http2HeaderEntry(int i4, CharSequence charSequence, CharSequence charSequence2, DefaultHeaders.HeaderEntry<CharSequence, CharSequence> headerEntry) {
            super(i4, charSequence);
    ...
    public DefaultHttp2Headers(boolean z3) {
        super(AsciiString.CASE_SENSITIVE_HASHER, CharSequenceValueConverter.INSTANCE, z3 ? HTTP2_NAME_VALIDATOR : DefaultHeaders.NameValidator.NOT_NULL);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // io.netty.handler.codec.DefaultHeaders
    public final DefaultHeaders.HeaderEntry<CharSequence, CharSequence> newHeaderEntry(int i4, CharSequence charSequence, CharSequence charSequence2, DefaultHeaders.HeaderEntry<CharSequence, CharSequence> headerEntry) {
        return new Http2HeaderEntry(i4, charSequence, charSequence2, headerEntry);
    }
    ...
    public DefaultHttp2Headers(boolean z3, int i4) {
        super(AsciiString.CASE_SENSITIVE_HASHER, CharSequenceValueConverter.INSTANCE, z3 ? HTTP2_NAME_VALIDATOR : DefaultHeaders.NameValidator.NOT_NULL, i4);
        this.firstNonPseudo = this.head;
    }
}
