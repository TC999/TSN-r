    ...
    public void channelRead(ChannelHandlerContext channelHandlerContext, Object obj) throws Exception {
        if (obj instanceof FullHttpMessage) {
            ...
            try {
                ...
                boolean z3 = !fullHttpMessage.trailingHeaders().isEmpty();
                this.listener.onHeadersRead(channelHandlerContext, streamId, http2Headers, 0, (isReadable || z3) ? false : true);
                if (isReadable) {
                    this.listener.onDataRead(channelHandlerContext, streamId, fullHttpMessage.content(), 0, !z3);
                }
                if (z3) {
