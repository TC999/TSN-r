...
public abstract class ProxyHandler extends ChannelDuplexHandler {
    ...
    private volatile long connectTimeoutMillis = ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT;
 ...
 */
    ...
    private boolean safeRemoveDecoder() {
        try {
            ...
            logger.warn("Failed to remove proxy decoders:", (Throwable) e4);
            return false;
        }
    }
    ...
    private boolean safeRemoveEncoder() {
        try {
            ...
            logger.warn("Failed to remove proxy encoders:", (Throwable) e4);
            return false;
        }
    }
    ...
    public final void setConnectTimeoutMillis(long j4) {
        if (j4 <= 0) {
            j4 = 0;
        }
