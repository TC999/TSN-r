...
public class Bootstrap extends AbstractBootstrap<Bootstrap, Channel> {
    ...
    */
    ...
    public Bootstrap remoteAddress(String str, int i4) {
    ...
    public Bootstrap mo100clone() {
        return new Bootstrap(this);
    }

    public Bootstrap remoteAddress(InetAddress inetAddress, int i4) {
    ...
    public ChannelFuture connect(String str, int i4) {
        return connect(InetSocketAddress.createUnresolved(str, i4));
    }

    public ChannelFuture connect(InetAddress inetAddress, int i4) {
