...
public class AdScopeThreadFactory implements ThreadFactory {
    ...
    public AdScopeThreadFactory(int i4, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            this.threadName = "adScope-adsdk-background-" + threadNum.getAndIncrement() + "-thread-";
            return;
        }
