...
public class AdComplainInteractionView extends AppCompatTextView implements IInteractionView<InteractionModel> {
    ...
    private ViewGroup totalAdView;

    public AdComplainInteractionView(@NonNull Context context) {
        super(context);
    ...
    private TextView rendTextView(InteractionModel interactionModel, ViewGroup viewGroup, View view, int i4, AdScopeCycleModel adScopeCycleModel) {
        ...
        String title = interactionModel.getTitle();
        if (!TextUtils.isEmpty(title)) {
            this.adTextInteractionView.setText(title);
        } else {
            this.adTextInteractionView.setText(getResources().getString(R.string.adscope_complaint));
        }
    ...
    public void loadAd(InteractionModel interactionModel, ViewGroup viewGroup, View view, int i4, IRenderCallback iRenderCallback, AtomicInteger atomicInteger, AdScopeCycleModel adScopeCycleModel) {
        ...
        this.adTextInteractionView.setOnClickListener(new View.OnClickListener() { // from class: xyz.adscope.ad.control.interaction.view.b
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                AdComplainInteractionView.lambda$loadAd$0(IBaseInteraction.this, view2);
            }
        });
    ...
    public AdComplainInteractionView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
