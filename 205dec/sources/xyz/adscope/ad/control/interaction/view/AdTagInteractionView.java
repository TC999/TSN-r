...
public class AdTagInteractionView extends AppCompatTextView implements IInteractionView<InteractionModel> {
    ...
    public AdTagInteractionView(@NonNull Context context) {
        super(context);
    ...
    public void loadAd(InteractionModel interactionModel, ViewGroup viewGroup, View view, int i4, IRenderCallback iRenderCallback, AtomicInteger atomicInteger, AdScopeCycleModel adScopeCycleModel) {
        ...
        this.adTextInteractionView.setOnClickListener(new View.OnClickListener() { // from class: xyz.adscope.ad.control.interaction.view.g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                AdTagInteractionView.lambda$loadAd$0(IBaseInteraction.this, view2);
            }
        });
    ...
    public AdTagInteractionView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
