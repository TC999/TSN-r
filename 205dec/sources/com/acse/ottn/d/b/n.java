...
class n implements S.a {
    ...
    final /* synthetic */ ShopHelperService f5461a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ String f5462b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public n(ShopHelperService shopHelperService, String str) {
        this.f5461a = shopHelperService;
        this.f5462b = str;
    }
    ...
    public void a(long j4) {
        ...
        try {
            AccessibilityNodeInfo g4 = C1442n.c().g(this.f5461a, this.f5462b);
            if (g4 == null) {
                q.h(this.f5461a);
