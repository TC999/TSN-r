...
public final class AAColumn {
    ...
    @NotNull
    public final AAColumn groupPadding(@Nullable Float f4) {
    ...
    @NotNull
    public final AAColumn pointPadding(@Nullable Float f4) {
        this.pointPadding = f4;
        return this;
    }

    @NotNull
    public final AAColumn pointPlacement(@Nullable Float f4) {
