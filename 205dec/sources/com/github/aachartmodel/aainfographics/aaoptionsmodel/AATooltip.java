...
public final class AATooltip {
    ...
    @NotNull
    public final AATooltip followTouchMove(boolean z3) {
        this.followTouchMove = Boolean.valueOf(z3);
        return this;
    }
    ...
    @NotNull
    public final AATooltip shadow(boolean z3) {
        this.shadow = Boolean.valueOf(z3);
        return this;
    }
