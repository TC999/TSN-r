...
public final class MultipartBody extends RequestBody {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                return create(new Headers.Builder().addUnsafeNonAscii(xyz.adscope.common.network.Headers.KEY_CONTENT_DISPOSITION, sb.toString()).build(), requestBody);
            }
    ...
    private long writeOrCountBytes(@Nullable BufferedSink bufferedSink, boolean z3) throws IOException {
        Buffer buffer;
        if (z3) {
