...
public class JdkWithJettyBootPlatform extends Platform {
            ...
            if (name.equals("unsupported") && Void.TYPE == returnType) {
                ...
                if ((name.equals("selectProtocol") || name.equals("select")) && String.class == returnType && objArr.length == 1 && (objArr[0] instanceof List)) {
                    ...
                    for (int i4 = 0; i4 < size; i4++) {
                        if (this.protocols.contains(list.get(i4))) {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(cls.getMethod("put", SSLSocket.class, cls2), cls.getMethod(f3.f5657f, SSLSocket.class), cls.getMethod("remove", SSLSocket.class), cls3, Class.forName("org.eclipse.jetty.alpn.ALPN$ServerProvider"));
    ...
    public void afterHandshake(SSLSocket sSLSocket) {
        try {
            ...
            throw Util.assertionError("unable to remove alpn", e4);
        }
    }
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) {
        try {
            ...
            throw Util.assertionError("unable to set alpn", e4);
        }
    }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        try {
            ...
            boolean z3 = jettyNegoProvider.unsupported;
            if (!z3 && jettyNegoProvider.selected == null) {
