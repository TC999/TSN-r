...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i4, int i5, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            Platform.get().connectSocket(this.rawSocket, this.route.socketAddress(), i4);
            try {
    ...
    private void connectTunnel(int i4, int i5, int i6, Call call, EventListener eventListener) throws IOException {
    ...
    private Request createTunnel(int i4, int i5, Request request, HttpUrl httpUrl) throws IOException {
        String str = "CONNECT " + Util.hostHeader(httpUrl, true) + " HTTP/1.1";
        while (true) {
            Http1Codec http1Codec = new Http1Codec(null, null, this.source, this.sink);
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            this.source.timeout().timeout(i4, timeUnit);
    ...
    private void establishProtocol(ConnectionSpecSelector connectionSpecSelector, int i4, Call call, EventListener eventListener) throws IOException {
    ...
    private void startHttp2(int i4) throws IOException {
        ...
        Http2Connection build = new Http2Connection.Builder(true).socket(this.socket, this.route.address().url().host(), this.source, this.sink).listener(this).pingIntervalMillis(i4).build();
        this.http2Connection = build;
        build.start();
    }

    public static RealConnection testConnection(ConnectionPool connectionPool, Route route, Socket socket, long j4) {
