...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    void awaitTermination(int i4, TimeUnit timeUnit) throws InterruptedException {
        this.executor.awaitTermination(i4, timeUnit);
    }
    ...
    synchronized boolean close(int i4, String str, long j4) {
    ...
    private synchronized boolean send(ByteString byteString, int i4) {
        if (!this.failed && !this.enqueuedClose) {
