...
public class MBDownloadConfig {
    ...
    public static final class Builder {
        ...
        public final Builder setDefaultConnectTimeout(long j4) {
            this.defaultConnectTimeout = j4;
            return this;
        }

        public final Builder setDefaultPingInterval(long j4) {
            this.defaultPingInterval = j4;
            return this;
        }

        public final Builder setDefaultReadTimeout(long j4) {
            this.defaultReadTimeout = j4;
            return this;
        }

        public final Builder setDefaultWriteTimeout(long j4) {
            this.defaultWriteTimeout = j4;
            return this;
        }
        ...
        public final Builder setMaxRequests(int i4) {
            this.maxRequests = i4;
            return this;
        }

        public final Builder setMaxRequestsPerHost(int i4) {
