        ...
        this.handler.postAtFrontOfQueue(new Runnable() { // from class: com.mbridge.msdk.foundation.download.database.DatabaseHelper.3
            ...
            public void run() {
                ...
                L70:
                    ...
                    com.mbridge.msdk.foundation.tools.x.d(r0, r2)
                L78:
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.download.database.DatabaseHelper.AnonymousClass3.run():void");
            }
        });
    }
    ...
    public Cursor rawQuery(String str, String[] strArr) {
        try {
            ...
            try {
                ...
                x.d(IDatabaseHelper.TAG, th4.getMessage());
            }
            throw th3;
        }
    }
