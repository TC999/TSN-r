...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j4, long j5, int i4, int i5, DownloadResourceType downloadResourceType, int i6) {
        ...
        downloadModel.setDownloadedBytes(j5);
        downloadModel.setTotalBytes(j4);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i5);
        downloadModel.setDownloadRate(i4);
    ...
    public void setDownloadRate(int i4) {
    ...
    public void setDownloadedBytes(long j4) {
    ...
    public void setLastModifiedTime(long j4) {
    ...
    public void setUnZipResourceByte(long j4) {
        this.unZipResourceByte = j4;
    }
    ...
    public void setUsageCounter(int i4) {
        this.usageCounter = i4;
    }

    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j4, long j5, int i4, int i5, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
