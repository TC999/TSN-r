...
public class VideoRequestService extends Service {
    ...
    private volatile VideoBinderListener f39033a = null;

    /* renamed from: b  reason: collision with root package name */
    private volatile VideoBinderInterface f39034b = null;

    @Override // android.app.Service
    public IBinder onBind(Intent intent) {
        if (this.f39034b != null) {
            try {
                return (IBinder) this.f39034b;
    ...
    public void onCreate() {
        super.onCreate();
        this.f39034b = new VideoBinderInterface.Stub() { // from class: com.mbridge.msdk.foundation.aidl.VideoRequestService.1
            ...
            public final void registerListener(VideoBinderListener videoBinderListener) throws RemoteException {
                VideoRequestService.this.f39033a = videoBinderListener;
            }

            @Override // com.mbridge.msdk.foundation.aidl.VideoBinderInterface
            public final void requestVideo(final String[] strArr) throws RemoteException {
                if (VideoRequestService.this.f39033a != null) {
                                ...
                                if (downloadModel != null && downloadModel.getDownloadedBytes() == downloadModel.getTotalBytes() && !arrayList.contains(downloadModel.getDownloadUrl())) {
                                    try {
                                        ...
                                        if (file.isFile() && file.exists()) {
                                            ...
                                            ParcelFileDescriptor dup = ParcelFileDescriptor.dup(a.a(memoryFile));
                                            if (VideoRequestService.this.f39033a != null) {
                                                VideoRequestService.this.f39033a.onVideo(downloadModel.getResourceUrl(), downloadModel.getTotalBytes(), downloadModel.getDownloadId(), downloadModel.getEtag(), downloadModel.getSaveFileName(), dup);
                                            }
                                        }
