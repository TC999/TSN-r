        ...
        public void write(JsonWriter jsonWriter, T t3) throws IOException {
            ...
            try {
                for (BoundField boundField : this.boundFields.values()) {
                    if (boundField.writeField(t3)) {
                        jsonWriter.name(boundField.name);
                        boundField.write(jsonWriter, t3);
                    }
                }
 ...
 */
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z3, boolean z4) {
        ...
        return new BoundField(str, z3, z4) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
            ...
            void write(JsonWriter jsonWriter, Object obj) throws IOException, IllegalAccessException {
                (z5 ? typeAdapter2 : new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter2, typeToken.getType())).write(jsonWriter, field.get(obj));
            }
            ...
            while (i4 < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i5 < size) {
                        ...
                        boolean z4 = i5 != 0 ? false : excludeField;
                        int i6 = i5;
                        BoundField boundField3 = boundField2;
                        int i7 = size;
                        List<String> list = fieldNames;
                        Field field2 = field;
                        boundField2 = boundField3 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(resolve), z4, excludeField2)) : boundField3;
                        i5 = i6 + 1;
                        excludeField = z4;
                        fieldNames = list;
                        size = i7;
    ...
    public boolean excludeField(Field field, boolean z3) {
        return excludeField(field, z3, this.excluder);
    }

    static boolean excludeField(Field field, boolean z3, Excluder excluder) {
