...
final class AlignmentPatternFinder {
    ...
    */
    ...
    private AlignmentPattern handlePossibleCenter(int[] iArr, int i4, int i5) {
        ...
        float centerFromEnd = centerFromEnd(iArr, i5);
        float crossCheckVertical = crossCheckVertical(i4, (int) centerFromEnd, iArr[1] * 2, i6);
        ...
        for (int i8 = 0; i8 < i5; i8++) {
            ...
            while (i10 < i6) {
                if (!this.image.get(i10, i9)) {
                    ...
                    if (foundPatternCross(iArr) && (handlePossibleCenter2 = handlePossibleCenter(iArr, i9, i10)) != null) {
            ...
            if (foundPatternCross(iArr) && (handlePossibleCenter = handlePossibleCenter(iArr, i9, i6)) != null) {
