 ...
 */
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v3, int i4, int i5, float f4) {
    ...
    */
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i4) {
        return setHeaderTopBottomOffset(coordinatorLayout, v3, i4, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i4, int i5, int i6) {
        int clamp;
