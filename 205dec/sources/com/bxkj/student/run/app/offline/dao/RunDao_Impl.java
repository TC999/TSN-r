...
public final class RunDao_Impl implements RunDao {
    ...
    public Object deleteByIdentify(final String identify, final c<? super f1> continuation) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<f1>() { // from class: com.bxkj.student.run.app.offline.dao.RunDao_Impl.7
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object deleteSports(final RunDb runDb, final c<? super f1> continuation) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<f1>() { // from class: com.bxkj.student.run.app.offline.dao.RunDao_Impl.6
            @Override // java.util.concurrent.Callable
            public f1 call() throws Exception {
                RunDao_Impl.this.__db.beginTransaction();
                try {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object getExceptionSports(final String userNumber, final c<? super List<RunDb>> continuation) {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object getLocalRecordById(final String identify, final c<? super List<RunDb>> continuation) {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object getUploadFailSports(final String userNumber, final c<? super List<RunDb>> continuation) {
        final RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM runDb WHERE userNumber = ? AND uploadType !='-1'", 1);
        if (userNumber == null) {
            acquire.bindNull(1);
        } else {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object getUploadFailSportsByType(final String userNumber, final int sportsType, final c<? super List<RunDb>> continuation) {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object insertRun(final RunDb[] runDb, final c<? super f1> continuation) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<f1>() { // from class: com.bxkj.student.run.app.offline.dao.RunDao_Impl.5
            @Override // java.util.concurrent.Callable
            public f1 call() throws Exception {
                RunDao_Impl.this.__db.beginTransaction();
                try {
    ...
    @Override // com.bxkj.student.run.app.offline.dao.RunDao
    public Object updateSports(final String endTime, final String uploadType, final String identify, final c<? super f1> continuation) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<f1>() { // from class: com.bxkj.student.run.app.offline.dao.RunDao_Impl.8
            @Override // java.util.concurrent.Callable
            public f1 call() throws Exception {
