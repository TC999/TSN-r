 ...
 */
    ...
    public Snackbar make() {
        ...
        snackbarLayout.setMinimumWidth(d.a(this.builder.view.getContext(), 600.0f));
        snackbarLayout.setMinimumHeight(d.a(this.builder.view.getContext(), 80.0f));
    ...
    public static Snackbar show(Activity activity, boolean isOK, String message) {
        Snackbar build = builder().setBackgroundColor(ContextCompat.getColor(activity, isOK ? 17170451 : 2131034177)).setTextSize(30.0f).setTextColor(ContextCompat.getColor(activity, 2131034196)).setTextTypefaceStyle(1).setText(message).setMaxLines(4).centerText().setIcon(isOK ? 2131559045 : 2131559043).setActivity(activity).setDuration(0).build();
        build.show();
        return build;
    }
    ...
    public static Snackbar show(Activity activity, boolean isOK, String message, int dismissTime) {
        final Snackbar build = builder().setBackgroundColor(ContextCompat.getColor(activity, isOK ? 17170451 : 2131034177)).setTextSize(30.0f).setTextColor(ContextCompat.getColor(activity, 2131034196)).setTextTypefaceStyle(1).setText(message).setMaxLines(4).centerText().setIcon(isOK ? 2131559045 : 2131559043).setActivity(activity).setDuration(-2).build();
        build.show();
