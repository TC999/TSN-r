...
public class s {
    ...
    public static final int f18419a = 111;

    /* renamed from: b  reason: collision with root package name */
    public static final int f18420b = 222;
 ...
 */
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Activity f18422b;
 ...
 */
    ...
    public static void p(FragmentActivity fragmentActivity, b.a aVar) {
        Intent intent = new Intent();
        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
        intent.setData(Uri.fromParts("package", fragmentActivity.getPackageName(), null));
        new m.b(fragmentActivity).startActivityForResult(intent).startActivityForResult(intent).c(aVar);
    }
}
