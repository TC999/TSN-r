 ...
 */
    ...
    public void writeValue(JSONSerializer jSONSerializer, Object obj) throws Exception {
        ...
        int i4 = fieldInfo.serialzeFeatures;
        if (obj == null) {
            ...
            if (Number.class.isAssignableFrom(cls2)) {
                ...
                objectSerializer3.write(jSONSerializer, null, fieldInfo2.name, fieldInfo2.fieldType, i4);
                return;
            }
        }
        if (fieldInfo.isEnum) {
        ...
        if (fieldInfo3.unwrapped) {
            if (objectSerializer4 instanceof JavaBeanSerializer) {
                ((JavaBeanSerializer) objectSerializer4).write(jSONSerializer, obj, fieldInfo3.name, fieldInfo3.fieldType, i4, true);
                return;
            } else if (objectSerializer4 instanceof MapSerializer) {
                ((MapSerializer) objectSerializer4).write(jSONSerializer, obj, fieldInfo3.name, fieldInfo3.fieldType, i4, true);
                return;
            }
        }
        objectSerializer4.write(jSONSerializer, obj, fieldInfo3.name, fieldInfo3.fieldType, i4);
    }
