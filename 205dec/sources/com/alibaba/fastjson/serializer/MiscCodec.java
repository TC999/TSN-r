            ...
            if (type == URL.class) {
                ...
                if (type == SimpleDateFormat.class) {
                        ...
                        if (name.equals("java.nio.file.Path")) {
                            try {
                                if (method_paths_get == null && !method_paths_get_error) {
                                    method_paths_get = TypeUtils.loadClass("java.nio.file.Paths").getMethod(f3.f5657f, String.class, String[].class);
                                }
                    ...
                    try {
                        ...
                        throw new JSONException("deserialize inet adress error", e7);
                    }
                }
            }
        }
