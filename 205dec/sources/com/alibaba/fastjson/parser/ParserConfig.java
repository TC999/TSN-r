...
public class ParserConfig {
        ...
        if (str.length() < this.maxTypeNameLength) {
                    ...
                    if (i5 >= strArr.length) {
                        ...
                        while (true) {
                            ...
                            if (i6 >= strArr2.length) {
                                break;
                            } else if (replace.startsWith(strArr2[i6]) && TypeUtils.getClassFromMapping(str) == null) {
                                throw new JSONException("autoType is not support. " + str);
                            } else {
                                i6++;
                            }
                        }
                    } else if (replace.startsWith(strArr[i5])) {
            ...
            if (!this.autoTypeSupport) {
                ...
                while (true) {
                    ...
                    if (i7 >= strArr3.length) {
                        while (true) {
                            ...
                            if (i4 >= strArr4.length) {
                                break;
                            } else if (replace.startsWith(strArr4[i4])) {
                    ...
                    } else if (replace.startsWith(strArr3[i7])) {
                        throw new JSONException("autoType is not support. " + str);
                    } else {
                        i7++;
                    }
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> cls, Type type) {
        ...
        if (z3 && (aSMDeserializerFactory = this.asmFactory) != null && aSMDeserializerFactory.classLoader.isExternalClass(cls)) {
            z3 = false;
        }
        if (z3) {
            z3 = ASMUtils.checkName(cls.getSimpleName());
        }
        if (z3) {
            if (cls.isInterface()) {
                z3 = false;
    ...
    public void setAutoTypeSupport(boolean z3) {
        this.autoTypeSupport = z3;
    }
    ...
    public ParserConfig(boolean z3) {
        this(null, null, z3);
    }
    ...
    private ParserConfig(ASMDeserializerFactory aSMDeserializerFactory, ClassLoader classLoader, boolean z3) {
        this.deserializers = new IdentityHashMap<>();
        boolean z4 = ASMUtils.IS_ANDROID;
        this.asmEnable = !z4;
        ...
        this.fieldBased = z3;
        if (aSMDeserializerFactory == null && !z4) {
            try {
                if (classLoader == null) {
