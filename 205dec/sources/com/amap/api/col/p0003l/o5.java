...
/* renamed from: com.amap.api.col.3l.o5  reason: invalid package */
/* loaded from: E:\TSN-r\205dec\7502512.dex */
public final class o5 {

    /* renamed from: a  reason: collision with root package name */
    private static String f8461a = "";

    public static boolean a(Context context) {
        if (context == null) {
            return false;
        }
        if (TextUtils.isEmpty(f8461a)) {
            f8461a = i4.H(context);
        }
        if (TextUtils.isEmpty(f8461a) || !TextUtils.isDigitsOnly(f8461a)) {
            return false;
        }
