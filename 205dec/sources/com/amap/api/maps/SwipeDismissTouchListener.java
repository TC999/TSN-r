 ...
 */
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            ...
            if (r3) {
                this.mView.animate().translationX(z3 ? this.mViewWidth : -this.mViewWidth).alpha(0.0f).setDuration(50L).setListener(new AnimatorListenerAdapter() { // from class: com.amap.api.maps.SwipeDismissTouchListener.1
