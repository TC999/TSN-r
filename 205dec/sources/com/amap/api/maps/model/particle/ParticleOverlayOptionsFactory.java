...
public class ParticleOverlayOptionsFactory {
    ...
    private static List<ParticleOverlayOptions> a() {
        ...
        particleOverlayOptions.setDuration(ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
        ...
        particleOverlayOptions.setParticleLifeTime(ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
        ...
        particleOverlayOptions2.setDuration(ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
        ...
        particleOverlayOptions2.setParticleLifeTime(ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
    ...
    public static List<ParticleOverlayOptions> defaultOptions(int i4) {
        ArrayList arrayList = new ArrayList();
        if (i4 == 0) {
            arrayList.addAll(d());
        } else if (i4 == 1) {
