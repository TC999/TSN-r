 ...
 */
    ...
    public static class a {
        ...
        private static final UMGlobalContext f53516a = new UMGlobalContext();
    ...
    public static Context getAppContext(Context context) {
        if (a.f53516a.mApplicationContext == null && context != null) {
            a.f53516a.mApplicationContext = StubApp.getOrigApplicationContext(context.getApplicationContext());
        }
        return a.f53516a.mApplicationContext;
    }

    public static UMGlobalContext getInstance(Context context) {
        if (a.f53516a.mApplicationContext == null && context != null) {
            a.f53516a.mApplicationContext = context;
        }
        return a.f53516a;
    }
    ...
    public String getProcessName(Context context) {
        if (TextUtils.isEmpty(this.mProcessName)) {
            if (context != null) {
                Context context2 = a.f53516a.mApplicationContext;
                if (context2 != null) {
                ...
                this.mProcessName = UMFrUtils.getCurrentProcessName(a.f53516a.mApplicationContext);
            }
        }
    ...
    public String toString() {
        if (a.f53516a.mApplicationContext != null) {
