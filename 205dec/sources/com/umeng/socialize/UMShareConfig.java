...
public final class UMShareConfig {
    ...
    public UMShareConfig isNeedAuthOnGetUserInfo(boolean z3) {
        this.isNeedAuthOnGetUserInfo = z3;
        return this;
    }

    public UMShareConfig isOpenShareEditActivity(boolean z3) {
        this.isOpenShareEditActivity = z3;
        UMLog.setIsOpenShareEdit(z3);
        return this;
    }
    ...
    public UMShareConfig setFacebookAuthType(int i4) {
        if (i4 == 1 || i4 == 2) {
            this.facebookAuthType = i4;
        }
        return this;
    }

    public UMShareConfig setKaKaoAuthType(int i4) {
        if (i4 == 0 || i4 == 2 || i4 == 1) {
            this.kakaoAuthType = i4;
        }
        return this;
    }

    public UMShareConfig setLinkedInProfileScope(int i4) {
        if (i4 == 0 || i4 == 1) {
            this.linkedInProfileScope = i4;
        }
        return this;
    }

    public void setOpenWXAnalytics(boolean z3) {
        this.isOpenWXAnalytics = z3;
    }

    public UMShareConfig setShareToLinkedInFriendScope(int i4) {
        if (i4 == 0 || i4 == 1) {
            this.linkedInFriendScope = i4;
        }
        return this;
    }

    public UMShareConfig setShareToQQFriendQzoneItemHide(boolean z3) {
        this.isHideQzoneOnQQFriendList = z3;
        return this;
    }
    ...
    public UMShareConfig setSinaAuthType(int i4) {
        if (i4 == 1 || i4 == 2) {
            this.sinaAuthType = i4;
        }
        return this;
    }
