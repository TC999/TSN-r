...
class UMActionFrame extends LinearLayout {
    ...
    private View createShareboardLayout(List<SnsPlatform> list) {
        ...
        if (shareBoardConfig.mShareboardPosition == ShareBoardConfig.SHAREBOARD_POSITION_CENTER && (i4 = shareBoardConfig.mTopMargin) != 0) {
            ...
            ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.umeng.socialize.shareboard.UMActionFrame.2
                ...
                public void onPageSelected(int i5) {
                    ...
                    if (indicatorView != null) {
                        indicatorView.setSelectedPosition(i5);
                    }
                }
            };
    ...
    private SocializeViewPager createSocializeViewPagerInstance() {
        try {
            ...
            SLog.error(UmengText.SHAREBOARD.NULLJAR, e4);
            return null;
        }
    }
    ...
    private void init(List<SnsPlatform> list) {
        ...
        setOrientation(1);
        int i4 = this.mConfig.mShareboardPosition;
        if (i4 == ShareBoardConfig.SHAREBOARD_POSITION_BOTTOM) {
            setGravity(80);
        } else if (i4 == ShareBoardConfig.SHAREBOARD_POSITION_CENTER) {
            setGravity(17);
    ...
    private void settingMenuLayout(View view, int i4) {
        int dip2px = dip2px(20.0f);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, dip2px(i4));
    ...
    @TargetApi(11)
    public UMActionFrame(Context context, AttributeSet attributeSet, int i4) {
    ...
    @TargetApi(21)
    public UMActionFrame(Context context, AttributeSet attributeSet, int i4, int i5) {
