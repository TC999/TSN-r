...
public class QZoneSsoHandler extends UMTencentSSOHandler {
    ...
    public void onActivityResult(int i4, int i5, Intent intent) {
        if (i4 == 10104) {
            Tencent.onActivityResultData(i4, i5, intent, getmShareListener(this.mShareListener));
        }
        if (i4 == 11101) {
            Tencent.onActivityResultData(i4, i5, intent, getAuthlistener(this.mAuthListener));
        }
    }
