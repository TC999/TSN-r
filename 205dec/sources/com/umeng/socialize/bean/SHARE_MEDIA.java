...
public enum SHARE_MEDIA {
    ...
    public static SnsPlatform createSnsPlatform(String str, String str2, String str3, String str4, int i4) {
        SnsPlatform snsPlatform = new SnsPlatform();
        snsPlatform.mShowWord = str;
        snsPlatform.mIcon = str3;
        snsPlatform.mGrayIcon = str4;
        snsPlatform.mIndex = i4;
    ...
    public String getauthstyle(boolean z3) {
        if (toString().equals("QQ")) {
            return "sso";
        }
        if (toString().equals("SINA")) {
            return z3 ? "sso" : "cloudy third";
    ...
    public String getsharestyle(boolean z3) {
        return toString().equals("QQ") ? "sso" : toString().equals("SINA") ? z3 ? "sso" : "cloudy third" : toString().equals("FACEBOOK") ? z3 ? "sso" : "cloudy third" : (toString().equals("RENREN") || toString().equals("DOUBAN") || toString().equals("TENCENT") || toString().equals("TWITTER") || toString().equals("LINKEDIN")) ? "cloudy self" : "sso";
    }
