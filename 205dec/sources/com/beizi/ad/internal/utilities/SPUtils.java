...
public class SPUtils {
    ...
    public static int getInt(Context context, String str, int i4) {
        return context.getSharedPreferences("beizisdk_config", 0).getInt(str, i4);
    }
    ...
    public static String getUpdated(Context context, String str) {
        return context.getSharedPreferences("beizisdk_config", 0).getString(str, String.valueOf(System.currentTimeMillis() / 1000));
    }
    ...
    public static void putInt(Context context, String str, int i4) {
        context.getSharedPreferences("beizisdk_config", 0).edit().putInt(str, i4).commit();
    }
