...
public class MultipartReport extends MimeMultipart {
    ...
    private synchronized void setBodyPart(BodyPart bodyPart, int i4) throws MessagingException {
        if (this.parts == null) {
    ...
    public synchronized DeliveryStatus getDeliveryStatus() throws MessagingException {
        ...
        if (bodyPart.isMimeType("message/delivery-status")) {
            try {
                ...
                throw new MessagingException("IOException getting DeliveryStatus", e4);
            }
        }
        return null;
    }
    ...
    public synchronized MimeMessage getReturnedMessage() throws MessagingException {
        ...
        if (bodyPart.isMimeType("message/rfc822") || bodyPart.isMimeType("text/rfc822-headers")) {
            try {
                ...
                throw new MessagingException("IOException getting ReturnedMessage", e4);
            }
        }
        return null;
    }
        ...
        try {
            ...
            if (bodyPart.isMimeType("multipart/alternative")) {
                ...
                for (int i4 = 0; i4 < multipart.getCount(); i4++) {
                    BodyPart bodyPart2 = multipart.getBodyPart(i4);
            ...
            throw new MessagingException("Exception getting text content", e4);
        }
    }
