...
public class MainMdidSdk implements IIdentifierListener {
    ...
    @Keep
    public MainMdidSdk(boolean z3) {
    }

    private int _InnerFailed(int i4, IdSupplier idSupplier) {
        return ((Integer) Utils.rL(new Object[]{this, Integer.valueOf(i4), idSupplier, 24, 1606976968496L})).intValue();
    }
    ...
    public void OnSupport(boolean z3, IdSupplier idSupplier) {
        Utils.rL(new Object[]{this, Boolean.valueOf(z3), idSupplier, 26, 1606976968498L});
    }
}
