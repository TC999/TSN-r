...
public class AdglAnimation1V extends AbstractAdglAnimation {
    ...
    public void setAnimationValue(float f4, float f5, int i4) {
        if (this.v1Param == null) {
            this.v1Param = new AbstractAdglAnimationParam1V();
        }
        this.v1Param.reset();
        this.v1Param.setInterpolatorType(i4, 1.0f);
        this.v1Param.setFromValue(f4);
        this.v1Param.setToValue(f5);
