...
public interface IAMap {
    void accelerateNetworkInChinese(boolean z3);
    ...
    l3 addContourLineOverlay(eo eoVar);
    ...
    ArrayList<Marker> addMarkers(ArrayList<MarkerOptions> arrayList, boolean z3) throws RemoteException;
    ...
    void animateCameraWithDurationAndCallback(CameraUpdate cameraUpdate, long j4, AMap.CancelableCallback cancelableCallback) throws RemoteException;

    Pair<Float, LatLng> calculateZoomToSpanLevel(int i4, int i5, int i6, int i7, LatLng latLng, LatLng latLng2);

    boolean canStopMapRender();

    void changeSurface(GL10 gl10, int i4, int i5);

    void checkMapState(IGLMapState iGLMapState);

    void clear() throws RemoteException;

    void clear(boolean z3) throws RemoteException;

    long createGLOverlay(int i4);

    void createSurface(GL10 gl10, EGLConfig eGLConfig);

    void destroy();

    void destroySurface(int i4);
    ...
    void getMapScreenShot(AMap.OnMapScreenShotListener onMapScreenShotListener, boolean z3);
    ...
    void set3DBuildingEnabled(boolean z3) throws RemoteException;

    void setAMapGestureListener(AMapGestureListener aMapGestureListener);

    void setCenterToPixel(int i4, int i5) throws RemoteException;

    void setConstructingRoadEnable(boolean z3) throws RemoteException;
    ...
    void setIndoorEnabled(boolean z3) throws RemoteException;
    ...
    void setLoadOfflineData(boolean z3) throws RemoteException;

    void setLocationSource(LocationSource locationSource) throws RemoteException;

    void setMapCustomEnable(boolean z3);

    void setMapLanguage(String str);

    void setMapStatusLimits(LatLngBounds latLngBounds);

    void setMapTextEnable(boolean z3) throws RemoteException;

    void setMapTextZIndex(int i4) throws RemoteException;

    void setMapType(int i4) throws RemoteException;

    void setMaskLayerParams(int i4, int i5, int i6, int i7, int i8, long j4);
    ...
    void setMyLocationRotateAngle(float f4) throws RemoteException;

    void setMyLocationStyle(MyLocationStyle myLocationStyle) throws RemoteException;

    void setMyLocationType(int i4) throws RemoteException;

    void setNaviLabelEnable(boolean z3, int i4, int i5) throws RemoteException;
    ...
    void setRenderFps(int i4);

    void setRenderMode(int i4);

    void setRoadArrowEnable(boolean z3) throws RemoteException;

    void setRunLowFrame(boolean z3);

    void setTouchPoiEnable(boolean z3);
    ...
    void setVisibilityEx(int i4);

    void setWorldVectorMapStyle(String str);

    void setZOrderOnTop(boolean z3) throws RemoteException;

    void setZoomScaleParam(float f4);

    void showHideBuildings(int i4);
