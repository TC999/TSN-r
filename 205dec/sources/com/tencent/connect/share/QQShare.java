...
public class QQShare extends BaseApi {
    ...
    public void d(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        String openIdWithCache = this.f51502c.getOpenIdWithCache();
        ...
        if (stringArrayList != null && stringArrayList.size() >= 2) {
            ...
            if (i4 == 7 && !TextUtils.isEmpty(str3) && k.c(activity, "8.3.3") < 0) {
                str3 = null;
                SLog.e("openSDK_LOG.QQShare", "doShareToQQ() share to mini program set file uri empty");
            }
            Uri a5 = m.a(activity, appId, str3);
            if (a5 != null) {
                stringBuffer.append("&file_uri=");
                stringBuffer.append(Base64.encodeToString(m.j(a5.toString()), 2));
            }
        ...
        stringBuffer.append("&req_type=" + Base64.encodeToString(m.j(String.valueOf(i4)), 2));
        ...
        stringBuffer.append("&cflag=" + Base64.encodeToString(m.j(String.valueOf(i5)), 2));
        boolean c4 = m.c();
        stringBuffer.append("&third_sd=" + Base64.encodeToString(m.j(String.valueOf(c4)), 2));
        SLog.v("openSDK_LOG.QQShare", "doShareToQQ -- url: " + stringBuffer.toString());
        com.tencent.connect.a.a.a(g.a(), this.f51502c, "requireApi", "shareToNativeQQ");
        Intent intent = new Intent("android.intent.action.VIEW");
        intent.setData(Uri.parse(stringBuffer.toString()));
        intent.putExtra(Constants.KEY_PASS_REPORT_VIA_PARAM, m.a(this.f51502c.getOpenId(), i5 == 1 ? "11" : "10", "3", "ANDROIDQQ.SHARETOQQ.XX", this.f51502c.getAppId(), this.mViaShareQQType, "", "", "0", "1", "0"));
        ...
        if (!TextUtils.isEmpty(string)) {
            if (m.h(string)) {
                    ...
                    new c(activity).a(string, new d() { // from class: com.tencent.connect.share.QQShare.1
                        ...
                        public void a(int i4, String str) {
                            if (i4 == 0) {
                                ...
                                e.a().a(1, "SHARE_CHECK_SDK", "1000", ((BaseApi) QQShare.this).f51502c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "\u83b7\u53d6\u5206\u4eab\u56fe\u7247\u5931\u8d25!");
                                return;
                            }
                ...
                if (m.f(activity, "4.3.0")) {
                    ...
                    boolean m4 = m.m(string);
                    boolean c4 = m.c();
                    SLog.d("openSDK_LOG.QQShare", "shareToMobileQQ -- QQ Version is > 4.3.0:isAppSpecificDir=" + m4 + ",hasSDPermission:" + c4);
