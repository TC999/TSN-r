...
public class FaceSDKManager {
    ...
    public byte[] compressImage(Bitmap bitmap, int i4) {
        return BitmapUtils.bitmapCompress(bitmap, i4);
    }

    public BDFaceImageInstance cropFace(BDFaceImageInstance bDFaceImageInstance, float[] fArr, int i4, int i5) {
    ...
    public Bitmap scaleImage(Bitmap bitmap, int i4, int i5) {
        return BitmapUtils.scale(bitmap, i4, i5);
    }
    ...
    public Bitmap scaleImage(Bitmap bitmap, float f4) {
        return BitmapUtils.scale(bitmap, f4);
    }
}
