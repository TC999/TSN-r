...
public final class FileUtils {
    ...
    public static boolean ensureMkdir(File file) {
        ...
        while (file2.exists()) {
            ...
            file2 = new File(parent, file.getName() + "(" + i4 + ")");
            i4++;
        }
        return file2.mkdir();
    }
    ...
    public static void writeToFile(File file, String str, boolean z3) {
        writeToFile(file, str, z3, "utf-8");
    }
    ...
    public static void writeToFile(File file, String str, boolean z3, String str2) {
        ...
        try {
            try {
                OutputStreamWriter outputStreamWriter2 = new OutputStreamWriter(new FileOutputStream(file, z3), str2);
                try {
    ...
    public static void deleteDir(File file, boolean z3, FileFilter fileFilter) {
        if (file == null || !file.isDirectory()) {
            return;
        }
    ...
    public static void deleteDir(File file, boolean z3, FilenameFilter filenameFilter) {
        if (file == null || !file.isDirectory()) {
            return;
        }
        ...
        if (listFiles != null) {
            for (File file2 : listFiles) {
                if (file2.isDirectory()) {
                    deleteDir(file2, z3, filenameFilter);
                } else {
                    file2.delete();
                }
            }
