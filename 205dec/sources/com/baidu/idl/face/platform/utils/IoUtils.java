 ...
 */
    ...
    public static void copyStream(InputStream inputStream, File file, long j4, ProgressListener progressListener) throws IOException {
        FileOutputStream fileOutputStream;
        try {
            fileOutputStream = FileUtils.openNewFileOutput(file);
        } catch (Throwable th) {
        ...
        try {
            copyStream(inputStream, fileOutputStream, j4, progressListener);
            closeQuietly(fileOutputStream);
        } catch (Throwable th2) {
            th = th2;
            closeQuietly(fileOutputStream);
    ...
    public static void copyStream(InputStream inputStream, OutputStream outputStream, long j4, ProgressListener progressListener) throws IOException {
        byte[] bArr = new byte[1024];
        long j5 = 0;
        while (true) {
            int read = inputStream.read(bArr);
            ...
            if (progressListener != null) {
                progressListener.progress(j5, j4);
            }
        }
    }
}
