...
public class SecRequest {
    ...
    */
    ...
    public static void sendMessage(final Context context, final String str, final int i4) {
        new Thread(new Runnable() { // from class: com.baidu.idl.face.platform.ui.utils.SecRequest.1
            ...
            public void run() {
                try {
                    ...
                    SecRequest.requestPost(jSONObject.toString(), "http://10.138.32.176:8518/api/v3/person/verify_sec?appid=7758258");
                } catch (Exception e4) {
                    e4.printStackTrace();
                }
            }
