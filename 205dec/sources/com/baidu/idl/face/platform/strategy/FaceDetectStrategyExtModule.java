...
public class FaceDetectStrategyExtModule implements IDetectStrategy {
    ...
    private boolean cropStrategy(BDFaceImageInstance bDFaceImageInstance, FaceExtInfo faceExtInfo, int i4) {
    ...
    private void processUIResult(FaceModel faceModel, BDFaceImageInstance bDFaceImageInstance) {
        ...
        if (faceModel != null && faceModel.getFaceInfos() != null && faceModel.getFaceInfos().length > 0) {
            ...
            LogHelper.addLogWithKey("ftm", Long.valueOf(System.currentTimeMillis()));
        } else {
    ...
    private void saveCropImageInstance(FaceExtInfo faceExtInfo, BDFaceImageInstance bDFaceImageInstance, int i4, float f4) {
        ...
        hashMap.put("bestCropDetectImage_" + i4 + "_" + f4, detectBestCropImageList.get(0));
    }
    ...
    private void saveSrcImageInstance(FaceExtInfo faceExtInfo, BDFaceImageInstance bDFaceImageInstance, int i4, float f4) {
        ...
        hashMap.put("bestSrcDetectImage_" + i4 + "_" + f4, detectBestSrcImageList.get(0));
    }
    ...
    @Override // com.baidu.idl.face.platform.IDetectStrategy
    public void setDetectStrategySoundEnable(boolean z3) {
