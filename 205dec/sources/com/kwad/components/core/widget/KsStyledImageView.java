...
public class KsStyledImageView extends ImageView implements d {
    ...
    public KsStyledImageView(Context context, @Nullable AttributeSet attributeSet, int i4) {
        super(context, attributeSet, i4);
    }

    @RequiresApi(api = 21)
    public KsStyledImageView(Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
