...
public class KsStyledLinearLayout extends LinearLayout implements d {
    ...
    public KsStyledLinearLayout(Context context, @Nullable AttributeSet attributeSet, int i4) {
        super(context, attributeSet, i4);
    }

    @RequiresApi(api = 21)
    public KsStyledLinearLayout(Context context, AttributeSet attributeSet, int i4, int i5) {
