 ...
 */
        ...
        public final Drawable getImageForEmptyUri() {
            ...
            return i4 != 0 ? this.resources.getDrawable(i4) : this.imageForEmptyUri;
        }

        public final Drawable getImageOnFail() {
            int i4 = this.imageResOnFail;
            return i4 != 0 ? this.resources.getDrawable(i4) : this.imageOnFail;
        }

        public final Drawable getImageOnLoading() {
            int i4 = this.imageResOnLoading;
            return i4 != 0 ? this.resources.getDrawable(i4) : this.imageOnLoading;
        }
