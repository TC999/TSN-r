...
public class ImageLoadImpl implements IImageLoader {
    ...
    public void checkInit() {
        ...
        builder.taskExecutor(GlobalThreadPools.FC());
        builder.taskExecutorForCachedImages(GlobalThreadPools.FD());
        builder.setTaskDistributor(GlobalThreadPools.FE());
    ...
    @Override // com.kwad.sdk.service.a.i
    public void load(@NonNull Context context, ImageView imageView, Object obj, int i4, int i5) {
        checkInit();
        ImageLoader.getInstance().displayImage(parseModel(obj), imageView, new DisplayImageOptions.Builder().bitmapConfig(Bitmap.Config.ARGB_8888).cacheOnDisk(true).cacheInMemory(true).showImageOnLoading(i5).showImageForEmptyUri(i4).showImageOnFail(i4).build());
    }
    ...
    @Override // com.kwad.sdk.service.a.i
    public void load(@NonNull KsFragment ksFragment, @NonNull String str, @NonNull ImageView imageView, @NonNull Drawable drawable, @NonNull Drawable drawable2, float f4) {
        checkInit();
        ImageLoader.getInstance().displayImage(str, imageView, new DisplayImageOptions.Builder().bitmapConfig(Bitmap.Config.ARGB_8888).cacheOnDisk(true).cacheInMemory(true).showImageOnLoading(drawable).showImageOnFail(drawable2).displayer(new RoundedBitmapDisplayer(a.a(imageView.getContext(), f4))).build());
    }
