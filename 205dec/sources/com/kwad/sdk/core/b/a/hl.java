...
public final class hl implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.PatchEcInfo> {
    ...
    private static JSONObject b2(AdStyleInfo.PlayDetailInfo.PatchEcInfo patchEcInfo, JSONObject jSONObject) {
        ...
        int i4 = patchEcInfo.platformTypeCode;
        if (i4 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "platformTypeCode", i4);
        }
        return jSONObject;
    }
}
