...
public final class dd implements com.kwad.sdk.core.d<AdInfo.DownloadSafeInfo> {
    ...
    private static JSONObject b2(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        boolean z3 = downloadSafeInfo.secWindowPopNoWifiSwitch;
        if (z3) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "secWindowPopNoWifiSwitch", z3);
        }
        boolean z4 = downloadSafeInfo.secWindowPopSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "secWindowPopSwitch", z4);
        }
