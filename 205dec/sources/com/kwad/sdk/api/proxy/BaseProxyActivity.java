...
public abstract class BaseProxyActivity extends Activity {
    ...
    protected void onActivityResult(int i4, int i5, Intent intent) {
        ...
        this.mDelegate.onActivityResult(i4, i5, intent);
    }
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i4, boolean z3) {
        ...
        this.mDelegate.onApplyThemeResource(theme, i4, z3);
    }
    ...
    public boolean onKeyDown(int i4, KeyEvent keyEvent) {
        return this.mDelegate.onKeyDown(i4, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyLongPress(int i4, KeyEvent keyEvent) {
        return this.mDelegate.onKeyLongPress(i4, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyUp(int i4, KeyEvent keyEvent) {
        return this.mDelegate.onKeyUp(i4, keyEvent);
    }
    ...
    protected void onTitleChanged(CharSequence charSequence, int i4) {
        ...
        this.mDelegate.onTitleChanged(charSequence, i4);
    }
    ...
    public boolean superOnKeyDown(int i4, KeyEvent keyEvent) {
        return super.onKeyDown(i4, keyEvent);
    }

    public boolean superOnKeyLongPress(int i4, KeyEvent keyEvent) {
        return super.onKeyLongPress(i4, keyEvent);
    }

    public boolean superOnKeyUp(int i4, KeyEvent keyEvent) {
