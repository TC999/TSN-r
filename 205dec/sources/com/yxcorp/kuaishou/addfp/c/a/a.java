...
public final class a {
    ...
    */
    ...
    public static String a(int i4, String str) {
        ...
        String str4 = split[2];
        if (i4 == 0) {
            a4 = com.yxcorp.kuaishou.addfp.android.b.a.a(paramContext, split[0], str);
            if (TextUtils.isEmpty(a4)) {
                a4 = Settings.System.getString(paramContext.getContentResolver(), str);
            }
        } else if (i4 == 1) {
            a4 = com.yxcorp.kuaishou.addfp.android.b.a.a(paramContext, split[1], str);
            if (TextUtils.isEmpty(a4)) {
                a4 = Settings.Secure.getString(paramContext.getContentResolver(), str);
            }
        } else if (i4 == 2) {
            a4 = com.yxcorp.kuaishou.addfp.android.b.a.a(paramContext, split[2], str);
            if (TextUtils.isEmpty(a4)) {
                a4 = Settings.Global.getString(paramContext.getContentResolver(), str);
            }
        } else {
            a4 = "";
        }
