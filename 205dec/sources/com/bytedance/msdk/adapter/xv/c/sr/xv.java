...
public class xv extends com.bytedance.msdk.api.sr.c.w.ev.w implements Bridge {

    /* renamed from: w  reason: collision with root package name */
    private com.bytedance.msdk.api.sr.c.w.w.w f27253w;
    private Bridge xv;

    public xv(com.bytedance.msdk.api.sr.c.w.w.w wVar, Bridge bridge) {
        this.f27253w = wVar;
        this.xv = bridge;
        if (bridge != null) {
            b a4 = b.a();
    ...
    private boolean ng() {
        com.bytedance.msdk.api.sr.c.w.w.w wVar = this.f27253w;
    ...
    private void xu() {
        c(new r() { // from class: com.bytedance.msdk.adapter.xv.c.sr.xv.1
            @Override // com.bytedance.msdk.api.sr.c.w.ev.r
            public ev c(Activity activity) {
                if (xv.this.xv != null) {
                    b a4 = b.a();
                    a4.h(20033, activity);
                    Bridge bridge = (Bridge) xv.this.xv.call(6072, a4.l(), Bridge.class);
                    if (bridge != null) {
                        final f fVar = new f(bridge);
                        return new ev() { // from class: com.bytedance.msdk.adapter.xv.c.sr.xv.1.1
            ...
            public void c(String str, Map<String, Object> map) {
                if (xv.this.xv != null) {
                    ...
                    a4.i(8036, str);
                    a4.h(8075, map);
                    xv.this.xv.call(8194, a4.l(), Void.class);
                }
            }
        });
    }
    ...
    public <T> T call(int i4, ValueSet valueSet, Class<T> cls) {
        if (i4 == 8134) {
            ...
            long longValue2 = valueSet.longValue(8063);
            valueSet.intValue(8064);
            valueSet.intValue(8065);
            c(longValue, longValue2, "", "");
        } else if (i4 == 8158) {
            w(valueSet.longValue(8062), valueSet.longValue(8063), valueSet.stringValue(8066), valueSet.stringValue(8056));
        } else if (i4 == 8157) {
            xv(valueSet.longValue(8062), valueSet.longValue(8063), valueSet.stringValue(8066), valueSet.stringValue(8056));
        } else if (i4 == 8155) {
            c(valueSet.longValue(8062), valueSet.stringValue(8066), valueSet.stringValue(8056));
        } else if (i4 == 8156) {
            c(valueSet.stringValue(8066), valueSet.stringValue(8056));
        } else if (i4 == 8185) {
            gb();
        } else if (i4 == 8184) {
            au();
    ...
    @Override // com.bytedance.msdk.api.sr.c.w.ev.w
    ...
    @Override // com.bytedance.msdk.api.sr.c.w.ev.w, com.bytedance.msdk.api.sr.c.w.ev.c
    public View w() {
        Bridge bridge = this.xv;
        if (bridge != null) {
    ...
    @Override // com.bytedance.msdk.api.sr.c.w.ev.w
    public void c(ViewGroup viewGroup, List<View> list, List<View> list2, k kVar) {
        super.c(viewGroup, list, list2, kVar);
        c(getActivity(), viewGroup, list, list2, a(), kVar);
    }
