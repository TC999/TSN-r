...
public class j extends k<Integer, Integer> {
    public j(List<n.h<Integer>> list) {
        super(list);
    }

    @Override // com.bytedance.adsdk.lottie.xv.c.b
    public com.bytedance.adsdk.lottie.c.w.c<Integer, Integer> c() {
        return new com.bytedance.adsdk.lottie.c.w.e(this.f25774a);
    }
