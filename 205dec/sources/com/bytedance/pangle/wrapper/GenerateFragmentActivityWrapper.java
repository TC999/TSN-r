...
public abstract class GenerateFragmentActivityWrapper extends FragmentActivity implements a {
    ...
    public PendingIntent createPendingResult(int i4, Intent intent, int i5) {
        return this.mOriginActivity.createPendingResult(i4, intent, i5);
    }
    ...
    public View findViewById(int i4) {
        return this.mOriginActivity.findViewById(i4);
    }
    ...
    public void finishActivity(int i4) {
        this.mOriginActivity.finishActivity(i4);
    }

    @Override // android.app.Activity
    public void finishActivityFromChild(Activity activity, int i4) {
        this.mOriginActivity.finishActivityFromChild(activity, i4);
    }
    ...
    public SharedPreferences getPreferences(int i4) {
        return this.mOriginActivity.getPreferences(i4);
    }
    ...
    public boolean moveTaskToBack(boolean z3) {
        return this.mOriginActivity.moveTaskToBack(z3);
    }
    ...
    public void onActivityReenter(int i4, Intent intent) {
        this.mOriginActivity.onActivityReenter(i4, intent);
    }
    ...
    public boolean onCreatePanelMenu(int i4, Menu menu) {
        return this.mOriginActivity.onCreatePanelMenu(i4, menu);
    }

    @Override // android.app.Activity, android.view.Window.Callback
    public View onCreatePanelView(int i4) {
        return this.mOriginActivity.onCreatePanelView(i4);
    }
    ...
    public boolean onKeyDown(int i4, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyDown(i4, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyLongPress(int i4, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyLongPress(i4, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyMultiple(int i4, int i5, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyMultiple(i4, i5, keyEvent);
    }

    @Override // android.app.Activity
    public boolean onKeyShortcut(int i4, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyShortcut(i4, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyUp(int i4, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyUp(i4, keyEvent);
    }
    ...
    public boolean onMenuItemSelected(int i4, MenuItem menuItem) {
        return this.mOriginActivity.onMenuItemSelected(i4, menuItem);
    }

    @Override // android.app.Activity, android.view.Window.Callback
    public boolean onMenuOpened(int i4, Menu menu) {
        return this.mOriginActivity.onMenuOpened(i4, menu);
    }

    @Override // android.app.Activity
    public void onMultiWindowModeChanged(boolean z3, Configuration configuration) {
        this.mOriginActivity.onMultiWindowModeChanged(z3, configuration);
    }
    ...
    public void onPanelClosed(int i4, Menu menu) {
        this.mOriginActivity.onPanelClosed(i4, menu);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z3, Configuration configuration) {
        this.mOriginActivity.onPictureInPictureModeChanged(z3, configuration);
    }
    ...
    public boolean onPreparePanel(int i4, View view, Menu menu) {
        return this.mOriginActivity.onPreparePanel(i4, view, menu);
    }
    ...
    public void onProvideKeyboardShortcuts(List list, Menu menu, int i4) {
        this.mOriginActivity.onProvideKeyboardShortcuts(list, menu, i4);
    }
    ...
    public void onRequestPermissionsResult(int i4, String[] strArr, int[] iArr) {
        ...
        this.mOriginActivity.onRequestPermissionsResult(i4, strArr, iArr);
    }
    ...
    public void onTopResumedActivityChanged(boolean z3) {
        this.mOriginActivity.onTopResumedActivityChanged(z3);
    }
    ...
    public void onTrimMemory(int i4) {
        this.mOriginActivity.onTrimMemory(i4);
    }
    ...
    public void onWindowFocusChanged(boolean z3) {
        this.mOriginActivity.onWindowFocusChanged(z3);
    }
    ...
    public void overridePendingTransition(int i4, int i5) {
        this.mOriginActivity.overridePendingTransition(i4, i5);
    }
    ...
    public boolean requestVisibleBehind(boolean z3) {
        return this.mOriginActivity.requestVisibleBehind(z3);
    }
    ...
    public void setContentView(int i4) {
        this.mOriginActivity.setContentView(i4);
    }
    ...
    public void setFinishOnTouchOutside(boolean z3) {
        this.mOriginActivity.setFinishOnTouchOutside(z3);
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z3) {
        this.mOriginActivity.setImmersive(z3);
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z3) {
        this.mOriginActivity.setInheritShowWhenLocked(z3);
    }
    ...
    public void setRequestedOrientation(int i4) {
        this.mOriginActivity.setRequestedOrientation(i4);
    }

    @Override // android.app.Activity
    public void setShowWhenLocked(boolean z3) {
        this.mOriginActivity.setShowWhenLocked(z3);
    }
    ...
    public void setTheme(int i4) {
        this.mOriginActivity.setTheme(i4);
    }
    ...
    public void setTitleColor(int i4) {
        this.mOriginActivity.setTitleColor(i4);
    }

    @Override // android.app.Activity
    public boolean setTranslucent(boolean z3) {
        return this.mOriginActivity.setTranslucent(z3);
    }

    @Override // android.app.Activity
    public void setTurnScreenOn(boolean z3) {
        this.mOriginActivity.setTurnScreenOn(z3);
    }

    @Override // android.app.Activity
    public void setVisible(boolean z3) {
        this.mOriginActivity.setVisible(z3);
    }

    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z3, ComponentName componentName) {
        this.mOriginActivity.setVrModeEnabled(z3, componentName);
    }

    @Override // com.bytedance.pangle.wrapper.a
    public void setWrapperActivityTheme(int i4) {
        try {
            super.setTheme(i4);
    ...
    public void startActivityForResult(Intent intent, int i4) {
        this.mOriginActivity.startActivityForResult(intent, i4);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i4) {
        this.mOriginActivity.startActivityFromChild(activity, intent, i4);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i4) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i4);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i4) {
        return this.mOriginActivity.startActivityIfNeeded(intent, i4);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i4, int i5, int i6) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i4, i5, i6);
    }

    @Override // androidx.fragment.app.FragmentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i4, Intent intent, int i5, int i6, int i7) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i4, intent, i5, i6, i7);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i4, Intent intent, int i5, int i6, int i7) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i4, intent, i5, i6, i7);
    }

    @Override // androidx.fragment.app.FragmentActivity
    public void startIntentSenderFromFragment(androidx.fragment.app.Fragment fragment, IntentSender intentSender, int i4, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromFragment(fragment, intentSender, i4, intent, i5, i6, i7, bundle);
    }
    ...
    public void startSearch(String str, boolean z3, Bundle bundle, boolean z4) {
        this.mOriginActivity.startSearch(str, z3, bundle, z4);
    }
    ...
    public void takeKeyEvents(boolean z3) {
        this.mOriginActivity.takeKeyEvents(z3);
    }
    ...
    public void onMultiWindowModeChanged(boolean z3) {
        this.mOriginActivity.onMultiWindowModeChanged(z3);
    }

    @Override // androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onPictureInPictureModeChanged(boolean z3) {
        this.mOriginActivity.onPictureInPictureModeChanged(z3);
    }
    ...
    public ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i4) {
        return this.mOriginActivity.onWindowStartingActionMode(callback, i4);
    }
    ...
    public void setTitle(int i4) {
        this.mOriginActivity.setTitle(i4);
    }

    @Override // android.app.Activity
    public ActionMode startActionMode(ActionMode.Callback callback, int i4) {
        return this.mOriginActivity.startActionMode(callback, i4);
    }
    ...
    public void startActivityForResult(Intent intent, int i4, Bundle bundle) {
        this.mOriginActivity.startActivityForResult(intent, i4, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i4, Bundle bundle) {
        this.mOriginActivity.startActivityFromChild(activity, intent, i4, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i4, Bundle bundle) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i4, bundle);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i4, Bundle bundle) {
        return this.mOriginActivity.startActivityIfNeeded(intent, i4, bundle);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i4, i5, i6, bundle);
    }

    @Override // androidx.fragment.app.FragmentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i4, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i4, intent, i5, i6, i7, bundle);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i4, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i4, intent, i5, i6, i7, bundle);
    }
    ...
    @Override // androidx.fragment.app.FragmentActivity
    public void startActivityFromFragment(androidx.fragment.app.Fragment fragment, Intent intent, int i4) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i4);
    }

    @Override // androidx.fragment.app.FragmentActivity
    public void startActivityFromFragment(androidx.fragment.app.Fragment fragment, Intent intent, int i4, Bundle bundle) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i4, bundle);
    }
}
