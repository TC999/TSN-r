...
public class ZeusProviderTransform {
    ...
    public static void registerContentObserver(Object obj, Uri uri, boolean z3, ContentObserver contentObserver, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).registerContentObserver(a.a(uri, str), z3, contentObserver);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "registerContentObserver", new Object[]{uri, Boolean.valueOf(z3), contentObserver}, new Class[]{Uri.class, Boolean.TYPE, ContentObserver.class});
        } catch (Exception e4) {
            throw new RuntimeException(e4);
        }
    }
    ...
    @RequiresApi(api = 24)
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, int i4, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(a.a(uri, str), contentObserver, i4);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{uri, contentObserver, Integer.valueOf(i4)}, new Class[]{Uri.class, ContentObserver.class, Integer.TYPE});
        } catch (Exception e4) {
            throw new RuntimeException(e4);
        }
    }
    ...
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, boolean z3, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(a.a(uri, str), contentObserver, z3);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{uri, contentObserver, Boolean.valueOf(z3)}, new Class[]{Uri.class, ContentObserver.class, Boolean.TYPE});
        } catch (Exception e4) {
            throw new RuntimeException(e4);
        }
    }
    ...
    @RequiresApi(api = 30)
    public static void notifyChange(Object obj, Collection<Uri> collection, ContentObserver contentObserver, int i4, String str) {
        if (obj instanceof ContentResolver) {
            ArrayList arrayList = new ArrayList();
            for (Uri uri : collection) {
                arrayList.add(a.a(uri, str));
            }
            ((ContentResolver) obj).notifyChange(arrayList, contentObserver, i4);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{collection, contentObserver, Integer.valueOf(i4)}, new Class[]{Collection.class, ContentObserver.class, Integer.TYPE});
        } catch (Exception e4) {
            throw new RuntimeException(e4);
        }
    }
