...
public class ContentProviderProxy extends ContentProvider {
    ...
    public Bundle call(@NonNull String str, @Nullable String str2, @Nullable Bundle bundle) {
        ...
        try {
            ...
            Uri parse = Uri.parse(bundle.getString("provider_proxy_uri", ""));
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#call(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
            return null;
        }
    }
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#delete(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return -1;
    }
    ...
    public String getType(@NonNull Uri uri) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#getType className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#insert(2 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#query(5 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String str, @Nullable String[] strArr) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#update(4 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return 0;
    }
    ...
    private PluginContentProvider obtainPluginProvider(Uri uri, String str, String str2) {
        ...
        if (str2 == null) {
            ZeusLogger.w("Zeus/provider_pangle", "[Method:obtainPluginProvider()] plugin Authority is null !!! plugin provider can not find !!");
        }
    ...
    public int delete(@NonNull Uri uri, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#delete(2 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return -1;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#insert(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2, @Nullable CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#query(6 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable Bundle bundle) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#update(3 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return 0;
    }
    ...
    public Bundle call(@NonNull String str, @NonNull String str2, @Nullable String str3, @Nullable Bundle bundle) {
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#call(4 params-Added in API level 29) className=" + getClass().getSimpleName() + ",exception:", th);
            return null;
        }
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable Bundle bundle, @Nullable CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            ZeusLogger.w("Zeus/provider_pangle", "proxy provider#query(4 params) className=" + getClass().getSimpleName() + ",exception:", th);
        }
        return null;
    }
}
