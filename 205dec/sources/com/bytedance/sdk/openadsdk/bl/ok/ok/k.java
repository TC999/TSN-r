...
public class k implements TTDrawFeedAd {
    ...
    public void setCanInterruptVideoPlay(boolean z3) {
        com.bykv.ok.ok.ok.ok.a c4 = com.bykv.ok.ok.ok.ok.a.c(1);
        c4.j(0, z3);
        this.ok.call(170101, c4.a(), Void.class);
    }
    ...
    public void setDrawVideoListener(TTDrawFeedAd.DrawVideoListener drawVideoListener) {
        com.bykv.ok.ok.ok.ok.a c4 = com.bykv.ok.ok.ok.ok.a.c(1);
        c4.h(0, new com.bytedance.sdk.openadsdk.p.ok.ok.ok.ok(drawVideoListener));
        this.ok.call(170103, c4.a(), Void.class);
    }
    ...
    public void setPauseIcon(Bitmap bitmap, int i4) {
        ...
        c4.h(0, bitmap);
        c4.f(1, i4);
        this.ok.call(170102, c4.a(), Void.class);
    }
    ...
    public void setVideoAdListener(TTFeedAd.VideoAdListener videoAdListener) {
        com.bykv.ok.ok.ok.ok.a c4 = com.bykv.ok.ok.ok.ok.a.c(1);
        c4.h(0, new com.bytedance.sdk.openadsdk.q.ok.ok.a.ok(videoAdListener));
        this.ok.call(160101, c4.a(), Void.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public void setVideoRewardListener(TTFeedAd.VideoRewardListener videoRewardListener) {
        com.bykv.ok.ok.ok.ok.a c4 = com.bykv.ok.ok.ok.ok.a.c(1);
        c4.h(0, new com.bytedance.sdk.openadsdk.q.ok.ok.a.a(videoRewardListener));
        this.ok.call(160102, c4.a(), Void.class);
    }
