...
public class TTRoundRectImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            if (c4 != null) {
                ...
                this.f36386c.setShader(bitmapShader);
                canvas.drawRoundRect(new RectF(0.0f, 0.0f, getWidth(), getHeight()), this.f36387w, this.xv, this.f36386c);
                return;
            }
            super.onDraw(canvas);
            return;
    ...
    public TTRoundRectImageView(Context context, AttributeSet attributeSet, int i4) {
        ...
        this.f36386c.setFilterBitmap(true);
        this.sr = new Matrix();
    }

    public TTRoundRectImageView(Context context, int i4, int i5) {
        this(context);
        this.f36387w = i4;
        this.xv = i5;
    }
