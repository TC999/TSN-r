 ...
 */
    ...
    public static final class Builder {
        ...
        public Builder setDownloadScene(int i4) {
            this.eventConfig.mDownloadScene = i4;
            return this;
        }
        ...
        public Builder setIsEnableClickEvent(boolean z3) {
            this.eventConfig.mIsEnableClickEvent = z3;
            return this;
        }

        @Deprecated
        public Builder setIsEnableCompletedEvent(boolean z3) {
            return this;
        }

        @Deprecated
        public Builder setIsEnableNoChargeClickEvent(boolean z3) {
            return this;
        }

        public Builder setIsEnableV3Event(boolean z3) {
            this.eventConfig.mIsEnableV3Event = z3;
            return this;
        }
    ...
    public static AdDownloadEventConfig fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            r.u().ok(e4, "AdDownloadEventConfig fromJson");
        }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt("enable_v3_event", Integer.valueOf(i4));
            jSONObject.putOpt("extra", this.mExtraJson);
            jSONObject.putOpt("params_json", this.mParamsJson);
        } catch (Exception e4) {
            r.u().ok(e4, "AdDownloadEventConfig toJson");
        }
        return jSONObject;
    }
