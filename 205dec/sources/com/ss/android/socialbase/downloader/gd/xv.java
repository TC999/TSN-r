...
public class xv {
    public static void c(int i4, SparseArray<IDownloadListener> sparseArray, boolean z3, DownloadInfo downloadInfo, BaseException baseException) {
        ...
        try {
            ...
            for (int i5 = 0; i5 < clone.size(); i5++) {
                ...
                if (iDownloadListener != null) {
                    ...
                    } else if (iDownloadListener instanceof fz) {
                        ((fz) iDownloadListener).c(downloadInfo);
                    }
                }
            }
        } catch (Throwable th) {
