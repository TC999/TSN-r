...
class MailDateParser {
    ...
    */
    ...
    public int parseNumericTimeZone() throws java.text.ParseException {
        ...
        int i5 = ((parseNumber / 100) * 60) + (parseNumber % 100);
        return z3 ? -i5 : i5;
    }
    ...
    public void skipChar(char c4) throws java.text.ParseException {
        int i4 = this.index;
        char[] cArr = this.orig;
        if (i4 < cArr.length) {
            if (cArr[i4] == c4) {
    ...
    public boolean skipIfChar(char c4) throws java.text.ParseException {
        int i4 = this.index;
        char[] cArr = this.orig;
        if (i4 < cArr.length) {
            if (cArr[i4] == c4) {
