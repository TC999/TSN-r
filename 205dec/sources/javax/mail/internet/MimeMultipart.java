...
public class MimeMultipart extends Multipart {
    ...
    */
    ...
    private static int readFully(InputStream inputStream, byte[] bArr, int i4, int i5) throws IOException {
        int i6 = 0;
        if (i5 == 0) {
            return 0;
        }
    ...
    private void skipFully(InputStream inputStream, long j4) throws IOException {
        while (j4 > 0) {
    ...
    */
    ...
    public void updateHeaders() throws MessagingException {
        for (int i4 = 0; i4 < this.parts.size(); i4++) {
            ((MimeBodyPart) this.parts.elementAt(i4)).updateHeaders();
        }
    }
    ...
    public synchronized void writeTo(OutputStream outputStream) throws IOException, MessagingException {
        ...
        for (int i4 = 0; i4 < this.parts.size(); i4++) {
            ...
            ((MimeBodyPart) this.parts.elementAt(i4)).writeTo(outputStream);
            lineOutputStream.writeln();
        }
    ...
    public synchronized BodyPart getBodyPart(String str) throws MessagingException {
        ...
        for (int i4 = 0; i4 < count; i4++) {
            MimeBodyPart mimeBodyPart = (MimeBodyPart) getBodyPart(i4);
    ...
    @Override // javax.mail.Multipart
    public void removeBodyPart(int i4) throws MessagingException {
        parse();
        super.removeBodyPart(i4);
    }

    @Override // javax.mail.Multipart
    public synchronized void addBodyPart(BodyPart bodyPart, int i4) throws MessagingException {
        parse();
        super.addBodyPart(bodyPart, i4);
    }
