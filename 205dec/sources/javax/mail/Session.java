...
public final class Session {
    ...
    private void loadAddressMap(Class cls) {
        ...
        try {
            ...
            if (this.debug) {
                pr("DEBUG: can't get java.home: " + e4);
            }
        }
    ...
    */
    ...
    public PasswordAuthentication requestPasswordAuthentication(InetAddress inetAddress, int i4, String str, String str2, String str3) {
        Authenticator authenticator = this.authenticator;
        if (authenticator != null) {
            return authenticator.requestPasswordAuthentication(inetAddress, i4, str, str2, str3);
        }
        return null;
    }

    public synchronized void setDebug(boolean z3) {
        this.debug = z3;
        if (z3) {
