...
final class EmittedSource$dispose$1 extends SuspendLambda implements p<q0, c<? super f1>, Object> {
    int label;
    ...
    public final Object invoke(q0 q0Var, c<? super f1> cVar) {
        return ((EmittedSource$dispose$1) create(q0Var, cVar)).invokeSuspend(f1.f55527a);
    }
