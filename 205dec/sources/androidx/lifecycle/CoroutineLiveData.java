...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    */
    public final java.lang.Object clearSource$lifecycle_livedata_ktx_release(@org.jetbrains.annotations.NotNull kotlin.coroutines.c<? super kotlin.f1> r5) {
        /*
            r4 = this;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object emitSource$lifecycle_livedata_ktx_release(@org.jetbrains.annotations.NotNull androidx.lifecycle.LiveData<T> r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.c<? super kotlinx.coroutines.i1> r7) {
        /*
            r5 = this;
    ...
    public CoroutineLiveData(@NotNull f context, long j4, @NotNull p<? super LiveDataScope<T>, ? super c<? super f1>, ? extends Object> block) {
        f0.p(context, "context");
        f0.p(block, "block");
        this.blockRunner = new BlockRunner<>(this, block, j4, r0.a(kotlinx.coroutines.f1.e().q().plus(context).plus(h3.a((e2) context.get(e2.f59626i0)))), new a<f1>() { // from class: androidx.lifecycle.CoroutineLiveData.1
            {
                super(0);
            }
