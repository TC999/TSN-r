...
final class LifecycleCoroutineScope$launchWhenResumed$1 extends SuspendLambda implements p<q0, c<? super f1>, Object> {
    ...
    public LifecycleCoroutineScope$launchWhenResumed$1(LifecycleCoroutineScope lifecycleCoroutineScope, p pVar, c cVar) {
        super(2, cVar);
    ...
    public final c<f1> create(@Nullable Object obj, @NotNull c<?> completion) {
        ...
        lifecycleCoroutineScope$launchWhenResumed$1.p$ = (q0) obj;
        return lifecycleCoroutineScope$launchWhenResumed$1;
    }

    @Override // d2.p
    public final Object invoke(q0 q0Var, c<? super f1> cVar) {
        return ((LifecycleCoroutineScope$launchWhenResumed$1) create(q0Var, cVar)).invokeSuspend(f1.f55527a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i4 == 0) {
            ...
            this.L$0 = q0Var;
            this.label = 1;
            if (PausingDispatcherKt.whenResumed(lifecycle$lifecycle_runtime_ktx_release, pVar, this) == h4) {
                return h4;
            }
        } else if (i4 != 1) {
