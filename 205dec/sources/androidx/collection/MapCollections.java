    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public int hashCode() {
            ...
            for (int colGetSize = MapCollections.this.colGetSize() - 1; colGetSize >= 0; colGetSize--) {
                ...
                i4 += (colGetEntry == null ? 0 : colGetEntry.hashCode()) ^ (colGetEntry2 == null ? 0 : colGetEntry2.hashCode());
            }
            return i4;
        }
 ...
 */
    ...
    final class KeySet implements Set<K> {
        ...
        public int hashCode() {
            ...
            for (int colGetSize = MapCollections.this.colGetSize() - 1; colGetSize >= 0; colGetSize--) {
                Object colGetEntry = MapCollections.this.colGetEntry(colGetSize, 0);
                i4 += colGetEntry == null ? 0 : colGetEntry.hashCode();
            }
            return i4;
        }
 ...
 */
    ...
    protected abstract Object colGetEntry(int i4, int i5);
    ...
    protected abstract void colPut(K k4, V v3);

    protected abstract void colRemoveAt(int i4);

    protected abstract V colSetValue(int i4, V v3);
