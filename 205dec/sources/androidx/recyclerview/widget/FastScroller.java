 ...
 */
    ...
    @VisibleForTesting
    boolean isPointInsideHorizontalThumb(float f4, float f5) {
    ...
    @VisibleForTesting
    boolean isPointInsideVerticalThumb(float f4, float f5) {
        if (!isLayoutRTL() ? f4 >= this.mRecyclerViewWidth - this.mVerticalThumbWidth : f4 <= this.mVerticalThumbWidth / 2) {
    ...
    void updateScrollPosition(int i4, int i5) {
        ...
        this.mNeedVerticalScrollbar = computeVerticalScrollRange - i6 > 0 && i6 >= this.mScrollbarMinimumRange;
        int computeHorizontalScrollRange = this.mRecyclerView.computeHorizontalScrollRange();
        int i7 = this.mRecyclerViewWidth;
        boolean z3 = computeHorizontalScrollRange - i7 > 0 && i7 >= this.mScrollbarMinimumRange;
        ...
        if (z4) {
            float f4 = i6;
            this.mVerticalThumbCenterY = (int) ((f4 * (i5 + (f4 / 2.0f))) / computeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i6, (i6 * i6) / computeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f5 = i7;
            this.mHorizontalThumbCenterX = (int) ((f5 * (i4 + (f5 / 2.0f))) / computeHorizontalScrollRange);
