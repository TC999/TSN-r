 ...
 */
    ...
    public static abstract class SpanSizeLookup {
        ...
        int getCachedSpanGroupIndex(int i4, int i5) {
        ...
        int getCachedSpanIndex(int i4, int i5) {
    ...
    private void measureChild(View view, int i4, boolean z3) {
        ...
        if (this.mOrientation == 1) {
            i6 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i4, i8, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
            ...
            int childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i4, i7, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i4, int i5, boolean z3) {
        ...
        if (z3) {
            shouldMeasureChild = shouldReMeasureChild(view, i4, i5, layoutParams);
        } else {
            shouldMeasureChild = shouldMeasureChild(view, i4, i5, layoutParams);
        }
    ...
    View findReferenceChild(RecyclerView.Recycler recycler, RecyclerView.State state, int i4, int i5, int i6) {
        ...
        while (i4 != i5) {
            ...
            if (position >= 0 && position < i6 && getSpanIndex(recycler, state, position) == 0) {
    ...
    int getSpaceForSpanRange(int i4, int i5) {
