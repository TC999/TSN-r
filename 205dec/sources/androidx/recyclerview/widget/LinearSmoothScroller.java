...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public int calculateTimeForDeceleration(int i4) {
        double calculateTimeForScrolling = calculateTimeForScrolling(i4);
    ...
    protected void onSeekTargetStep(int i4, int i5, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
