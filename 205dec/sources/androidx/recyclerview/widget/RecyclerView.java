 ...
 */
        ...
        */
        ...
        public void measureChild(@NonNull View view, int i4, int i5) {
            ...
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + i6, ((ViewGroup.MarginLayoutParams) layoutParams).width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + i7, ((ViewGroup.MarginLayoutParams) layoutParams).height, canScrollVertically());
        ...
        public void measureChildWithMargins(@NonNull View view, int i4, int i5) {
            ...
            int i6 = i4 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
            int i7 = i5 + itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + i6, ((ViewGroup.MarginLayoutParams) layoutParams).width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + i7, ((ViewGroup.MarginLayoutParams) layoutParams).height, canScrollVertically());
            if (shouldMeasureChild(view, childMeasureSpec, childMeasureSpec2, layoutParams)) {
                view.measure(childMeasureSpec, childMeasureSpec2);
            }
        }
 ...
 */
        ...
        void onAdapterChanged(Adapter adapter, Adapter adapter2, boolean z3) {
            if (adapter != null) {
                detach();
            }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i4) {
            ...
            if (childViewHolderInt != null) {
                ...
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + i4 + "(offset:" + findPositionOffset + ").state:" + RecyclerView.this.mState.getItemCount() + RecyclerView.this.exceptionLabel());
            }
        ...
        ViewHolder getChangedScrapViewForPosition(int i4) {
            int size;
        ...
        ViewHolder getScrapOrCachedViewForId(long j4, int i4, boolean z3) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i4, boolean z3) {
            ...
            if (!z3 && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i4)) != null) {
        ...
        void offsetPositionRecordsForInsert(int i4, int i5) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (viewHolder != null && viewHolder.mPosition >= i4) {
                    viewHolder.offsetPosition(i5, true);
                }
            }
        }
        ...
        */
        ...
        View getViewForPosition(int i4, boolean z3) {
            return tryGetViewHolderForPositionByDeadline(i4, z3, Long.MAX_VALUE).itemView;
        }
 ...
 */
        ...
        protected abstract void onSeekTargetStep(@Px int i4, @Px int i5, @NonNull State state, @NonNull Action action);
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void smoothScrollBy(int i4, int i5, int i6, @Nullable Interpolator interpolator) {
            if (i6 == Integer.MIN_VALUE) {
                i6 = computeScrollDuration(i4, i5, 0, 0);
            }
            int i7 = i6;
 ...
 */
    ...
    private void dispatchLayoutStep1() {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            boolean z4 = state2.mStructureChanged;
    ...
    */
    ...
    public boolean fling(int i4, int i5) {
        ...
        if (layoutManager == null) {
            ...
            i4 = (canScrollHorizontally == 0 || Math.abs(i4) < this.mMinFlingVelocity) ? 0 : 0;
    ...
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (gapWorker == null) {
                ...
                gapWorker2.mFrameIntervalNs = 1.0E9f / f4;
    ...
    */
    ...
    @VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(ViewHolder viewHolder, int i4) {
        if (isComputingLayout()) {
 ...
 */
    ...
    void smoothScrollBy(@Px int i4, @Px int i5, @Nullable Interpolator interpolator, int i6, boolean z3) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e("RecyclerView", "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutSuppressed) {
