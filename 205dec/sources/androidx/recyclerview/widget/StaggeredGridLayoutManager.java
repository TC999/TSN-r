 ...
 */
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                i4 = layoutState.mEndLine + layoutState.mAvailable;
            } else {
                i4 = layoutState.mStartLine - layoutState.mAvailable;
            }
            i5 = i4;
        }
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                int maxEnd2 = layoutParams.mFullSpan ? getMaxEnd(i8) : span3.getEndLine(i8);
                ...
                int minStart = layoutParams.mFullSpan ? getMinStart(i8) : span3.getStartLine(i8);
    ...
    */
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z3) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), ((ViewGroup.MarginLayoutParams) layoutParams).height, true), z3);
            } else {
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), ((ViewGroup.MarginLayoutParams) layoutParams).width, true), this.mFullSizeSpec, z3);
            }
    ...
    */
    ...
    View findFirstVisibleItemClosestToEnd(boolean z3) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        View view = null;
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
    ...
    View findFirstVisibleItemClosestToStart(boolean z3) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        int childCount = getChildCount();
        View view = null;
    ...
    */
    ...
    void prepareLayoutStateForDelta(int i4, RecyclerView.State state) {
        int firstChildPosition;
        int i5;
        if (i4 > 0) {
            firstChildPosition = getLastChildPosition();
    ...
    public void setMeasuredDimension(Rect rect, int i4, int i5) {
        ...
        if (this.mOrientation == 1) {
            ...
            chooseSize = RecyclerView.LayoutManager.chooseSize(i4, (this.mSizePerSpan * this.mSpanCount) + paddingLeft, getMinimumWidth());
        } else {
            chooseSize = RecyclerView.LayoutManager.chooseSize(i4, rect.width() + paddingLeft, getMinimumWidth());
            chooseSize2 = RecyclerView.LayoutManager.chooseSize(i5, (this.mSizePerSpan * this.mSpanCount) + paddingTop, getMinimumHeight());
        }
 ...
 */
    ...
    public class Span {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i4, int i5, boolean z3, boolean z4, boolean z5) {
        ...
        int findOnePartiallyVisibleChild(int i4, int i5, boolean z3) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i5, false, false, z3);
        }

        int findOneVisibleChild(int i4, int i5, boolean z3) {
 ...
 */
    ...
    public static class LazySpanLookup {
        ...
        int forceInvalidateAfter(int i4) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
        ...
        int invalidateAfter(int i4) {
            ...
            if (iArr != null && i4 < iArr.length) {
                ...
                int i5 = invalidateFullSpansAfter + 1;
                Arrays.fill(this.mData, i4, i5, -1);
                return i5;
            }
            return -1;
        }
        ...
        void setSpan(int i4, Span span) {
            ensureSize(i4);
            this.mData[i4] = span.mIndex;
        }

        int sizeForPosition(int i4) {
 ...
 */
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i4, int i5, boolean z3) {
        ...
        int updateSpecWithExtra = updateSpecWithExtra(i4, i6 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
