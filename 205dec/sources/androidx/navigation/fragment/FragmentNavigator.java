 ...
 */
    ...
    public FragmentNavigator(@NonNull Context context, @NonNull FragmentManager fragmentManager, int i4) {
    ...
    @NonNull
    private String generateBackStackName(int i4, int i5) {
        return i4 + "-" + i5;
    }
    ...
    public void onRestoreState(@Nullable Bundle bundle) {
        ...
        for (int i4 : intArray) {
            this.mBackStack.add(Integer.valueOf(i4));
        }
    }
