...
public abstract class NavType<T> {
    ...
    public static final NavType<Long> LongType = new NavType<Long>(false) { // from class: androidx.navigation.NavType.4
        ...
        @Override // androidx.navigation.NavType
        public void put(@NonNull Bundle bundle, @NonNull String str, @NonNull Long l4) {
    ...
    public static final NavType<Float> FloatType = new NavType<Float>(false) { // from class: androidx.navigation.NavType.6
        ...
        @Override // androidx.navigation.NavType
        public void put(@NonNull Bundle bundle, @NonNull String str, @NonNull Float f4) {
 ...
 */
    ...
    public static final class ParcelableType<D> extends NavType<D> {
        ...
        @Override // androidx.navigation.NavType
        public void put(@NonNull Bundle bundle, @NonNull String str, @Nullable D d4) {
            this.mType.cast(d4);
 ...
 */
    ...
    public static class SerializableType<D extends Serializable> extends NavType<D> {
        ...
        SerializableType(boolean z3, @NonNull Class<D> cls) {
            super(z3);
            if (Serializable.class.isAssignableFrom(cls)) {
                this.mType = cls;
                return;
    ...
    public abstract void put(@NonNull Bundle bundle, @NonNull String str, @Nullable T t3);
 ...
 */
    ...
    public static final class EnumType<D extends Enum> extends SerializableType<D> {
        ...
        public D parseValue(@NonNull String str) {
            D[] enumConstants;
            for (D d4 : this.mType.getEnumConstants()) {
