 ...
 */
    ...
    static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ Object lambda$setForeignKeyConstraintsEnabled$12(boolean z3, SupportSQLiteDatabase supportSQLiteDatabase) {
            supportSQLiteDatabase.setForeignKeyConstraintsEnabled(z3);
            return null;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ Object lambda$setMaxSqlCacheSize$11(int i4, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ Object lambda$setPageSize$3(long j4, SupportSQLiteDatabase supportSQLiteDatabase) {
            supportSQLiteDatabase.setPageSize(j4);
            return null;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ Object lambda$setVersion$1(int i4, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        public boolean yieldIfContendedSafely() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(n.f189a)).booleanValue();
        }
 ...
 */
    ...
    public static class AutoClosingSupportSqliteStatement implements SupportSQLiteStatement {
        ...
        private void saveBinds(int bindIndex, Object value) {
            int i4 = bindIndex - 1;
            if (i4 >= this.mBinds.size()) {
                for (int size = this.mBinds.size(); size <= i4; size++) {
                    this.mBinds.add(null);
                }
            }
            this.mBinds.set(i4, value);
        }
