 ...
 */
        ...
        public static IMultiInstanceInvalidationCallback asInterface(IBinder obj) {
            ...
            IInterface queryLocalInterface = obj.queryLocalInterface("androidx.room.IMultiInstanceInvalidationCallback");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                data.enforceInterface("androidx.room.IMultiInstanceInvalidationCallback");
                onInvalidation(data.createStringArray());
                return true;
            } else if (code != 1598968902) {
                return super.onTransact(code, data, reply, flags);
            } else {
                reply.writeString("androidx.room.IMultiInstanceInvalidationCallback");
                return true;
            }
        }
    }
