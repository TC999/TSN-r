    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            if (this.mContext != null) {
                if (this.mDatabaseClass != null) {
                    ...
                    long j4 = this.mAutoCloseTimeout;
                    if (j4 > 0) {
                        if (this.mName != null) {
                            autoClosingRoomOpenHelperFactory = new AutoClosingRoomOpenHelperFactory(autoClosingRoomOpenHelperFactory, new AutoCloser(j4, this.mAutoCloseTimeUnit, this.mTransactionExecutor));
                        } else {
                    ...
                    T t3 = (T) Room.getGeneratedImplementation(this.mDatabaseClass, "_Impl");
        ...
        public Builder<T> fallbackToDestructiveMigrationFrom(int... startVersions) {
            ...
            for (int i4 : startVersions) {
                this.mMigrationsNotRequiredFrom.add(Integer.valueOf(i4));
            }
            return this;
        }
 ...
 */
    ...
    public static class MigrationContainer {
        ...
        private void addMigration(Migration migration) {
            ...
            TreeMap<Integer, Migration> treeMap = this.mMigrations.get(Integer.valueOf(i4));
            if (treeMap == null) {
                treeMap = new TreeMap<>();
                this.mMigrations.put(Integer.valueOf(i4), treeMap);
            }
            Migration migration2 = treeMap.get(Integer.valueOf(i5));
            if (migration2 != null) {
