 ...
 */
    ...
    private static void doInstallation(Context context, File file, File file2, String str, String str2, boolean z3) throws IOException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException {
        ...
        synchronized (set) {
            ...
            if (i4 > 20) {
                Log.w("MultiDex", "MultiDex is not guaranteed to work in SDK version " + i4 + ": SDK version higher than 20 should be backed by runtime with built-in multidex capabilty but it's not the case here: java.vm.version=\"" + System.getProperty("java.vm.version") + "\"");
            }
            try {
    ...
    static boolean isVMMultidexCapable(String str) {
        ...
        sb.append(str);
        sb.append(z3 ? " has multidex support" : " does not have multidex support");
