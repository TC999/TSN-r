        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (this.mIsSingleChoice) {
                    i4 = alertController.mSingleChoiceItemLayout;
                } else {
                    i4 = alertController.mListItemLayout;
                }
                int i5 = i4;
                if (this.mCursor != null) {
 ...
 */
    ...
    private int selectContentView() {
        ...
        return this.mButtonPanelLayoutHint == 1 ? i4 : this.mAlertDialogLayout;
    }
    ...
    private void setupView() {
        ...
        boolean z4 = (resolvePanel == null || resolvePanel.getVisibility() == 8) ? 0 : 1;
        boolean z5 = (resolvePanel3 == null || resolvePanel3.getVisibility() == 8) ? false : true;
        if (!z5 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z3) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, z4 | (z5 ? 2 : 0), 3);
            }
        }
