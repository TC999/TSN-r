 ...
 */
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            while (true) {
                ...
                View createViewByPrefix = createViewByPrefix(context, str, strArr[i4]);
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z3, boolean z4) {
        ...
        if (z4 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(R.styleable.View_theme, 0)) != 0) {
