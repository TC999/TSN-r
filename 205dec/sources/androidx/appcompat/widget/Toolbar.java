            ...
            if (this.mCurrentExpandedItem != null) {
                ...
                if (menuBuilder != null) {
                    ...
                    while (true) {
                        if (i4 >= size) {
                            break;
                        } else if (this.mMenu.getItem(i4) == this.mCurrentExpandedItem) {
                            z4 = true;
                            break;
                        } else {
                            i4++;
    ...
    */
    ...
    protected void onMeasure(int i4, int i5) {
        ...
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i4, max, i5, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            max2 += measureChildCollapseMargins(this.mExpandedActionView, i4, max2, i5, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            max2 += measureChildCollapseMargins(this.mLogoView, i4, max2, i5, 0, iArr);
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                max2 += measureChildCollapseMargins(childAt, i4, max2, i5, 0, iArr);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i4, max2 + i16, i5, i15, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i11 = Math.max(i11, measureChildCollapseMargins(this.mSubtitleTextView, i4, max2 + i16, i5, i12 + i15, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max2 + i11 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i4, (-16777216) & i10), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(max3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i5, i10 << 16));
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (i4 != 0 && this.mExpandedMenuPresenter != null && peekMenu != null && (findItem = peekMenu.findItem(i4)) != null) {
