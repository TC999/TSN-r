 ...
 */
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i4, String str) {
        ...
        try {
            ...
            if (columnString3 != null && (columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id")) != null) {
                columnString3 = columnString3 + TTPathConst.sSeparator + Uri.encode(columnString);
            }
    ...
    private void updateViewsVisibility(boolean z3) {
        ...
        int i5 = z3 ? 0 : 8;
        boolean z4 = !TextUtils.isEmpty(this.mSearchSrcTextView.getText());
        this.mSearchButton.setVisibility(i5);
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (isLayoutRtl) {
                ...
                i4 = paddingLeft - (rect.left + dimensionPixelSize);
            }
    ...
    void launchQuerySearch(int i4, String str, String str2) {
    ...
    boolean onItemClicked(int i4, int i5, String str) {
    ...
    boolean onSuggestionsKey(View view, int i4, KeyEvent keyEvent) {
