 ...
 */
    ...
    TabView createTabView(ActionBar.Tab tab, boolean z3) {
    ...
    public void onMeasure(int i4, int i5) {
        ...
        if ((z4 || !this.mAllowCollapse) ? false : false) {
    ...
    public void addTab(ActionBar.Tab tab, int i4, boolean z3) {
        TabView createTabView = createTabView(tab, false);
        this.mTabLayout.addView(createTabView, i4, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
