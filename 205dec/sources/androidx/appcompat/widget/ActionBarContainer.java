...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            int i8 = ((FrameLayout.LayoutParams) view.getLayoutParams()).bottomMargin;
            view.layout(i4, (measuredHeight - view.getMeasuredHeight()) - i8, i6, measuredHeight - i8);
        }
        if (this.mIsSplit) {
    ...
    public void onMeasure(int i4, int i5) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min(measuredHeightWithMargins + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i5) : Integer.MAX_VALUE));
    }
