...
public class SwitchCompat extends CompoundButton {
    ...
    private void animateThumbToCheckedState(boolean z3) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, THUMB_POS, z3 ? 1.0f : 0.0f);
    ...
    private boolean hitThumb(float f4, float f5) {
        ...
        return f4 > ((float) i7) && f4 < ((float) ((((this.mThumbWidth + i7) + rect.left) + rect.right) + i5)) && f5 > ((float) i6) && f5 < ((float) (this.mSwitchBottom + i5));
    }
    ...
    protected void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            width = ((this.mSwitchWidth + i9) - i8) - i12;
        } else {
            width = (getWidth() - getPaddingRight()) - i12;
            i9 = (width - this.mSwitchWidth) + i8 + i12;
        }
        int gravity = getGravity() & 112;
        if (gravity == 16) {
            i10 = this.mSwitchHeight;
            paddingTop = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / 2) - (i10 / 2);
        } else if (gravity != 80) {
            paddingTop = getPaddingTop();
            i10 = this.mSwitchHeight;
        } else {
            i11 = getHeight() - getPaddingBottom();
            paddingTop = i11 - this.mSwitchHeight;
            this.mSwitchLeft = i9;
    ...
    public void onMeasure(int i4, int i5) {
        ...
        int max = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + i9 + i10);
    ...
    */
    ...
    public void setSwitchTypeface(Typeface typeface, int i4) {
        ...
        if (i4 > 0) {
            ...
            int style = ((create != null ? create.getStyle() : 0) ^ (-1)) & i4;
