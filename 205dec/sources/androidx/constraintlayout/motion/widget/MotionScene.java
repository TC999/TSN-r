...
public class MotionScene {
    ...
    private int getRealID(int i4) {
        ...
        return (stateSet == null || (stateGetConstraintID = stateSet.stateGetConstraintID(i4, -1, -1)) == -1) ? i4 : stateGetConstraintID;
    }
    ...
    private void readConstraintChain(int i4) {
        ...
        if (i5 > 0) {
            ...
            if (constraintSet2 == null) {
                Log.e("MotionScene", "ERROR! invalid deriveConstraintsFrom: @id/" + Debug.getName(this.mMotionLayout.getContext(), i5));
                return;
            }
    ...
    public void addOnClickListeners(MotionLayout motionLayout, int i4) {
        ...
        while (it5.hasNext()) {
            ...
            if (next3.mOnClicks.size() > 0) {
                ...
                while (it6.hasNext()) {
                    ((Transition.TransitionOnClick) it6.next()).addOnClickListeners(motionLayout, i4, next3);
                }
            }
        }
        ...
        while (it7.hasNext()) {
            ...
            if (next4.mOnClicks.size() > 0) {
                ...
                while (it8.hasNext()) {
                    ((Transition.TransitionOnClick) it8.next()).addOnClickListeners(motionLayout, i4, next4);
                }
            }
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (next.mAutoTransition != 0) {
                if (i4 == next.mConstraintSetStart && (next.mAutoTransition == 4 || next.mAutoTransition == 2)) {
                    ...
                    return true;
                } else if (i4 == next.mConstraintSetEnd && (next.mAutoTransition == 3 || next.mAutoTransition == 1)) {
                ...
                if (!transition2.mDisable && transition2.mTouchResponse != null) {
                    ...
                    if (touchRegion == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY())) {
                        ...
                        if (touchRegion2 == null || motionEvent == null || touchRegion2.contains(motionEvent.getX(), motionEvent.getY())) {
                            float dot = transition2.mTouchResponse.dot(f4, f5) * (transition2.mConstraintSetEnd == i4 ? -1.0f : 1.1f);
                            if (dot > f6) {
                                transition = transition2;
                                f6 = dot;
                            }
    ...
    public ConstraintSet getConstraintSet(Context context, String str) {
        ...
        for (int i4 = 0; i4 < this.mConstraintSetMap.size(); i4++) {
            ...
            if (this.DEBUG_DESKTOP) {
                ...
                printStream3.println("Id for <" + i4 + "> is <" + resourceName + "> looking for <" + str + ">");
            }
    ...
    */
    ...
    ConstraintSet getConstraintSet(int i4, int i5, int i6) {
        int stateGetConstraintID;
        if (this.DEBUG_DESKTOP) {
            PrintStream printStream = System.out;
        ...
        if (this.mConstraintSetMap.get(i4) == null) {
            Log.e("MotionScene", "Warning could not find ConstraintSet id/" + Debug.getName(this.mMotionLayout.getContext(), i4) + " In MotionScene");
            ...
            for (int i4 = 0; i4 < indexCount; i4++) {
                ...
                if (index == R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (i5 == 1) {
                        ...
                        if (string.indexOf(TTPathConst.sSeparator) > 0) {
