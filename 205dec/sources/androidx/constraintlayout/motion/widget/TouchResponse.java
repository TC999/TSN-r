...
public class TouchResponse {
    ...
    public float dot(float f4, float f5) {
        return (f4 * this.mTouchDirectionX) + (f5 * this.mTouchDirectionY);
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i4, MotionScene motionScene) {
        ...
        if (action == 0) {
            ...
            if (f9 == 0.0f || f9 == 1.0f || (i5 = this.mOnTouchUp) == 3) {
                if (0.0f >= f9 || 1.0f <= f9) {
            ...
            this.mMotionLayout.touchAnimateTo(i5, ((double) f9) < 0.5d ? 0.0f : 1.0f, f4);
            ...
            if (Math.abs((this.mTouchDirectionX * rawX) + (this.mTouchDirectionY * rawY)) > this.mDragThreshold || this.mDragStarted) {
                ...
                if (this.mTouchDirectionX != 0.0f) {
                    f5 = rawX / this.mAnchorDpDt[0];
                } else {
                    f5 = rawY / this.mAnchorDpDt[1];
                }
    ...
    public void scrollMove(float f4, float f5) {
        ...
        float[] fArr = this.mAnchorDpDt;
        if (Math.abs((f7 * fArr[0]) + (this.mTouchDirectionY * fArr[1])) < 0.01d) {
            float[] fArr2 = this.mAnchorDpDt;
            fArr2[0] = 0.01f;
            fArr2[1] = 0.01f;
        }
    ...
    public void scrollUp(float f4, float f5) {
        ...
        if (progress != 0.0f) {
            ...
            if ((i4 != 3) && z3) {
                this.mMotionLayout.touchAnimateTo(i4, ((double) progress) >= 0.5d ? 1.0f : 0.0f, f6);
            }
        }
    }
