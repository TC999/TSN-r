 ...
 */
    ...
    public static abstract class WorkEnqueuer {
        ...
        void ensureJobId(int i4) {
            if (!this.mHasJobId) {
                this.mHasJobId = true;
                this.mJobId = i4;
            } else if (this.mJobId == i4) {
            } else {
                throw new IllegalArgumentException("Given job ID " + i4 + " is different than previous " + this.mJobId);
            }
        }
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z3, int i4) {
    ...
    void ensureProcessorRunningLocked(boolean z3) {
