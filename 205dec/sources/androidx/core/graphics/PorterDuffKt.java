...
public final class PorterDuffKt {
    @NotNull
    public static final PorterDuffColorFilter toColorFilter(@NotNull PorterDuff.Mode toColorFilter, int i4) {
        f0.q(toColorFilter, "$this$toColorFilter");
    ...
    public static final PorterDuffXfermode toXfermode(@NotNull PorterDuff.Mode toXfermode) {
        f0.q(toXfermode, "$this$toXfermode");
