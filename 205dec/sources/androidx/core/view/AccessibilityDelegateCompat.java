 ...
 */
    ...
    public boolean performAccessibilityAction(View view, int i4, Bundle bundle) {
        ...
        if (!z3) {
            z3 = this.mOriginalDelegate.performAccessibilityAction(view, i4, bundle);
        }
        return (z3 || i4 != R.id.accessibility_action_clickable_span) ? z3 : performClickableSpanAction(bundle.getInt("ACCESSIBILITY_CLICKABLE_SPAN_ID", -1), view);
    }
