 ...
 */
    ...
    private static Typeface loadFont(@NonNull Context context, int i4, TypedValue typedValue, int i5, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z3) {
        ...
        resources.getValue(i4, typedValue, true);
        Typeface loadFont = loadFont(context, resources, typedValue, i4, i5, fontCallback, handler, z3);
    ...
    */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(@NonNull Context context, @FontRes int i4, TypedValue typedValue, int i5, @Nullable FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
