...
public final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i4, @ColorInt int i5, boolean z3, @ColorInt int i6) {
        ...
        if (z3) {
            return new ColorStops(i4, i6, i5);
        }
        return new ColorStops(i4, i5);
    }
 ...
 */
    ...
    public static final class ColorStops {
        ...
        ColorStops(@ColorInt int i4, @ColorInt int i5) {
            this.mColors = new int[]{i4, i5};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int i4, @ColorInt int i5, @ColorInt int i6) {
