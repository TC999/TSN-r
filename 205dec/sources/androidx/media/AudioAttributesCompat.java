 ...
 */
    ...
    static int toVolumeStreamType(boolean z3, AudioAttributesCompat audioAttributesCompat) {
 ...
 */
    ...
    public static class Builder {
        ...
        public Builder setFlags(int i4) {
            this.mFlags = (i4 & 1023) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        Builder setInternalLegacyStreamType(int i4) {
            switch (i4) {
                case 0:
                    this.mContentType = 1;
                    break;
