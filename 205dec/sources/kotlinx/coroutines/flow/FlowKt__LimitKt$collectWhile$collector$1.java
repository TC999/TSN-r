...
public final class FlowKt__LimitKt$collectWhile$collector$1<T> implements i<T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ d2.p f59761a;

    public FlowKt__LimitKt$collectWhile$collector$1(d2.p pVar) {
        this.f59761a = pVar;
    }
    ...
    public Object a(Object obj, @NotNull kotlin.coroutines.c cVar) {
        ...
        if (((Boolean) this.f59761a.invoke(obj, cVar)).booleanValue()) {
            return f1.f55527a;
        }
    ...
    */
    public java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.c<? super kotlin.f1> r6) {
        /*
            r4 = this;
