...
public final class FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1<T> implements h<T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ h f59901a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d2.q f59902b;

    public FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1(h hVar, d2.q qVar) {
        this.f59901a = hVar;
        this.f59902b = qVar;
    }
    ...
    public Object e(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        ...
        Object e4 = this.f59901a.e(new FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1$lambda$1(iVar, objectRef, this), cVar);
