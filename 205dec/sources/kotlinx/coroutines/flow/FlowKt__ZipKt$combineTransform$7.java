...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements d2.p<i<? super R>, kotlin.coroutines.c<? super f1>, Object> {
 ...
 */
    ...
    public static final class AnonymousClass2<T> extends SuspendLambda implements d2.q<i<? super R>, T[], kotlin.coroutines.c<? super f1>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i4 == 0) {
                ...
                d2.q qVar = FlowKt__ZipKt$combineTransform$7.this.$transform;
                this.L$0 = iVar;
                this.L$1 = objArr;
                this.label = 1;
    ...
    public FlowKt__ZipKt$combineTransform$7(h[] hVarArr, d2.q qVar, kotlin.coroutines.c cVar) {
        super(2, cVar);
    ...
    public final kotlin.coroutines.c<f1> create(@Nullable Object obj, @NotNull kotlin.coroutines.c<?> cVar) {
        ...
        flowKt__ZipKt$combineTransform$7.p$ = (i) obj;
        return flowKt__ZipKt$combineTransform$7;
    }

    @Override // d2.p
    public final Object invoke(Object obj, kotlin.coroutines.c<? super f1> cVar) {
        return ((FlowKt__ZipKt$combineTransform$7) create(obj, cVar)).invokeSuspend(f1.f55527a);
    }
