...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2<R> extends SuspendLambda implements d2.p<i<? super R>, kotlin.coroutines.c<? super f1>, Object> {
    final /* synthetic */ h[] $flows;
    final /* synthetic */ d2.r $transform$inlined;
    Object L$0;
    int label;
    private i p$;
 ...
 */
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$1", f = "Zip.kt", i = {0, 0, 0, 0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_GET_RES_HEADERS}, m = "invokeSuspend", n = {"$this$combineInternal", "it", "continuation", "args", "$receiver"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4"})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements d2.q<i<? super R>, Object[], kotlin.coroutines.c<? super f1>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i4 == 0) {
                ...
                d2.r rVar = FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2.this.$transform$inlined;
                ...
                Object invoke = rVar.invoke(iVar, obj2, obj3, this);
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2(h[] hVarArr, kotlin.coroutines.c cVar, d2.r rVar) {
        super(2, cVar);
        this.$flows = hVarArr;
    ...
    public final kotlin.coroutines.c<f1> create(@Nullable Object obj, @NotNull kotlin.coroutines.c<?> cVar) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2.p$ = (i) obj;
    ...
    public final Object invoke(Object obj, kotlin.coroutines.c<? super f1> cVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2) create(obj, cVar)).invokeSuspend(f1.f55527a);
    }
