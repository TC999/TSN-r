...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements h<R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ h[] f59954a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d2.p f59955b;

    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$3(h[] hVarArr, d2.p pVar) {
        this.f59954a = hVarArr;
        this.f59955b = pVar;
    }
    ...
    public Object e(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        Object h4;
        h[] hVarArr = this.f59954a;
        kotlin.jvm.internal.f0.w();
        kotlin.jvm.internal.f0.w();
        Object a4 = CombineKt.a(iVar, hVarArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2(null, this), cVar);
    ...
    public Object g(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        ...
        CombineKt.a(iVar, hVarArr, flowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$1, flowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2, cVar);
