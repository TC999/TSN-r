...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements h<R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ h[] f59952a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d2.p f59953b;

    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$2(h[] hVarArr, d2.p pVar) {
        this.f59952a = hVarArr;
        this.f59953b = pVar;
    }
    ...
    public Object e(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        Object h4;
        h[] hVarArr = this.f59952a;
        kotlin.jvm.internal.f0.w();
        kotlin.jvm.internal.f0.w();
        Object a4 = CombineKt.a(iVar, hVarArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2(null, this), cVar);
    ...
    public Object g(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        ...
        new ContinuationImpl(cVar) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.1
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.this.e(null, this);
            }
        };
        ...
        CombineKt.a(iVar, hVarArr, flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$1, flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2, cVar);
