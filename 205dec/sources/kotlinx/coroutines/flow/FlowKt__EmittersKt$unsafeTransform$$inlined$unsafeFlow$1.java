...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1<R> implements h<R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ h f59687a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d2.q f59688b;

    public FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1(h hVar, d2.q qVar) {
        this.f59687a = hVar;
        this.f59688b = qVar;
    }
    ...
    public Object e(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        Object h4;
        Object e4 = this.f59687a.e(new FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(iVar, this), cVar);
    ...
    public Object g(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        ...
        h hVar = this.f59687a;
        FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 flowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(iVar, this);
        kotlin.jvm.internal.c0.e(0);
        hVar.e(flowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1, cVar);
