...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2<R, T> extends SuspendLambda implements d2.q<i<? super R>, T[], kotlin.coroutines.c<? super f1>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2(kotlin.coroutines.c cVar, FlowKt__ZipKt$combine$$inlined$unsafeFlow$3 flowKt__ZipKt$combine$$inlined$unsafeFlow$3) {
        super(3, cVar);
    ...
    public final kotlin.coroutines.c<f1> create(@NotNull i<? super R> iVar, @NotNull T[] tArr, @NotNull kotlin.coroutines.c<? super f1> cVar) {
        ...
        flowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2.p$ = iVar;
    ...
    public final Object invoke(Object obj, Object obj2, kotlin.coroutines.c<? super f1> cVar) {
        return ((FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$lambda$2) create((i) obj, (Object[]) obj2, cVar)).invokeSuspend(f1.f55527a);
    }
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        i iVar = this.p$;
        Object invoke = this.this$0.f59955b.invoke(this.p$0, this);
