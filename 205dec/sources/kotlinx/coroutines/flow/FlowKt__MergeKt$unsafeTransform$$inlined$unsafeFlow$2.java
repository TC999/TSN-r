...
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2<R> implements h<R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ h f59790a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d2.q f59791b;

    public FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2(h hVar, d2.q qVar) {
        this.f59790a = hVar;
        this.f59791b = qVar;
    }
    ...
    public Object e(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        Object h4;
        Object e4 = this.f59790a.e(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(iVar, this), cVar);
    ...
    public Object g(@NotNull i iVar, @NotNull kotlin.coroutines.c cVar) {
        ...
        h hVar = this.f59790a;
        FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1 flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1 = new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(iVar, this);
        kotlin.jvm.internal.c0.e(0);
        hVar.e(flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1, cVar);
