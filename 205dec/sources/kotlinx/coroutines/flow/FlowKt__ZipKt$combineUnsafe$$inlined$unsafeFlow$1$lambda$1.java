...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1", f = "Zip.kt", i = {0, 0, 1, 1}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_ASYNC, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_ASYNC}, m = "invokeSuspend", n = {"$this$combineInternal", "it", "$this$combineInternal", "it"}, s = {"L$0", "L$1", "L$0", "L$1"})
/* loaded from: E:\TSN-r\205dec\7343912.dex */
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1<R, T> extends SuspendLambda implements d2.q<i<? super R>, T[], kotlin.coroutines.c<? super f1>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1(kotlin.coroutines.c cVar, FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1) {
        super(3, cVar);
    ...
    public final kotlin.coroutines.c<f1> create(@NotNull i<? super R> iVar, @NotNull T[] tArr, @NotNull kotlin.coroutines.c<? super f1> cVar) {
        ...
        flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1.p$ = iVar;
    ...
    public final Object invoke(Object obj, Object obj2, kotlin.coroutines.c<? super f1> cVar) {
        return ((FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1) create((i) obj, (Object[]) obj2, cVar)).invokeSuspend(f1.f55527a);
    }
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        i iVar = this.p$;
        Object invoke = this.this$0.f59959b.invoke(this.p$0, this);
